...
Namespace S5T
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("CodeFluent Entities", "1.0.01234.05678"),  _
     ...
     System.Diagnostics.DebuggerDisplayAttribute("EK={EntityKey}, pREDESPACHO={pREDESPACHO}, pId={pId}"),  _
     System.ComponentModel.TypeConverterAttribute(GetType(CodeFluent.Runtime.Design.NameTypeConverter))>  _
    Partial Public Class AviacaoRedespachos
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.AviacaoRedespachos), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.AviacaoRedespachos)
        ...
        Public Overloads Overridable Function Equals(ByVal aviacaoRedespachos As S5T.AviacaoRedespachos) As Boolean Implements System.IEquatable(Of S5T.AviacaoRedespachos).Equals
            If (aviacaoRedespachos Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(aviacaoRedespachos)
            End If
            Return (Me.pId.Equals(aviacaoRedespachos.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                aviacaoRedespachos = CType(obj,S5T.AviacaoRedespachos)
            Catch icex As System.InvalidCastException
                aviacaoRedespachos = Nothing
            End Try
            Return Me.Equals(aviacaoRedespachos)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(aviacaoRedespachos)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal aviacaoRedespachos As S5T.AviacaoRedespachos) As Integer Implements System.IComparable(Of S5T.AviacaoRedespachos).CompareTo
            If (aviacaoRedespachos Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoRedespachos")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(aviacaoRedespachos.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.AviacaoRedespachos.ExternalValidate", "Type 'S5T.AviacaoRedespachos' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoRedespachos", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.AviacaoRedespachos
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoRedespachos As S5T.AviacaoRedespachos = New S5T.AviacaoRedespachos()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoRedespachos", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    aviacaoRedespachos.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.AviacaoRedespachos
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoRedespachos As S5T.AviacaoRedespachos = New S5T.AviacaoRedespachos()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoRedespachos", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5T.AviacaoRedespachos.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoRedespachos", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal aviacaoRedespachos As S5T.AviacaoRedespachos) As Boolean
            If (aviacaoRedespachos Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal aviacaoRedespachos As S5T.AviacaoRedespachos) As Boolean
            Dim ret As Boolean = S5T.AviacaoRedespachos.Save(aviacaoRedespachos)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal aviacaoRedespachos As S5T.AviacaoRedespachos) As Boolean
            If (aviacaoRedespachos Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.AviacaoRedespachos
            ...
            aviacaoRedespachos = S5T.AviacaoRedespachos.Load(var)
            Return aviacaoRedespachos
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.AviacaoRedespachos
            Dim aviacaoRedespachos As S5T.AviacaoRedespachos = New S5T.AviacaoRedespachos()
            Me.CopyTo(aviacaoRedespachos, deep)
            Return aviacaoRedespachos
        End Function
        
        Public Overloads Function Clone() As S5T.AviacaoRedespachos
            Dim localClone As S5T.AviacaoRedespachos = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal aviacaoRedespachos As S5T.AviacaoRedespachos, ByVal deep As Boolean)
            If (aviacaoRedespachos Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoRedespachos")
            End If
            aviacaoRedespachos.pId = Me.pId
            aviacaoRedespachos.pNOME_REDESPACHO = Me.pNOME_REDESPACHO
            aviacaoRedespachos.pREDESPACHO = Me.pREDESPACHO
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, aviacaoRedespachos))
        End Sub
