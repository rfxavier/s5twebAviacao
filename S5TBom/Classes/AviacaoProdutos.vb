...
Namespace S5T
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("CodeFluent Entities", "1.0.01234.05678"),  _
     ...
     System.Diagnostics.DebuggerDisplayAttribute("EK={EntityKey}, pPRODUTO={pPRODUTO}, pId={pId}"),  _
     System.ComponentModel.TypeConverterAttribute(GetType(CodeFluent.Runtime.Design.NameTypeConverter))>  _
    Partial Public Class AviacaoProdutos
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.AviacaoProdutos), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.AviacaoProdutos)
        ...
        Public Overloads Overridable Function Equals(ByVal aviacaoProdutos As S5T.AviacaoProdutos) As Boolean Implements System.IEquatable(Of S5T.AviacaoProdutos).Equals
            If (aviacaoProdutos Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(aviacaoProdutos)
            End If
            Return (Me.pId.Equals(aviacaoProdutos.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                aviacaoProdutos = CType(obj,S5T.AviacaoProdutos)
            Catch icex As System.InvalidCastException
                aviacaoProdutos = Nothing
            End Try
            Return Me.Equals(aviacaoProdutos)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(aviacaoProdutos)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal aviacaoProdutos As S5T.AviacaoProdutos) As Integer Implements System.IComparable(Of S5T.AviacaoProdutos).CompareTo
            If (aviacaoProdutos Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoProdutos")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(aviacaoProdutos.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.AviacaoProdutos.ExternalValidate", "Type 'S5T.AviacaoProdutos' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoProdutos", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.AviacaoProdutos
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoProdutos As S5T.AviacaoProdutos = New S5T.AviacaoProdutos()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoProdutos", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    aviacaoProdutos.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.AviacaoProdutos
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoProdutos As S5T.AviacaoProdutos = New S5T.AviacaoProdutos()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoProdutos", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoProdutos", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal aviacaoProdutos As S5T.AviacaoProdutos) As Boolean
            If (aviacaoProdutos Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal aviacaoProdutos As S5T.AviacaoProdutos) As Boolean
            Dim ret As Boolean = S5T.AviacaoProdutos.Save(aviacaoProdutos)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal aviacaoProdutos As S5T.AviacaoProdutos) As Boolean
            If (aviacaoProdutos Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.AviacaoProdutos
            ...
            aviacaoProdutos = S5T.AviacaoProdutos.Load(var)
            Return aviacaoProdutos
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.AviacaoProdutos
            Dim aviacaoProdutos As S5T.AviacaoProdutos = New S5T.AviacaoProdutos()
            Me.CopyTo(aviacaoProdutos, deep)
            Return aviacaoProdutos
        End Function
        
        Public Overloads Function Clone() As S5T.AviacaoProdutos
            Dim localClone As S5T.AviacaoProdutos = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal aviacaoProdutos As S5T.AviacaoProdutos, ByVal deep As Boolean)
            If (aviacaoProdutos Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoProdutos")
            End If
            aviacaoProdutos.pId = Me.pId
            aviacaoProdutos.pDESCRICAO = Me.pDESCRICAO
            aviacaoProdutos.pPRODUTO = Me.pPRODUTO
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, aviacaoProdutos))
        End Sub
