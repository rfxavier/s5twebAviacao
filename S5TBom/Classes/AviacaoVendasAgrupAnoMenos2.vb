...
Namespace S5T
    ...
    Partial Public Class AviacaoVendasAgrupAnoMenos2
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.AviacaoVendasAgrupAnoMenos2), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.AviacaoVendasAgrupAnoMenos2)
        ...
        Public Overloads Overridable Function Equals(ByVal aviacaoVendasAgrupAnoMenos2 As S5T.AviacaoVendasAgrupAnoMenos2) As Boolean Implements System.IEquatable(Of S5T.AviacaoVendasAgrupAnoMenos2).Equals
            If (aviacaoVendasAgrupAnoMenos2 Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(aviacaoVendasAgrupAnoMenos2)
            End If
            Return (Me.pId.Equals(aviacaoVendasAgrupAnoMenos2.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                aviacaoVendasAgrupAnoMenos2 = CType(obj,S5T.AviacaoVendasAgrupAnoMenos2)
            Catch icex As System.InvalidCastException
                aviacaoVendasAgrupAnoMenos2 = Nothing
            End Try
            Return Me.Equals(aviacaoVendasAgrupAnoMenos2)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(aviacaoVendasAgrupAnoMenos2)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal aviacaoVendasAgrupAnoMenos2 As S5T.AviacaoVendasAgrupAnoMenos2) As Integer Implements System.IComparable(Of S5T.AviacaoVendasAgrupAnoMenos2).CompareTo
            If (aviacaoVendasAgrupAnoMenos2 Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoVendasAgrupAnoMenos2")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(aviacaoVendasAgrupAnoMenos2.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.AviacaoVendasAgrupAnoMenos2.ExternalValidate", "Type 'S5T.AviacaoVendasAgrupAnoMenos2' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAgrupAnoMenos2", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.AviacaoVendasAgrupAnoMenos2
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoVendasAgrupAnoMenos2 As S5T.AviacaoVendasAgrupAnoMenos2 = New S5T.AviacaoVendasAgrupAnoMenos2()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAgrupAnoMenos2", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    aviacaoVendasAgrupAnoMenos2.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.AviacaoVendasAgrupAnoMenos2
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoVendasAgrupAnoMenos2 As S5T.AviacaoVendasAgrupAnoMenos2 = New S5T.AviacaoVendasAgrupAnoMenos2()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAgrupAnoMenos2", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5T.AviacaoVendasAgrupAnoMenos2.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAgrupAnoMenos2", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal aviacaoVendasAgrupAnoMenos2 As S5T.AviacaoVendasAgrupAnoMenos2) As Boolean
            If (aviacaoVendasAgrupAnoMenos2 Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal aviacaoVendasAgrupAnoMenos2 As S5T.AviacaoVendasAgrupAnoMenos2) As Boolean
            Dim ret As Boolean = S5T.AviacaoVendasAgrupAnoMenos2.Save(aviacaoVendasAgrupAnoMenos2)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal aviacaoVendasAgrupAnoMenos2 As S5T.AviacaoVendasAgrupAnoMenos2) As Boolean
            If (aviacaoVendasAgrupAnoMenos2 Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.AviacaoVendasAgrupAnoMenos2
            ...
            aviacaoVendasAgrupAnoMenos2 = S5T.AviacaoVendasAgrupAnoMenos2.Load(var)
            Return aviacaoVendasAgrupAnoMenos2
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.AviacaoVendasAgrupAnoMenos2
            Dim aviacaoVendasAgrupAnoMenos2 As S5T.AviacaoVendasAgrupAnoMenos2 = New S5T.AviacaoVendasAgrupAnoMenos2()
            Me.CopyTo(aviacaoVendasAgrupAnoMenos2, deep)
            Return aviacaoVendasAgrupAnoMenos2
        End Function
        
        Public Overloads Function Clone() As S5T.AviacaoVendasAgrupAnoMenos2
            Dim localClone As S5T.AviacaoVendasAgrupAnoMenos2 = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal aviacaoVendasAgrupAnoMenos2 As S5T.AviacaoVendasAgrupAnoMenos2, ByVal deep As Boolean)
            If (aviacaoVendasAgrupAnoMenos2 Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoVendasAgrupAnoMenos2")
            End If
            aviacaoVendasAgrupAnoMenos2.pId = Me.pId
            aviacaoVendasAgrupAnoMenos2.pVLR_TOTAL_NOTA = Me.pVLR_TOTAL_NOTA
            aviacaoVendasAgrupAnoMenos2.pVLR_BASE_ICM = Me.pVLR_BASE_ICM
            aviacaoVendasAgrupAnoMenos2.pVLR_SEM_ICMSST = Me.pVLR_SEM_ICMSST
            aviacaoVendasAgrupAnoMenos2.pVLR_COFINS = Me.pVLR_COFINS
            aviacaoVendasAgrupAnoMenos2.pVLR_ICM = Me.pVLR_ICM
            aviacaoVendasAgrupAnoMenos2.pPRECO_TABELA = Me.pPRECO_TABELA
            aviacaoVendasAgrupAnoMenos2.pQUANTIDADE = Me.pQUANTIDADE
            aviacaoVendasAgrupAnoMenos2.pVLR_TOTAL_PRODUTO = Me.pVLR_TOTAL_PRODUTO
            aviacaoVendasAgrupAnoMenos2.pVLR_DESCONTO = Me.pVLR_DESCONTO
            aviacaoVendasAgrupAnoMenos2.pPRECO_DE_VENDA = Me.pPRECO_DE_VENDA
            aviacaoVendasAgrupAnoMenos2.pCUSTO_PRODUTO = Me.pCUSTO_PRODUTO
            aviacaoVendasAgrupAnoMenos2.pDESCON_FINAN = Me.pDESCON_FINAN
            aviacaoVendasAgrupAnoMenos2.pCUSTO_PROD_QTD = Me.pCUSTO_PROD_QTD
            aviacaoVendasAgrupAnoMenos2.pMES_EMISSAO = Me.pMES_EMISSAO
            aviacaoVendasAgrupAnoMenos2.pANO_EMISSAO = Me.pANO_EMISSAO
            aviacaoVendasAgrupAnoMenos2.pPRECO_FORA_IMPOSTO = Me.pPRECO_FORA_IMPOSTO
            aviacaoVendasAgrupAnoMenos2.pVLR_PIS = Me.pVLR_PIS
            aviacaoVendasAgrupAnoMenos2.pPRECO_FORA_IMPOSTO_UNIT = Me.pPRECO_FORA_IMPOSTO_UNIT
            aviacaoVendasAgrupAnoMenos2.pCFOP = Me.pCFOP
            aviacaoVendasAgrupAnoMenos2.pIMPOSTO_TOTAL_NOTA = Me.pIMPOSTO_TOTAL_NOTA
            aviacaoVendasAgrupAnoMenos2.pDESCRICAO = Me.pDESCRICAO
            aviacaoVendasAgrupAnoMenos2.pESTADO = Me.pESTADO
            aviacaoVendasAgrupAnoMenos2.pCIDADE_CLIENTE_IBGE = Me.pCIDADE_CLIENTE_IBGE
            aviacaoVendasAgrupAnoMenos2.pREGIAO = Me.pREGIAO
            aviacaoVendasAgrupAnoMenos2.pNOME_VENDEDOR = Me.pNOME_VENDEDOR
            aviacaoVendasAgrupAnoMenos2.pCODIGO_VENDEDOR = Me.pCODIGO_VENDEDOR
            aviacaoVendasAgrupAnoMenos2.pFILIAL = Me.pFILIAL
            aviacaoVendasAgrupAnoMenos2.pCLIENTE = Me.pCLIENTE
            aviacaoVendasAgrupAnoMenos2.pLOJA = Me.pLOJA
            aviacaoVendasAgrupAnoMenos2.pCIDADE_CLIENTE = Me.pCIDADE_CLIENTE
            aviacaoVendasAgrupAnoMenos2.pNOME_CLIENTE = Me.pNOME_CLIENTE
            aviacaoVendasAgrupAnoMenos2.pQTD_P_CAIXA = Me.pQTD_P_CAIXA
            aviacaoVendasAgrupAnoMenos2.pPESO_PRODUTO = Me.pPESO_PRODUTO
            aviacaoVendasAgrupAnoMenos2.pQTD_EM_CAIXA = Me.pQTD_EM_CAIXA
            aviacaoVendasAgrupAnoMenos2.pPESO_BRUTO = Me.pPESO_BRUTO
            aviacaoVendasAgrupAnoMenos2.pPESO_TOTAL = Me.pPESO_TOTAL
            aviacaoVendasAgrupAnoMenos2.pDATA_EMISSAO = Me.pDATA_EMISSAO
            aviacaoVendasAgrupAnoMenos2.pVALOR_COMISSAO = Me.pVALOR_COMISSAO
            aviacaoVendasAgrupAnoMenos2.pTRIMESTRE = Me.pTRIMESTRE
            aviacaoVendasAgrupAnoMenos2.pGRUPO_PRODUTO = Me.pGRUPO_PRODUTO
            aviacaoVendasAgrupAnoMenos2.pPRODUTO = Me.pPRODUTO
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, aviacaoVendasAgrupAnoMenos2))
        End Sub
