...
Namespace S5T
    ...
    Partial Public Class AviacaoVendedoresEmail
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.AviacaoVendedoresEmail), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.AviacaoVendedoresEmail)
        ...
        Public Property pEMAIL_VENDEDOR() As String
            ...
            Set
                ...
                Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("pEMAIL_VENDEDOR"))
            End Set
        End Property
        ...
        Public Overloads Overridable Function Equals(ByVal aviacaoVendedoresEmail As S5T.AviacaoVendedoresEmail) As Boolean Implements System.IEquatable(Of S5T.AviacaoVendedoresEmail).Equals
            If (aviacaoVendedoresEmail Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(aviacaoVendedoresEmail)
            End If
            Return (Me.pId.Equals(aviacaoVendedoresEmail.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                aviacaoVendedoresEmail = CType(obj,S5T.AviacaoVendedoresEmail)
            Catch icex As System.InvalidCastException
                aviacaoVendedoresEmail = Nothing
            End Try
            Return Me.Equals(aviacaoVendedoresEmail)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(aviacaoVendedoresEmail)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal aviacaoVendedoresEmail As S5T.AviacaoVendedoresEmail) As Integer Implements System.IComparable(Of S5T.AviacaoVendedoresEmail).CompareTo
            If (aviacaoVendedoresEmail Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoVendedoresEmail")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(aviacaoVendedoresEmail.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.AviacaoVendedoresEmail.ExternalValidate", "Type 'S5T.AviacaoVendedoresEmail' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendedoresEmail", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.AviacaoVendedoresEmail
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoVendedoresEmail As S5T.AviacaoVendedoresEmail = New S5T.AviacaoVendedoresEmail()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendedoresEmail", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    aviacaoVendedoresEmail.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.AviacaoVendedoresEmail
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoVendedoresEmail As S5T.AviacaoVendedoresEmail = New S5T.AviacaoVendedoresEmail()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendedoresEmail", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5T.AviacaoVendedoresEmail.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendedoresEmail", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
            persistence.AddParameter("@pCODIGO_VENDEDOR", Me.pCODIGO_VENDEDOR, CType(Nothing, String))
            persistence.AddParameter("@pEMAIL_VENDEDOR", Me.pEMAIL_VENDEDOR, CType(Nothing, String))
        ...
        Public Overloads Shared Function Save(ByVal aviacaoVendedoresEmail As S5T.AviacaoVendedoresEmail) As Boolean
            If (aviacaoVendedoresEmail Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal aviacaoVendedoresEmail As S5T.AviacaoVendedoresEmail) As Boolean
            Dim ret As Boolean = S5T.AviacaoVendedoresEmail.Save(aviacaoVendedoresEmail)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal aviacaoVendedoresEmail As S5T.AviacaoVendedoresEmail) As Boolean
            If (aviacaoVendedoresEmail Is Nothing) Then
                Return false
            End If
        ...
        Protected Overridable Sub BaseTrace(ByVal writer As System.CodeDom.Compiler.IndentedTextWriter)
            ...
            writer.Write(",")
            writer.Write("pEMAIL_VENDEDOR=")
            writer.Write(Me.pEMAIL_VENDEDOR)
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.AviacaoVendedoresEmail
            ...
            aviacaoVendedoresEmail = S5T.AviacaoVendedoresEmail.Load(var)
            Return aviacaoVendedoresEmail
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.AviacaoVendedoresEmail
            Dim aviacaoVendedoresEmail As S5T.AviacaoVendedoresEmail = New S5T.AviacaoVendedoresEmail()
            Me.CopyTo(aviacaoVendedoresEmail, deep)
            Return aviacaoVendedoresEmail
        End Function
        
        Public Overloads Function Clone() As S5T.AviacaoVendedoresEmail
            Dim localClone As S5T.AviacaoVendedoresEmail = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overridable Sub CopyFrom(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            End If
            If (dict.Contains("pEMAIL_VENDEDOR") = true) Then
                Me.pEMAIL_VENDEDOR = CType(ConvertUtilities.ChangeType(dict("pEMAIL_VENDEDOR"), GetType(String), CType(Nothing, String)),String)
            End If
        ...
        Public Overloads Overridable Sub CopyTo(ByVal aviacaoVendedoresEmail As S5T.AviacaoVendedoresEmail, ByVal deep As Boolean)
            If (aviacaoVendedoresEmail Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoVendedoresEmail")
            End If
            aviacaoVendedoresEmail.pId = Me.pId
            aviacaoVendedoresEmail.pEMAIL_VENDEDOR = Me.pEMAIL_VENDEDOR
            aviacaoVendedoresEmail.pCODIGO_VENDEDOR = Me.pCODIGO_VENDEDOR
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, aviacaoVendedoresEmail))
        End Sub
        ...
        Public Overloads Overridable Sub CopyTo(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            End If
            dict("pId") = Me.pId
            dict("pEMAIL_VENDEDOR") = Me.pEMAIL_VENDEDOR
