...
Namespace S5T
    ...
    Partial Public Class SetorVisitaCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5T.SetorVisita), System.Collections.Generic.ICollection(Of S5T.SetorVisita), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5T.SetorVisita) = New System.Collections.Generic.List(Of S5T.SetorVisita)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5T.SetorVisita) = New System.Collections.Generic.Dictionary(Of Long, S5T.SetorVisita)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm4220467881 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.SetorVisita)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm4220467881 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.SetorVisita)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5T.SetorVisita)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5T.SetorVisita)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As S5T.SetorVisita Implements System.Collections.Generic.IList(Of S5T.SetorVisita).Item
            Get
                Return CType(Me.BaseList(index),S5T.SetorVisita)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5T.SetorVisita)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5T.SetorVisita
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5T.SetorVisita = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim setorVisita As S5T.SetorVisita = Me.TryGetValue(pId)
                    If (Not (setorVisita) Is Nothing) Then
                        Me.Remove(setorVisita)
                    End If
                    Return
                End If
                Dim existing As S5T.SetorVisita = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5T.SetorVisita).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5T.SetorVisita).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm4220467881.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm4220467881.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5T.SetorVisita, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal setorVisita As S5T.SetorVisita) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(setorVisita)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal setorVisita As S5T.SetorVisita) As Integer
            If (setorVisita Is Nothing) Then
                Throw New System.ArgumentNullException("setorVisita")
            End If
            If (setorVisita.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "setorVisita", "S5T.SetorVisita")
            End If
            Try 
                Me.BaseTable.Add(setorVisita.pId, setorVisita)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.SetorVisitaCollection", setorVisita.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.SetorVisitaCollection", setorVisita.pId), ae)
            End Try
            AddHandler setorVisita.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(setorVisita)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, setorVisita, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            Dim setorVisita As S5T.SetorVisita = Nothing
            Try 
                setorVisita = CType(value,S5T.SetorVisita)
            ...
            If (setorVisita Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(setorVisita)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5T_SetorVisita__Add(ByVal setorVisita As S5T.SetorVisita) Implements System.Collections.Generic.ICollection(Of S5T.SetorVisita).Add
            Me.BaseAdd(setorVisita)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5T.SetorVisita
            Dim setorVisita As S5T.SetorVisita = S5T.SetorVisita.LoadByEntityKey(key)
            If ((Not (setorVisita) Is Nothing)  _
                        AndAlso (Me.Contains(setorVisita) = false)) Then
                Me.Add(setorVisita)
            End If
            Return setorVisita
        End Function
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5T.SetorVisita))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5T.SetorVisita, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5T.SetorVisita).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5T.SetorVisita, ByVal index As Integer)
        ...
        Public Function Contains(ByVal setorVisita As S5T.SetorVisita) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.SetorVisita).Contains
            Dim localContains As Boolean = Me.BaseContains(setorVisita)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal setorVisita As S5T.SetorVisita) As Boolean
            If (setorVisita Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(setorVisita.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            Dim setorVisita As S5T.SetorVisita
            Try 
                setorVisita = CType(value,S5T.SetorVisita)
            Catch icex As System.InvalidCastException
                setorVisita = Nothing
            End Try
            Return Me.Contains(setorVisita)
        End Function
        
        Public Function IndexOf(ByVal setorVisita As S5T.SetorVisita) As Integer Implements System.Collections.Generic.IList(Of S5T.SetorVisita).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(setorVisita)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal setorVisita As S5T.SetorVisita) As Integer
            If (setorVisita Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(setorVisita)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                setorVisita = Nothing
            End Try
            Return Me.IndexOf(setorVisita)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal setorVisita As S5T.SetorVisita) Implements System.Collections.Generic.IList(Of S5T.SetorVisita).Insert
            Me.BaseInsert(index, setorVisita)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal setorVisita As S5T.SetorVisita)
            If (setorVisita Is Nothing) Then
                Throw New System.ArgumentNullException("setorVisita")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.SetorVisitaCollection", setorVisita.pId), ae)
            End Try
            Me.BaseList.Insert(index, setorVisita)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, setorVisita, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                setorVisita = Nothing
            End Try
            Me.Insert(index, setorVisita)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5T.SetorVisita).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim SetorVisita As S5T.SetorVisita = Me(0)
                Me.BaseRemove(SetorVisita)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal setorVisita As S5T.SetorVisita) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.SetorVisita).Remove
            Return Me.BaseRemove(setorVisita)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal setorVisita As S5T.SetorVisita) As Boolean
            If (setorVisita Is Nothing) Then
                Throw New System.ArgumentNullException("setorVisita")
            End If
            Dim index As Integer = Me.IndexOf(setorVisita)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.SetorVisita).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(setorVisita)
            RemoveHandler setorVisita.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(setorVisita.pId)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, setorVisita, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5T.SetorVisita).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.SetorVisita).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim setorVisita As S5T.SetorVisita = Me.BaseList(index)
            If (Not (setorVisita) Is Nothing) Then
                RemoveHandler setorVisita.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(setorVisita.pId)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5T.SetorVisita) Implements System.Collections.Generic.IEnumerable(Of S5T.SetorVisita).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5T.SetorVisita) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5T.SetorVisita
            Dim setorVisita As S5T.SetorVisita = Nothing
            If (Me.BaseTable.TryGetValue(key, setorVisita) = true) Then
                Return setorVisita
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim setorVisita As S5T.SetorVisita = Me(index)
                setorVisita.Save
                If (setorVisita.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(setorVisita)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    Dim setorVisita As S5T.SetorVisita = New S5T.SetorVisita()
                    CType(setorVisita,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(setorVisita) = false) Then
                        Me.BaseAdd(setorVisita)
                        count = (count + 1)
                    End If
                    setorVisita.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Unchanged
                End If
                readerRead = reader.Read
            Loop
        End Sub
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5T.SetorVisitaCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5T.SetorVisitaCollection = New S5T.SetorVisitaCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.SetorVisitaCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5T.SetorVisitaCollection
            Dim ret As S5T.SetorVisitaCollection = S5T.SetorVisitaCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "SetorVisita", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.SetorVisitaCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5T.SetorVisitaCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5T.SetorVisita)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5T.SetorVisita) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5T.SetorVisita))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5T.SetorVisitaCollection
            Dim ret As S5T.SetorVisitaCollection = New S5T.SetorVisitaCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm4220467881.AddIndex([property])
        End Sub
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm4220467881.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm4220467881.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5T.SetorVisita))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5T.SetorVisita = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.SetorVisitaCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.SetorVisitaCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5T.SetorVisitaCollection
            Return S5T.SetorVisitaCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal setorVisita As S5T.SetorVisita) As Boolean
            If (setorVisita Is Nothing) Then
                Return false
            End If
            Dim ret As Boolean = setorVisita.Save
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Shared Function Insert(ByVal setorVisita As S5T.SetorVisita) As Boolean
            Dim ret As Boolean = S5T.SetorVisita.Save(setorVisita)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal setorVisita As S5T.SetorVisita) As Boolean
            If (setorVisita Is Nothing) Then
                Return false
            End If
            Dim ret As Boolean = setorVisita.Delete
            Return ret
        End Function
    End Class
End Namespace
