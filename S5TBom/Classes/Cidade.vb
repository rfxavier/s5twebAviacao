...
Namespace S5T
    ...
    Partial Public Class Cidade
        ...
        <System.NonSerializedAttribute()>  _
        Private _oVisitaCadastroVisitantes As S5T.VisitanteVisitaCollection
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Public ReadOnly Property oVisitaCadastroVisitantes() As S5T.VisitanteVisitaCollection
            Get
                If (Me._oVisitaCadastroVisitantes Is Nothing) Then
                    If ((Me.pId = -1)  _
                                OrElse (Me.EntityState.Equals(CodeFluent.Runtime.CodeFluentEntityState.Created) = true)) Then
                        Me._oVisitaCadastroVisitantes = New S5T.VisitanteVisitaCollection(Me)
                        Return Me._oVisitaCadastroVisitantes
                    End If
                    Me._oVisitaCadastroVisitantes = S5T.VisitanteVisitaCollection.LoadByoCidade(Me)
                End If
                Return Me._oVisitaCadastroVisitantes
            End Get
        End Property
        ...
        Protected Overridable Sub BaseTrace(ByVal writer As System.CodeDom.Compiler.IndentedTextWriter)
            ...
            writer.Write(",")
            writer.Write("oVisitaCadastroVisitantes=")
            If (Not (Me._oVisitaCadastroVisitantes) Is Nothing) Then
                CType(Me._oVisitaCadastroVisitantes,CodeFluent.Runtime.ICodeFluentObject).Trace(writer)
            Else
                writer.Write("<null>")
            End If
