...
Namespace S5T
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("CodeFluent Entities", "1.0.01234.05678"),  _
     ...
     System.Diagnostics.DebuggerDisplayAttribute("EK={EntityKey}, pCodigoProduto={pCodigoProduto}, pId={pId}"),  _
    ...
    Partial Public Class ParametrosFracionamento
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.ParametrosFracionamento), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.ParametrosFracionamento)
        ...
        Private _pImprimeMultiplasEtiquetas As String = CType(Nothing, String)
        ...
        <System.ComponentModel.DefaultValueAttribute(CType(Nothing, String)),  _
         System.Xml.Serialization.XmlElementAttribute(IsNullable:=true, Type:=GetType(String))>  _
        Public Property pImprimeMultiplasEtiquetas() As String
            Get
                Return Me._pImprimeMultiplasEtiquetas
            End Get
            Set
                Me._pImprimeMultiplasEtiquetas = value
                Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("pImprimeMultiplasEtiquetas"))
            End Set
        End Property
        ...
        Public Overloads Overridable Function Equals(ByVal parametrosFracionamento As S5T.ParametrosFracionamento) As Boolean Implements System.IEquatable(Of S5T.ParametrosFracionamento).Equals
            If (parametrosFracionamento Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(parametrosFracionamento)
            End If
            Return (Me.pId.Equals(parametrosFracionamento.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                parametrosFracionamento = CType(obj,S5T.ParametrosFracionamento)
            Catch icex As System.InvalidCastException
                parametrosFracionamento = Nothing
            End Try
            Return Me.Equals(parametrosFracionamento)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(parametrosFracionamento)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal parametrosFracionamento As S5T.ParametrosFracionamento) As Integer Implements System.IComparable(Of S5T.ParametrosFracionamento).CompareTo
            If (parametrosFracionamento Is Nothing) Then
                Throw New System.ArgumentNullException("parametrosFracionamento")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(parametrosFracionamento.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.ParametrosFracionamento.ExternalValidate", "Type 'S5T.ParametrosFracionamento' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "ParametrosFracionamento", "Delete")
        ...
        Protected Overridable Sub ReadRecord(ByVal reader As System.Data.IDataReader, ByVal options As CodeFluent.Runtime.CodeFluentReloadOptions)
            ...
            If (((options And CodeFluent.Runtime.CodeFluentReloadOptions.Properties)  _
                ...
                Me._pImprimeMultiplasEtiquetas = CodeFluentPersistence.GetReaderValue(reader, "pImprimeMultiplasEtiquetas", CType(CType(Nothing, String),String))
            End If
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.ParametrosFracionamento
            If (pId = -1) Then
                Return Nothing
            End If
            Dim parametrosFracionamento As S5T.ParametrosFracionamento = New S5T.ParametrosFracionamento()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "ParametrosFracionamento", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    parametrosFracionamento.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.ParametrosFracionamento
            If (pId = -1) Then
                Return Nothing
            End If
            Dim parametrosFracionamento As S5T.ParametrosFracionamento = New S5T.ParametrosFracionamento()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "ParametrosFracionamento", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5T.ParametrosFracionamento.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "ParametrosFracionamento", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
            persistence.AddParameter("@pCodigoProduto", Me.pCodigoProduto, CType(Nothing, String))
            persistence.AddParameter("@pImprimeMultiplasEtiquetas", Me.pImprimeMultiplasEtiquetas, CType(Nothing, String))
        ...
        Public Overloads Shared Function Save(ByVal parametrosFracionamento As S5T.ParametrosFracionamento) As Boolean
            If (parametrosFracionamento Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal parametrosFracionamento As S5T.ParametrosFracionamento) As Boolean
            Dim ret As Boolean = S5T.ParametrosFracionamento.Save(parametrosFracionamento)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal parametrosFracionamento As S5T.ParametrosFracionamento) As Boolean
            If (parametrosFracionamento Is Nothing) Then
                Return false
            End If
        ...
        Protected Overridable Sub BaseTrace(ByVal writer As System.CodeDom.Compiler.IndentedTextWriter)
            ...
            writer.Write(",")
            writer.Write("pImprimeMultiplasEtiquetas=")
            writer.Write(Me.pImprimeMultiplasEtiquetas)
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.ParametrosFracionamento
            ...
            parametrosFracionamento = S5T.ParametrosFracionamento.Load(var)
            Return parametrosFracionamento
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.ParametrosFracionamento
            Dim parametrosFracionamento As S5T.ParametrosFracionamento = New S5T.ParametrosFracionamento()
            Me.CopyTo(parametrosFracionamento, deep)
            Return parametrosFracionamento
        End Function
        
        Public Overloads Function Clone() As S5T.ParametrosFracionamento
            Dim localClone As S5T.ParametrosFracionamento = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overridable Sub CopyFrom(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            End If
            If (dict.Contains("pImprimeMultiplasEtiquetas") = true) Then
                Me.pImprimeMultiplasEtiquetas = CType(ConvertUtilities.ChangeType(dict("pImprimeMultiplasEtiquetas"), GetType(String), CType(Nothing, String)),String)
            End If
        ...
        Public Overloads Overridable Sub CopyTo(ByVal parametrosFracionamento As S5T.ParametrosFracionamento, ByVal deep As Boolean)
            If (parametrosFracionamento Is Nothing) Then
                Throw New System.ArgumentNullException("parametrosFracionamento")
            End If
            parametrosFracionamento.pId = Me.pId
            parametrosFracionamento.pImprimeMultiplasEtiquetas = Me.pImprimeMultiplasEtiquetas
            parametrosFracionamento.pCodigoProduto = Me.pCodigoProduto
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, parametrosFracionamento))
        End Sub
        ...
        Public Overloads Overridable Sub CopyTo(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            End If
            dict("pId") = Me.pId
            dict("pImprimeMultiplasEtiquetas") = Me.pImprimeMultiplasEtiquetas
