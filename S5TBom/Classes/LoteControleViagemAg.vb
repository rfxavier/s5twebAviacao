...
Namespace S5T
    ...
    Partial Public Class LoteControleViagemAg
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.LoteControleViagemAg), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.LoteControleViagemAg)
        ...
        Public Overloads Overridable Function Equals(ByVal loteControleViagemAg As S5T.LoteControleViagemAg) As Boolean Implements System.IEquatable(Of S5T.LoteControleViagemAg).Equals
            If (loteControleViagemAg Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(loteControleViagemAg)
            End If
            Return (Me.pId.Equals(loteControleViagemAg.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                loteControleViagemAg = CType(obj,S5T.LoteControleViagemAg)
            Catch icex As System.InvalidCastException
                loteControleViagemAg = Nothing
            End Try
            Return Me.Equals(loteControleViagemAg)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(loteControleViagemAg)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal loteControleViagemAg As S5T.LoteControleViagemAg) As Integer Implements System.IComparable(Of S5T.LoteControleViagemAg).CompareTo
            If (loteControleViagemAg Is Nothing) Then
                Throw New System.ArgumentNullException("loteControleViagemAg")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(loteControleViagemAg.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.LoteControleViagemAg.ExternalValidate", "Type 'S5T.LoteControleViagemAg' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "LoteControleViagemAg", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.LoteControleViagemAg
            If (pId = -1) Then
                Return Nothing
            End If
            Dim loteControleViagemAg As S5T.LoteControleViagemAg = New S5T.LoteControleViagemAg()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "LoteControleViagemAg", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    loteControleViagemAg.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.LoteControleViagemAg
            If (pId = -1) Then
                Return Nothing
            End If
            Dim loteControleViagemAg As S5T.LoteControleViagemAg = New S5T.LoteControleViagemAg()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "LoteControleViagemAg", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5T.LoteControleViagemAg.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "LoteControleViagemAg", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal loteControleViagemAg As S5T.LoteControleViagemAg) As Boolean
            If (loteControleViagemAg Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal loteControleViagemAg As S5T.LoteControleViagemAg) As Boolean
            Dim ret As Boolean = S5T.LoteControleViagemAg.Save(loteControleViagemAg)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal loteControleViagemAg As S5T.LoteControleViagemAg) As Boolean
            If (loteControleViagemAg Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.LoteControleViagemAg
            ...
            loteControleViagemAg = S5T.LoteControleViagemAg.Load(var)
            Return loteControleViagemAg
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.LoteControleViagemAg
            Dim loteControleViagemAg As S5T.LoteControleViagemAg = New S5T.LoteControleViagemAg()
            Me.CopyTo(loteControleViagemAg, deep)
            Return loteControleViagemAg
        End Function
        
        Public Overloads Function Clone() As S5T.LoteControleViagemAg
            Dim localClone As S5T.LoteControleViagemAg = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal loteControleViagemAg As S5T.LoteControleViagemAg, ByVal deep As Boolean)
            If (loteControleViagemAg Is Nothing) Then
                Throw New System.ArgumentNullException("loteControleViagemAg")
            End If
            loteControleViagemAg.pId = Me.pId
            loteControleViagemAg.pLote = Me.pLote
            loteControleViagemAg.oControleViagemAgpId = Me.oControleViagemAgpId
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, loteControleViagemAg))
        End Sub
