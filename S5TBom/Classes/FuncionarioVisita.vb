...
Namespace S5T
    ...
    Partial Public Class FuncionarioVisita
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.FuncionarioVisita), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.FuncionarioVisita)
            ...
            Get
                If (Me._oVisitaMovs Is Nothing) Then
                    If ((Me.pId = -1)  _
                        ...
                        Me._oVisitaMovs = New S5T.VisitaMovCollection(Nothing, Me, Nothing, Nothing)
                        Return Me._oVisitaMovs
                    End If
                    Me._oVisitaMovs = S5T.VisitaMovCollection.LoadByoFuncionario(Me)
                End If
                Return Me._oVisitaMovs
            End Get
        End Property
        ...
        Public Overloads Overridable Function Equals(ByVal funcionarioVisita As S5T.FuncionarioVisita) As Boolean Implements System.IEquatable(Of S5T.FuncionarioVisita).Equals
            If (funcionarioVisita Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(funcionarioVisita)
            End If
            Return (Me.pId.Equals(funcionarioVisita.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                funcionarioVisita = CType(obj,S5T.FuncionarioVisita)
            Catch icex As System.InvalidCastException
                funcionarioVisita = Nothing
            End Try
            Return Me.Equals(funcionarioVisita)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(funcionarioVisita)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal funcionarioVisita As S5T.FuncionarioVisita) As Integer Implements System.IComparable(Of S5T.FuncionarioVisita).CompareTo
            If (funcionarioVisita Is Nothing) Then
                Throw New System.ArgumentNullException("funcionarioVisita")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(funcionarioVisita.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.FuncionarioVisita.ExternalValidate", "Type 'S5T.FuncionarioVisita' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "FuncionarioVisita", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.FuncionarioVisita
            If (pId = -1) Then
                Return Nothing
            End If
            Dim funcionarioVisita As S5T.FuncionarioVisita = New S5T.FuncionarioVisita()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "FuncionarioVisita", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    funcionarioVisita.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.FuncionarioVisita
            If (pId = -1) Then
                Return Nothing
            End If
            Dim funcionarioVisita As S5T.FuncionarioVisita = New S5T.FuncionarioVisita()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "FuncionarioVisita", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5T.FuncionarioVisita.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "FuncionarioVisita", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal funcionarioVisita As S5T.FuncionarioVisita) As Boolean
            If (funcionarioVisita Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal funcionarioVisita As S5T.FuncionarioVisita) As Boolean
            Dim ret As Boolean = S5T.FuncionarioVisita.Save(funcionarioVisita)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal funcionarioVisita As S5T.FuncionarioVisita) As Boolean
            If (funcionarioVisita Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.FuncionarioVisita
            ...
            funcionarioVisita = S5T.FuncionarioVisita.Load(var)
            Return funcionarioVisita
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.FuncionarioVisita
            Dim funcionarioVisita As S5T.FuncionarioVisita = New S5T.FuncionarioVisita()
            Me.CopyTo(funcionarioVisita, deep)
            Return funcionarioVisita
        End Function
        
        Public Overloads Function Clone() As S5T.FuncionarioVisita
            Dim localClone As S5T.FuncionarioVisita = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal funcionarioVisita As S5T.FuncionarioVisita, ByVal deep As Boolean)
            If (funcionarioVisita Is Nothing) Then
                Throw New System.ArgumentNullException("funcionarioVisita")
            End If
            funcionarioVisita.pId = Me.pId
            funcionarioVisita.pNome = Me.pNome
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, funcionarioVisita))
        End Sub
