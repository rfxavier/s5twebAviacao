...
Namespace S5T
    ...
    Partial Public Class EmbalagemFracionamento
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.EmbalagemFracionamento), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.EmbalagemFracionamento)
        ...
        Private _oTaraFracionamentos As S5T.TaraFracionamentoCollection
        ...
        Public Property pPeso() As Double
            ...
            Set
                Me._pPeso = value
                Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("pPeso"))
            End Set
        End Property
        
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Public ReadOnly Property oTaraFracionamentos() As S5T.TaraFracionamentoCollection
            Get
                If (Me._oTaraFracionamentos Is Nothing) Then
                    If ((Me.pId = -1)  _
                                OrElse (Me.EntityState.Equals(CodeFluent.Runtime.CodeFluentEntityState.Created) = true)) Then
                        Me._oTaraFracionamentos = New S5T.TaraFracionamentoCollection(Me)
                        Return Me._oTaraFracionamentos
                    End If
                    Me._oTaraFracionamentos = S5T.TaraFracionamentoCollection.LoadByoEmbalagem(Me)
                End If
                Return Me._oTaraFracionamentos
            End Get
        End Property
        ...
        Public Overloads Overridable Function Equals(ByVal embalagemFracionamento As S5T.EmbalagemFracionamento) As Boolean Implements System.IEquatable(Of S5T.EmbalagemFracionamento).Equals
            If (embalagemFracionamento Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(embalagemFracionamento)
            End If
            Return (Me.pId.Equals(embalagemFracionamento.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                embalagemFracionamento = CType(obj,S5T.EmbalagemFracionamento)
            Catch icex As System.InvalidCastException
                embalagemFracionamento = Nothing
            End Try
            Return Me.Equals(embalagemFracionamento)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(embalagemFracionamento)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal embalagemFracionamento As S5T.EmbalagemFracionamento) As Integer Implements System.IComparable(Of S5T.EmbalagemFracionamento).CompareTo
            If (embalagemFracionamento Is Nothing) Then
                Throw New System.ArgumentNullException("embalagemFracionamento")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(embalagemFracionamento.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.EmbalagemFracionamento.ExternalValidate", "Type 'S5T.EmbalagemFracionamento' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "EmbalagemFracionamento", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.EmbalagemFracionamento
            If (pId = -1) Then
                Return Nothing
            End If
            Dim embalagemFracionamento As S5T.EmbalagemFracionamento = New S5T.EmbalagemFracionamento()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "EmbalagemFracionamento", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    embalagemFracionamento.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.EmbalagemFracionamento
            If (pId = -1) Then
                Return Nothing
            End If
            Dim embalagemFracionamento As S5T.EmbalagemFracionamento = New S5T.EmbalagemFracionamento()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "EmbalagemFracionamento", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5T.EmbalagemFracionamento.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "EmbalagemFracionamento", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
            persistence.AddParameter("@pDescricao", Me.pDescricao, CType(Nothing, String))
            persistence.AddParameter("@pPeso", Me.pPeso, CodeFluentPersistence.DefaultDoubleValue)
        ...
        Public Overloads Shared Function Save(ByVal embalagemFracionamento As S5T.EmbalagemFracionamento) As Boolean
            If (embalagemFracionamento Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal embalagemFracionamento As S5T.EmbalagemFracionamento) As Boolean
            Dim ret As Boolean = S5T.EmbalagemFracionamento.Save(embalagemFracionamento)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal embalagemFracionamento As S5T.EmbalagemFracionamento) As Boolean
            If (embalagemFracionamento Is Nothing) Then
                Return false
            End If
        ...
        Protected Overridable Sub BaseTrace(ByVal writer As System.CodeDom.Compiler.IndentedTextWriter)
            ...
            writer.Write(",")
            writer.Write("pPeso=")
            writer.Write(Me.pPeso)
            writer.Write(",")
            writer.Write("oTaraFracionamentos=")
            If (Not (Me._oTaraFracionamentos) Is Nothing) Then
                CType(Me._oTaraFracionamentos,CodeFluent.Runtime.ICodeFluentObject).Trace(writer)
            Else
                writer.Write("<null>")
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.EmbalagemFracionamento
            ...
            embalagemFracionamento = S5T.EmbalagemFracionamento.Load(var)
            Return embalagemFracionamento
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.EmbalagemFracionamento
            Dim embalagemFracionamento As S5T.EmbalagemFracionamento = New S5T.EmbalagemFracionamento()
            Me.CopyTo(embalagemFracionamento, deep)
            Return embalagemFracionamento
        End Function
        
        Public Overloads Function Clone() As S5T.EmbalagemFracionamento
            Dim localClone As S5T.EmbalagemFracionamento = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overridable Sub CopyFrom(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            End If
            If (dict.Contains("pPeso") = true) Then
                Me.pPeso = CType(ConvertUtilities.ChangeType(dict("pPeso"), GetType(Double), CodeFluentPersistence.DefaultDoubleValue),Double)
            End If
        ...
        Public Overloads Overridable Sub CopyTo(ByVal embalagemFracionamento As S5T.EmbalagemFracionamento, ByVal deep As Boolean)
            If (embalagemFracionamento Is Nothing) Then
                Throw New System.ArgumentNullException("embalagemFracionamento")
            End If
            embalagemFracionamento.pId = Me.pId
            embalagemFracionamento.pPeso = Me.pPeso
            embalagemFracionamento.pDescricao = Me.pDescricao
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, embalagemFracionamento))
        End Sub
