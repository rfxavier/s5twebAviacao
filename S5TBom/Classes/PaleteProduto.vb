...
Namespace S5T
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("CodeFluent Entities", "1.0.01234.05678"),  _
     ...
     System.Diagnostics.DebuggerDisplayAttribute("EK={EntityKey}, pCodProduto={pCodProduto}, pId={pId}"),  _
     System.ComponentModel.TypeConverterAttribute(GetType(CodeFluent.Runtime.Design.NameTypeConverter))>  _
    Partial Public Class PaleteProduto
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.PaleteProduto), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.PaleteProduto)
        ...
        Private _pCodProduto As String = CType(Nothing, String)
        
        Private _pDescProduto As String = CType(Nothing, String)
        
        Private _pProdutoEmb As String = CType(Nothing, String)
        
        Private _pQuantidade As Double = CodeFluentPersistence.DefaultDoubleValue
        
        <System.NonSerializedAttribute()>  _
        Private _oPaleteMovs As S5T.PaleteMovCollection
        ...
        Public Property pCodProduto() As String
            Get
                Return Me._pCodProduto
            End Get
            Set
                Me._pCodProduto = value
                Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("pCodProduto"))
            End Set
        End Property
        
        <System.ComponentModel.DefaultValueAttribute(CType(Nothing, String)),  _
         System.Xml.Serialization.XmlElementAttribute(IsNullable:=true, Type:=GetType(String))>  _
        Public Property pDescProduto() As String
            Get
                Return Me._pDescProduto
            End Get
            Set
                Me._pDescProduto = value
                Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("pDescProduto"))
            End Set
        End Property
        
        <System.ComponentModel.DefaultValueAttribute(CType(Nothing, String)),  _
         System.Xml.Serialization.XmlElementAttribute(IsNullable:=true, Type:=GetType(String))>  _
        Public Property pProdutoEmb() As String
            Get
                Return Me._pProdutoEmb
            End Get
            Set
                Me._pProdutoEmb = value
                Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("pProdutoEmb"))
            End Set
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Public ReadOnly Property oPaleteMovs() As S5T.PaleteMovCollection
            Get
                If (Me._oPaleteMovs Is Nothing) Then
                    If ((Me.pId = -1)  _
                                OrElse (Me.EntityState.Equals(CodeFluent.Runtime.CodeFluentEntityState.Created) = true)) Then
                        Me._oPaleteMovs = New S5T.PaleteMovCollection(Me)
                        Return Me._oPaleteMovs
                    End If
                    Me._oPaleteMovs = S5T.PaleteMovCollection.LoadByoPaleteProduto(Me)
                End If
                Return Me._oPaleteMovs
            End Get
        End Property
        ...
        Public Overloads Overridable Function Equals(ByVal paleteProduto As S5T.PaleteProduto) As Boolean Implements System.IEquatable(Of S5T.PaleteProduto).Equals
            If (paleteProduto Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(paleteProduto)
            End If
            Return (Me.pId.Equals(paleteProduto.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                paleteProduto = CType(obj,S5T.PaleteProduto)
            Catch icex As System.InvalidCastException
                paleteProduto = Nothing
            End Try
            Return Me.Equals(paleteProduto)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(paleteProduto)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal paleteProduto As S5T.PaleteProduto) As Integer Implements System.IComparable(Of S5T.PaleteProduto).CompareTo
            If (paleteProduto Is Nothing) Then
                Throw New System.ArgumentNullException("paleteProduto")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(paleteProduto.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.PaleteProduto.ExternalValidate", "Type 'S5T.PaleteProduto' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "PaleteProduto", "Delete")
        ...
        Protected Overridable Sub ReadRecord(ByVal reader As System.Data.IDataReader, ByVal options As CodeFluent.Runtime.CodeFluentReloadOptions)
            ...
            If (((options And CodeFluent.Runtime.CodeFluentReloadOptions.Properties)  _
                ...
                Me._pCodProduto = CodeFluentPersistence.GetReaderValue(reader, "pCodProduto", CType(CType(Nothing, String),String))
                Me._pDescProduto = CodeFluentPersistence.GetReaderValue(reader, "pDescProduto", CType(CType(Nothing, String),String))
                Me._pProdutoEmb = CodeFluentPersistence.GetReaderValue(reader, "pProdutoEmb", CType(CType(Nothing, String),String))
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.PaleteProduto
            If (pId = -1) Then
                Return Nothing
            End If
            Dim paleteProduto As S5T.PaleteProduto = New S5T.PaleteProduto()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "PaleteProduto", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    paleteProduto.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.PaleteProduto
            If (pId = -1) Then
                Return Nothing
            End If
            Dim paleteProduto As S5T.PaleteProduto = New S5T.PaleteProduto()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "PaleteProduto", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "PaleteProduto", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
            persistence.AddParameter("@pCodProduto", Me.pCodProduto, CType(Nothing, String))
            persistence.AddParameter("@pDescProduto", Me.pDescProduto, CType(Nothing, String))
            persistence.AddParameter("@pProdutoEmb", Me.pProdutoEmb, CType(Nothing, String))
        ...
        Public Overloads Shared Function Save(ByVal paleteProduto As S5T.PaleteProduto) As Boolean
            If (paleteProduto Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal paleteProduto As S5T.PaleteProduto) As Boolean
            Dim ret As Boolean = S5T.PaleteProduto.Save(paleteProduto)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal paleteProduto As S5T.PaleteProduto) As Boolean
            If (paleteProduto Is Nothing) Then
                Return false
            End If
        ...
        Protected Overridable Sub BaseTrace(ByVal writer As System.CodeDom.Compiler.IndentedTextWriter)
            ...
            writer.Write(Me.pId)
            writer.Write(",")
            writer.Write("pCodProduto=")
            writer.Write(Me.pCodProduto)
            writer.Write(",")
            writer.Write("pDescProduto=")
            writer.Write(Me.pDescProduto)
            writer.Write(",")
            writer.Write("pProdutoEmb=")
            writer.Write(Me.pProdutoEmb)
            writer.Write(",")
            writer.Write("pQuantidade=")
            writer.Write(Me.pQuantidade)
            writer.Write(",")
            writer.Write("oPaleteMovs=")
            If (Not (Me._oPaleteMovs) Is Nothing) Then
                CType(Me._oPaleteMovs,CodeFluent.Runtime.ICodeFluentObject).Trace(writer)
            Else
                writer.Write("<null>")
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.PaleteProduto
            ...
            paleteProduto = S5T.PaleteProduto.Load(var)
            Return paleteProduto
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.PaleteProduto
            Dim paleteProduto As S5T.PaleteProduto = New S5T.PaleteProduto()
            Me.CopyTo(paleteProduto, deep)
            Return paleteProduto
        End Function
        
        Public Overloads Function Clone() As S5T.PaleteProduto
            Dim localClone As S5T.PaleteProduto = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overridable Sub CopyFrom(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            End If
            If (dict.Contains("pProdutoEmb") = true) Then
                Me.pProdutoEmb = CType(ConvertUtilities.ChangeType(dict("pProdutoEmb"), GetType(String), CType(Nothing, String)),String)
            End If
            ...
            End If
            If (dict.Contains("pCodProduto") = true) Then
                Me.pCodProduto = CType(ConvertUtilities.ChangeType(dict("pCodProduto"), GetType(String), CType(Nothing, String)),String)
            End If
            If (dict.Contains("pDescProduto") = true) Then
                Me.pDescProduto = CType(ConvertUtilities.ChangeType(dict("pDescProduto"), GetType(String), CType(Nothing, String)),String)
            End If
        ...
        Public Overloads Overridable Sub CopyTo(ByVal paleteProduto As S5T.PaleteProduto, ByVal deep As Boolean)
            If (paleteProduto Is Nothing) Then
                Throw New System.ArgumentNullException("paleteProduto")
            End If
            paleteProduto.pId = Me.pId
            paleteProduto.pProdutoEmb = Me.pProdutoEmb
            paleteProduto.pQuantidade = Me.pQuantidade
            paleteProduto.pCodProduto = Me.pCodProduto
            paleteProduto.pDescProduto = Me.pDescProduto
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, paleteProduto))
        End Sub
        ...
        Public Overloads Overridable Sub CopyTo(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            End If
            dict("pId") = Me.pId
            dict("pProdutoEmb") = Me.pProdutoEmb
            dict("pQuantidade") = Me.pQuantidade
            dict("pCodProduto") = Me.pCodProduto
            dict("pDescProduto") = Me.pDescProduto
