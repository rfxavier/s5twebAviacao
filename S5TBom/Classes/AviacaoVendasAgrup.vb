...
Namespace S5T
    ...
    Partial Public Class AviacaoVendasAgrup
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.AviacaoVendasAgrup), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.AviacaoVendasAgrup)
        ...
        Public Overloads Overridable Function Equals(ByVal aviacaoVendasAgrup As S5T.AviacaoVendasAgrup) As Boolean Implements System.IEquatable(Of S5T.AviacaoVendasAgrup).Equals
            If (aviacaoVendasAgrup Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(aviacaoVendasAgrup)
            End If
            Return (Me.pId.Equals(aviacaoVendasAgrup.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                aviacaoVendasAgrup = CType(obj,S5T.AviacaoVendasAgrup)
            Catch icex As System.InvalidCastException
                aviacaoVendasAgrup = Nothing
            End Try
            Return Me.Equals(aviacaoVendasAgrup)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(aviacaoVendasAgrup)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal aviacaoVendasAgrup As S5T.AviacaoVendasAgrup) As Integer Implements System.IComparable(Of S5T.AviacaoVendasAgrup).CompareTo
            If (aviacaoVendasAgrup Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoVendasAgrup")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(aviacaoVendasAgrup.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.AviacaoVendasAgrup.ExternalValidate", "Type 'S5T.AviacaoVendasAgrup' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAgrup", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.AviacaoVendasAgrup
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoVendasAgrup As S5T.AviacaoVendasAgrup = New S5T.AviacaoVendasAgrup()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAgrup", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    aviacaoVendasAgrup.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.AviacaoVendasAgrup
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoVendasAgrup As S5T.AviacaoVendasAgrup = New S5T.AviacaoVendasAgrup()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAgrup", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5T.AviacaoVendasAgrup.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAgrup", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal aviacaoVendasAgrup As S5T.AviacaoVendasAgrup) As Boolean
            If (aviacaoVendasAgrup Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal aviacaoVendasAgrup As S5T.AviacaoVendasAgrup) As Boolean
            Dim ret As Boolean = S5T.AviacaoVendasAgrup.Save(aviacaoVendasAgrup)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal aviacaoVendasAgrup As S5T.AviacaoVendasAgrup) As Boolean
            If (aviacaoVendasAgrup Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.AviacaoVendasAgrup
            ...
            aviacaoVendasAgrup = S5T.AviacaoVendasAgrup.Load(var)
            Return aviacaoVendasAgrup
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.AviacaoVendasAgrup
            Dim aviacaoVendasAgrup As S5T.AviacaoVendasAgrup = New S5T.AviacaoVendasAgrup()
            Me.CopyTo(aviacaoVendasAgrup, deep)
            Return aviacaoVendasAgrup
        End Function
        
        Public Overloads Function Clone() As S5T.AviacaoVendasAgrup
            Dim localClone As S5T.AviacaoVendasAgrup = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal aviacaoVendasAgrup As S5T.AviacaoVendasAgrup, ByVal deep As Boolean)
            If (aviacaoVendasAgrup Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoVendasAgrup")
            End If
            aviacaoVendasAgrup.pId = Me.pId
            aviacaoVendasAgrup.pVLR_TOTAL_NOTA = Me.pVLR_TOTAL_NOTA
            aviacaoVendasAgrup.pVLR_BASE_ICM = Me.pVLR_BASE_ICM
            aviacaoVendasAgrup.pVLR_SEM_ICMSST = Me.pVLR_SEM_ICMSST
            aviacaoVendasAgrup.pVLR_COFINS = Me.pVLR_COFINS
            aviacaoVendasAgrup.pVLR_ICM = Me.pVLR_ICM
            aviacaoVendasAgrup.pPRECO_TABELA = Me.pPRECO_TABELA
            aviacaoVendasAgrup.pQUANTIDADE = Me.pQUANTIDADE
            aviacaoVendasAgrup.pVLR_TOTAL_PRODUTO = Me.pVLR_TOTAL_PRODUTO
            aviacaoVendasAgrup.pVLR_DESCONTO = Me.pVLR_DESCONTO
            aviacaoVendasAgrup.pPRECO_DE_VENDA = Me.pPRECO_DE_VENDA
            aviacaoVendasAgrup.pVLR_PIS = Me.pVLR_PIS
            aviacaoVendasAgrup.pCUSTO_PRODUTO = Me.pCUSTO_PRODUTO
            aviacaoVendasAgrup.pVALOR_DESC_FINAN = Me.pVALOR_DESC_FINAN
            aviacaoVendasAgrup.pCUSTO_PROD_QTD = Me.pCUSTO_PROD_QTD
            aviacaoVendasAgrup.pMES_EMISSAO = Me.pMES_EMISSAO
            aviacaoVendasAgrup.pANO_EMISSAO = Me.pANO_EMISSAO
            aviacaoVendasAgrup.pPRECO_FORA_IMPOSTO_UNIT = Me.pPRECO_FORA_IMPOSTO_UNIT
            aviacaoVendasAgrup.pPRECO_FORA_IMPOSTO = Me.pPRECO_FORA_IMPOSTO
            aviacaoVendasAgrup.pIMPOSTO_TOTAL_NOTA = Me.pIMPOSTO_TOTAL_NOTA
            aviacaoVendasAgrup.pDESCON_FINAN = Me.pDESCON_FINAN
            aviacaoVendasAgrup.pCFOP = Me.pCFOP
            aviacaoVendasAgrup.pESTADO = Me.pESTADO
            aviacaoVendasAgrup.pCIDADE_CLIENTE_IBGE = Me.pCIDADE_CLIENTE_IBGE
            aviacaoVendasAgrup.pREGIAO = Me.pREGIAO
            aviacaoVendasAgrup.pNOME_VENDEDOR = Me.pNOME_VENDEDOR
            aviacaoVendasAgrup.pCODIGO_VENDEDOR = Me.pCODIGO_VENDEDOR
            aviacaoVendasAgrup.pFILIAL = Me.pFILIAL
            aviacaoVendasAgrup.pCLIENTE = Me.pCLIENTE
            aviacaoVendasAgrup.pLOJA = Me.pLOJA
            aviacaoVendasAgrup.pCIDADE_CLIENTE = Me.pCIDADE_CLIENTE
            aviacaoVendasAgrup.pNOME_CLIENTE = Me.pNOME_CLIENTE
            aviacaoVendasAgrup.pVALOR_COMISSAO = Me.pVALOR_COMISSAO
            aviacaoVendasAgrup.pQTD_EM_CAIXA = Me.pQTD_EM_CAIXA
            aviacaoVendasAgrup.pQTD_P_CAIXA = Me.pQTD_P_CAIXA
            aviacaoVendasAgrup.pPESO_TOTAL = Me.pPESO_TOTAL
            aviacaoVendasAgrup.pDESCRICAO = Me.pDESCRICAO
            aviacaoVendasAgrup.pPESO_BRUTO = Me.pPESO_BRUTO
            aviacaoVendasAgrup.pTRIMESTRE = Me.pTRIMESTRE
            aviacaoVendasAgrup.pDATA_EMISSAO = Me.pDATA_EMISSAO
            aviacaoVendasAgrup.pPRODUTO = Me.pPRODUTO
            aviacaoVendasAgrup.pPESO_PRODUTO = Me.pPESO_PRODUTO
            aviacaoVendasAgrup.pGRUPO_PRODUTO = Me.pGRUPO_PRODUTO
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, aviacaoVendasAgrup))
        End Sub
