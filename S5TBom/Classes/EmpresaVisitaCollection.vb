...
Namespace S5T
    ...
    Partial Public Class EmpresaVisitaCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5T.EmpresaVisita), System.Collections.Generic.ICollection(Of S5T.EmpresaVisita), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5T.EmpresaVisita) = New System.Collections.Generic.List(Of S5T.EmpresaVisita)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5T.EmpresaVisita) = New System.Collections.Generic.Dictionary(Of Long, S5T.EmpresaVisita)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm92924114 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.EmpresaVisita)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm92924114 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.EmpresaVisita)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5T.EmpresaVisita)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5T.EmpresaVisita)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As S5T.EmpresaVisita Implements System.Collections.Generic.IList(Of S5T.EmpresaVisita).Item
            Get
                Return CType(Me.BaseList(index),S5T.EmpresaVisita)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5T.EmpresaVisita)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5T.EmpresaVisita
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5T.EmpresaVisita = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim empresaVisita As S5T.EmpresaVisita = Me.TryGetValue(pId)
                    If (Not (empresaVisita) Is Nothing) Then
                        Me.Remove(empresaVisita)
                    End If
                    Return
                End If
                Dim existing As S5T.EmpresaVisita = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5T.EmpresaVisita).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5T.EmpresaVisita).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm92924114.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm92924114.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5T.EmpresaVisita, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal empresaVisita As S5T.EmpresaVisita) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(empresaVisita)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal empresaVisita As S5T.EmpresaVisita) As Integer
            If (empresaVisita Is Nothing) Then
                Throw New System.ArgumentNullException("empresaVisita")
            End If
            If (empresaVisita.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "empresaVisita", "S5T.EmpresaVisita")
            End If
            Try 
                Me.BaseTable.Add(empresaVisita.pId, empresaVisita)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.EmpresaVisitaCollection", empresaVisita.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.EmpresaVisitaCollection", empresaVisita.pId), ae)
            End Try
            AddHandler empresaVisita.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(empresaVisita)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, empresaVisita, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            Dim empresaVisita As S5T.EmpresaVisita = Nothing
            Try 
                empresaVisita = CType(value,S5T.EmpresaVisita)
            Catch icex As System.InvalidCastException
                empresaVisita = Nothing
            ...
            If (empresaVisita Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(empresaVisita)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5T_EmpresaVisita__Add(ByVal empresaVisita As S5T.EmpresaVisita) Implements System.Collections.Generic.ICollection(Of S5T.EmpresaVisita).Add
            Me.BaseAdd(empresaVisita)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5T.EmpresaVisita
            Dim empresaVisita As S5T.EmpresaVisita = S5T.EmpresaVisita.LoadByEntityKey(key)
            If ((Not (empresaVisita) Is Nothing)  _
                        AndAlso (Me.Contains(empresaVisita) = false)) Then
                Me.Add(empresaVisita)
            End If
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5T.EmpresaVisita))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5T.EmpresaVisita, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5T.EmpresaVisita).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5T.EmpresaVisita, ByVal index As Integer)
        ...
        Public Function Contains(ByVal empresaVisita As S5T.EmpresaVisita) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.EmpresaVisita).Contains
            Dim localContains As Boolean = Me.BaseContains(empresaVisita)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal empresaVisita As S5T.EmpresaVisita) As Boolean
            If (empresaVisita Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(empresaVisita.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            Dim empresaVisita As S5T.EmpresaVisita
            Try 
                empresaVisita = CType(value,S5T.EmpresaVisita)
            Catch icex As System.InvalidCastException
                empresaVisita = Nothing
            End Try
            Return Me.Contains(empresaVisita)
        End Function
        
        Public Function IndexOf(ByVal empresaVisita As S5T.EmpresaVisita) As Integer Implements System.Collections.Generic.IList(Of S5T.EmpresaVisita).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(empresaVisita)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal empresaVisita As S5T.EmpresaVisita) As Integer
            If (empresaVisita Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(empresaVisita)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                empresaVisita = Nothing
            End Try
            Return Me.IndexOf(empresaVisita)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal empresaVisita As S5T.EmpresaVisita) Implements System.Collections.Generic.IList(Of S5T.EmpresaVisita).Insert
            Me.BaseInsert(index, empresaVisita)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal empresaVisita As S5T.EmpresaVisita)
            If (empresaVisita Is Nothing) Then
                Throw New System.ArgumentNullException("empresaVisita")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.EmpresaVisitaCollection", empresaVisita.pId), ae)
            End Try
            Me.BaseList.Insert(index, empresaVisita)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, empresaVisita, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                empresaVisita = Nothing
            End Try
            Me.Insert(index, empresaVisita)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5T.EmpresaVisita).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim EmpresaVisita As S5T.EmpresaVisita = Me(0)
                Me.BaseRemove(EmpresaVisita)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal empresaVisita As S5T.EmpresaVisita) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.EmpresaVisita).Remove
            Return Me.BaseRemove(empresaVisita)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal empresaVisita As S5T.EmpresaVisita) As Boolean
            If (empresaVisita Is Nothing) Then
                Throw New System.ArgumentNullException("empresaVisita")
            End If
            Dim index As Integer = Me.IndexOf(empresaVisita)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.EmpresaVisita).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(empresaVisita)
            RemoveHandler empresaVisita.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(empresaVisita.pId)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, empresaVisita, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5T.EmpresaVisita).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.EmpresaVisita).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim empresaVisita As S5T.EmpresaVisita = Me.BaseList(index)
            If (Not (empresaVisita) Is Nothing) Then
                RemoveHandler empresaVisita.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(empresaVisita.pId)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5T.EmpresaVisita) Implements System.Collections.Generic.IEnumerable(Of S5T.EmpresaVisita).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5T.EmpresaVisita) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5T.EmpresaVisita
            Dim empresaVisita As S5T.EmpresaVisita = Nothing
            If (Me.BaseTable.TryGetValue(key, empresaVisita) = true) Then
                Return empresaVisita
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim empresaVisita As S5T.EmpresaVisita = Me(index)
                empresaVisita.Save
                If (empresaVisita.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(empresaVisita)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    Dim empresaVisita As S5T.EmpresaVisita = New S5T.EmpresaVisita()
                    CType(empresaVisita,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(empresaVisita) = false) Then
                        Me.BaseAdd(empresaVisita)
                        count = (count + 1)
                    End If
                    empresaVisita.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Unchanged
                End If
                readerRead = reader.Read
            Loop
        End Sub
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5T.EmpresaVisitaCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5T.EmpresaVisitaCollection = New S5T.EmpresaVisitaCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.EmpresaVisitaCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5T.EmpresaVisitaCollection
            Dim ret As S5T.EmpresaVisitaCollection = S5T.EmpresaVisitaCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "EmpresaVisita", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.EmpresaVisitaCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5T.EmpresaVisitaCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5T.EmpresaVisita)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5T.EmpresaVisita) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5T.EmpresaVisita))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5T.EmpresaVisitaCollection
            Dim ret As S5T.EmpresaVisitaCollection = New S5T.EmpresaVisitaCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm92924114.AddIndex([property])
        End Sub
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm92924114.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm92924114.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5T.EmpresaVisita))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5T.EmpresaVisita = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.EmpresaVisitaCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.EmpresaVisitaCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5T.EmpresaVisitaCollection
            Return S5T.EmpresaVisitaCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal empresaVisita As S5T.EmpresaVisita) As Boolean
            If (empresaVisita Is Nothing) Then
                Return false
            End If
            Dim ret As Boolean = empresaVisita.Save
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Shared Function Insert(ByVal empresaVisita As S5T.EmpresaVisita) As Boolean
            Dim ret As Boolean = S5T.EmpresaVisita.Save(empresaVisita)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal empresaVisita As S5T.EmpresaVisita) As Boolean
            If (empresaVisita Is Nothing) Then
                Return false
            End If
            Dim ret As Boolean = empresaVisita.Delete
            Return ret
        End Function
    End Class
End Namespace
