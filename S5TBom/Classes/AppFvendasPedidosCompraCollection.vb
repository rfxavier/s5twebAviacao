...
Namespace S5T
    ...
    Partial Public Class AppFvendasPedidosCompraCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5T.AppFvendasPedidosCompra), System.Collections.Generic.ICollection(Of S5T.AppFvendasPedidosCompra), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5T.AppFvendasPedidosCompra) = New System.Collections.Generic.List(Of S5T.AppFvendasPedidosCompra)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5T.AppFvendasPedidosCompra) = New System.Collections.Generic.Dictionary(Of Long, S5T.AppFvendasPedidosCompra)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm1315123073 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.AppFvendasPedidosCompra)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm1315123073 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.AppFvendasPedidosCompra)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5T.AppFvendasPedidosCompra)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5T.AppFvendasPedidosCompra)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As S5T.AppFvendasPedidosCompra Implements System.Collections.Generic.IList(Of S5T.AppFvendasPedidosCompra).Item
            Get
                Return CType(Me.BaseList(index),S5T.AppFvendasPedidosCompra)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5T.AppFvendasPedidosCompra)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5T.AppFvendasPedidosCompra
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5T.AppFvendasPedidosCompra = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra = Me.TryGetValue(pId)
                    If (Not (appFvendasPedidosCompra) Is Nothing) Then
                        Me.Remove(appFvendasPedidosCompra)
                    End If
                    Return
                End If
                Dim existing As S5T.AppFvendasPedidosCompra = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5T.AppFvendasPedidosCompra).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5T.AppFvendasPedidosCompra).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm1315123073.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm1315123073.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5T.AppFvendasPedidosCompra, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(appFvendasPedidosCompra)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra) As Integer
            If (appFvendasPedidosCompra Is Nothing) Then
                Throw New System.ArgumentNullException("appFvendasPedidosCompra")
            End If
            If (appFvendasPedidosCompra.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "appFvendasPedidosCompra", "S5T.AppFvendasPedidosCompra")
            End If
            Try 
                Me.BaseTable.Add(appFvendasPedidosCompra.pId, appFvendasPedidosCompra)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.AppFvendasPedidosCompraCollection", appFvendasPedidosCompra.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.AppFvendasPedidosCompraCollection", appFvendasPedidosCompra.pId), ae)
            End Try
            AddHandler appFvendasPedidosCompra.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(appFvendasPedidosCompra)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, appFvendasPedidosCompra, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            ...
            If (appFvendasPedidosCompra Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(appFvendasPedidosCompra)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5T_AppFvendasPedidosCompra__Add(ByVal appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra) Implements System.Collections.Generic.ICollection(Of S5T.AppFvendasPedidosCompra).Add
            Me.BaseAdd(appFvendasPedidosCompra)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5T.AppFvendasPedidosCompra
            Dim appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra = S5T.AppFvendasPedidosCompra.LoadByEntityKey(key)
            If ((Not (appFvendasPedidosCompra) Is Nothing)  _
                        AndAlso (Me.Contains(appFvendasPedidosCompra) = false)) Then
                Me.Add(appFvendasPedidosCompra)
            End If
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5T.AppFvendasPedidosCompra))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5T.AppFvendasPedidosCompra, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5T.AppFvendasPedidosCompra).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5T.AppFvendasPedidosCompra, ByVal index As Integer)
        ...
        Public Function Contains(ByVal appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.AppFvendasPedidosCompra).Contains
            Dim localContains As Boolean = Me.BaseContains(appFvendasPedidosCompra)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra) As Boolean
            If (appFvendasPedidosCompra Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(appFvendasPedidosCompra.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            ...
            Catch icex As System.InvalidCastException
                appFvendasPedidosCompra = Nothing
            End Try
            Return Me.Contains(appFvendasPedidosCompra)
        End Function
        
        Public Function IndexOf(ByVal appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra) As Integer Implements System.Collections.Generic.IList(Of S5T.AppFvendasPedidosCompra).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(appFvendasPedidosCompra)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra) As Integer
            If (appFvendasPedidosCompra Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(appFvendasPedidosCompra)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                appFvendasPedidosCompra = Nothing
            End Try
            Return Me.IndexOf(appFvendasPedidosCompra)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra) Implements System.Collections.Generic.IList(Of S5T.AppFvendasPedidosCompra).Insert
            Me.BaseInsert(index, appFvendasPedidosCompra)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra)
            If (appFvendasPedidosCompra Is Nothing) Then
                Throw New System.ArgumentNullException("appFvendasPedidosCompra")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.AppFvendasPedidosCompraCollection", appFvendasPedidosCompra.pId), ae)
            End Try
            Me.BaseList.Insert(index, appFvendasPedidosCompra)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, appFvendasPedidosCompra, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                appFvendasPedidosCompra = Nothing
            End Try
            Me.Insert(index, appFvendasPedidosCompra)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5T.AppFvendasPedidosCompra).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim AppFvendasPedidosCompra As S5T.AppFvendasPedidosCompra = Me(0)
                Me.BaseRemove(AppFvendasPedidosCompra)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.AppFvendasPedidosCompra).Remove
            Return Me.BaseRemove(appFvendasPedidosCompra)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra) As Boolean
            If (appFvendasPedidosCompra Is Nothing) Then
                Throw New System.ArgumentNullException("appFvendasPedidosCompra")
            End If
            Dim index As Integer = Me.IndexOf(appFvendasPedidosCompra)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.AppFvendasPedidosCompra).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(appFvendasPedidosCompra)
            RemoveHandler appFvendasPedidosCompra.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(appFvendasPedidosCompra.pId)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, appFvendasPedidosCompra, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5T.AppFvendasPedidosCompra).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.AppFvendasPedidosCompra).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra = Me.BaseList(index)
            If (Not (appFvendasPedidosCompra) Is Nothing) Then
                RemoveHandler appFvendasPedidosCompra.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(appFvendasPedidosCompra.pId)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5T.AppFvendasPedidosCompra) Implements System.Collections.Generic.IEnumerable(Of S5T.AppFvendasPedidosCompra).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5T.AppFvendasPedidosCompra) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5T.AppFvendasPedidosCompra
            Dim appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra = Nothing
            If (Me.BaseTable.TryGetValue(key, appFvendasPedidosCompra) = true) Then
                Return appFvendasPedidosCompra
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra = Me(index)
                appFvendasPedidosCompra.Save
                If (appFvendasPedidosCompra.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(appFvendasPedidosCompra)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    ...
                    CType(appFvendasPedidosCompra,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(appFvendasPedidosCompra) = false) Then
                        Me.BaseAdd(appFvendasPedidosCompra)
                        count = (count + 1)
                    End If
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5T.AppFvendasPedidosCompraCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5T.AppFvendasPedidosCompraCollection = New S5T.AppFvendasPedidosCompraCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.AppFvendasPedidosCompraCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5T.AppFvendasPedidosCompraCollection
            Dim ret As S5T.AppFvendasPedidosCompraCollection = S5T.AppFvendasPedidosCompraCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AppFvendasPedidosCompra", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.AppFvendasPedidosCompraCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5T.AppFvendasPedidosCompraCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5T.AppFvendasPedidosCompra)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5T.AppFvendasPedidosCompra) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5T.AppFvendasPedidosCompra))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5T.AppFvendasPedidosCompraCollection
            Dim ret As S5T.AppFvendasPedidosCompraCollection = New S5T.AppFvendasPedidosCompraCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm1315123073.AddIndex([property])
        End Sub
        ...
        Private Function AddNew() As Object Implements System.ComponentModel.IBindingList.AddNew
            Dim add As S5T.AppFvendasPedidosCompra = New S5T.AppFvendasPedidosCompra()
            Dim e As System.ComponentModel.AddingNewEventArgs = New System.ComponentModel.AddingNewEventArgs(add)
            Me.OnAddingNew(e)
            add = CType(e.NewObject,S5T.AppFvendasPedidosCompra)
            If (add Is Nothing) Then
                add = New S5T.AppFvendasPedidosCompra()
            End If
            add.pId = 0
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm1315123073.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm1315123073.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5T.AppFvendasPedidosCompra))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5T.AppFvendasPedidosCompra = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.AppFvendasPedidosCompraCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.AppFvendasPedidosCompraCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5T.AppFvendasPedidosCompraCollection
            Return S5T.AppFvendasPedidosCompraCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra) As Boolean
            If (appFvendasPedidosCompra Is Nothing) Then
                Return false
            End If
        ...
        Public Overloads Shared Function Insert(ByVal appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra) As Boolean
            Dim ret As Boolean = S5T.AppFvendasPedidosCompra.Save(appFvendasPedidosCompra)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal appFvendasPedidosCompra As S5T.AppFvendasPedidosCompra) As Boolean
            If (appFvendasPedidosCompra Is Nothing) Then
                Return false
            End If
