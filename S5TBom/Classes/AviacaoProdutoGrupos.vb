...
Namespace S5T
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("CodeFluent Entities", "1.0.01234.05678"),  _
     ...
     System.Diagnostics.DebuggerDisplayAttribute("EK={EntityKey}, pGRUPO_PRODUTO={pGRUPO_PRODUTO}, pId={pId}"),  _
     System.ComponentModel.TypeConverterAttribute(GetType(CodeFluent.Runtime.Design.NameTypeConverter))>  _
    Partial Public Class AviacaoProdutoGrupos
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.AviacaoProdutoGrupos), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.AviacaoProdutoGrupos)
        ...
        Public Overloads Overridable Function Equals(ByVal aviacaoProdutoGrupos As S5T.AviacaoProdutoGrupos) As Boolean Implements System.IEquatable(Of S5T.AviacaoProdutoGrupos).Equals
            If (aviacaoProdutoGrupos Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(aviacaoProdutoGrupos)
            End If
            Return (Me.pId.Equals(aviacaoProdutoGrupos.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                aviacaoProdutoGrupos = CType(obj,S5T.AviacaoProdutoGrupos)
            Catch icex As System.InvalidCastException
                aviacaoProdutoGrupos = Nothing
            End Try
            Return Me.Equals(aviacaoProdutoGrupos)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(aviacaoProdutoGrupos)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal aviacaoProdutoGrupos As S5T.AviacaoProdutoGrupos) As Integer Implements System.IComparable(Of S5T.AviacaoProdutoGrupos).CompareTo
            If (aviacaoProdutoGrupos Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoProdutoGrupos")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(aviacaoProdutoGrupos.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.AviacaoProdutoGrupos.ExternalValidate", "Type 'S5T.AviacaoProdutoGrupos' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoProdutoGrupos", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.AviacaoProdutoGrupos
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoProdutoGrupos As S5T.AviacaoProdutoGrupos = New S5T.AviacaoProdutoGrupos()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoProdutoGrupos", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    aviacaoProdutoGrupos.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.AviacaoProdutoGrupos
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoProdutoGrupos As S5T.AviacaoProdutoGrupos = New S5T.AviacaoProdutoGrupos()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoProdutoGrupos", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5T.AviacaoProdutoGrupos.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoProdutoGrupos", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal aviacaoProdutoGrupos As S5T.AviacaoProdutoGrupos) As Boolean
            If (aviacaoProdutoGrupos Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal aviacaoProdutoGrupos As S5T.AviacaoProdutoGrupos) As Boolean
            Dim ret As Boolean = S5T.AviacaoProdutoGrupos.Save(aviacaoProdutoGrupos)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal aviacaoProdutoGrupos As S5T.AviacaoProdutoGrupos) As Boolean
            If (aviacaoProdutoGrupos Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.AviacaoProdutoGrupos
            ...
            aviacaoProdutoGrupos = S5T.AviacaoProdutoGrupos.Load(var)
            Return aviacaoProdutoGrupos
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.AviacaoProdutoGrupos
            Dim aviacaoProdutoGrupos As S5T.AviacaoProdutoGrupos = New S5T.AviacaoProdutoGrupos()
            Me.CopyTo(aviacaoProdutoGrupos, deep)
            Return aviacaoProdutoGrupos
        End Function
        
        Public Overloads Function Clone() As S5T.AviacaoProdutoGrupos
            Dim localClone As S5T.AviacaoProdutoGrupos = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal aviacaoProdutoGrupos As S5T.AviacaoProdutoGrupos, ByVal deep As Boolean)
            If (aviacaoProdutoGrupos Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoProdutoGrupos")
            End If
            aviacaoProdutoGrupos.pId = Me.pId
            aviacaoProdutoGrupos.pGRUPO_PRODUTO = Me.pGRUPO_PRODUTO
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, aviacaoProdutoGrupos))
        End Sub
