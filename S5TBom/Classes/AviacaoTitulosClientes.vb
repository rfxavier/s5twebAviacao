...
Namespace S5T
    ...
    Partial Public Class AviacaoTitulosClientes
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.AviacaoTitulosClientes), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.AviacaoTitulosClientes)
        ...
        Public Overloads Overridable Function Equals(ByVal aviacaoTitulosClientes As S5T.AviacaoTitulosClientes) As Boolean Implements System.IEquatable(Of S5T.AviacaoTitulosClientes).Equals
            If (aviacaoTitulosClientes Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(aviacaoTitulosClientes)
            End If
            Return (Me.pId.Equals(aviacaoTitulosClientes.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                aviacaoTitulosClientes = CType(obj,S5T.AviacaoTitulosClientes)
            Catch icex As System.InvalidCastException
                aviacaoTitulosClientes = Nothing
            End Try
            Return Me.Equals(aviacaoTitulosClientes)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(aviacaoTitulosClientes)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal aviacaoTitulosClientes As S5T.AviacaoTitulosClientes) As Integer Implements System.IComparable(Of S5T.AviacaoTitulosClientes).CompareTo
            If (aviacaoTitulosClientes Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoTitulosClientes")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(aviacaoTitulosClientes.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.AviacaoTitulosClientes.ExternalValidate", "Type 'S5T.AviacaoTitulosClientes' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoTitulosClientes", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.AviacaoTitulosClientes
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoTitulosClientes As S5T.AviacaoTitulosClientes = New S5T.AviacaoTitulosClientes()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoTitulosClientes", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    aviacaoTitulosClientes.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.AviacaoTitulosClientes
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoTitulosClientes As S5T.AviacaoTitulosClientes = New S5T.AviacaoTitulosClientes()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoTitulosClientes", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5T.AviacaoTitulosClientes.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoTitulosClientes", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal aviacaoTitulosClientes As S5T.AviacaoTitulosClientes) As Boolean
            If (aviacaoTitulosClientes Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal aviacaoTitulosClientes As S5T.AviacaoTitulosClientes) As Boolean
            Dim ret As Boolean = S5T.AviacaoTitulosClientes.Save(aviacaoTitulosClientes)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal aviacaoTitulosClientes As S5T.AviacaoTitulosClientes) As Boolean
            If (aviacaoTitulosClientes Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.AviacaoTitulosClientes
            ...
            aviacaoTitulosClientes = S5T.AviacaoTitulosClientes.Load(var)
            Return aviacaoTitulosClientes
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.AviacaoTitulosClientes
            Dim aviacaoTitulosClientes As S5T.AviacaoTitulosClientes = New S5T.AviacaoTitulosClientes()
            Me.CopyTo(aviacaoTitulosClientes, deep)
            Return aviacaoTitulosClientes
        End Function
        
        Public Overloads Function Clone() As S5T.AviacaoTitulosClientes
            Dim localClone As S5T.AviacaoTitulosClientes = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal aviacaoTitulosClientes As S5T.AviacaoTitulosClientes, ByVal deep As Boolean)
            If (aviacaoTitulosClientes Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoTitulosClientes")
            End If
            aviacaoTitulosClientes.pId = Me.pId
            aviacaoTitulosClientes.pNOME = Me.pNOME
            aviacaoTitulosClientes.pCODIGO = Me.pCODIGO
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, aviacaoTitulosClientes))
        End Sub
