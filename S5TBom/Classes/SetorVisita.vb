...
Namespace S5T
    ...
    Partial Public Class SetorVisita
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.SetorVisita), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.SetorVisita)
            ...
            Get
                If (Me._oVisitaMovs Is Nothing) Then
                    If ((Me.pId = -1)  _
                        ...
                        Me._oVisitaMovs = New S5T.VisitaMovCollection(Nothing, Nothing, Me, Nothing)
                        Return Me._oVisitaMovs
                    End If
                    Me._oVisitaMovs = S5T.VisitaMovCollection.LoadByoSetor(Me)
                End If
                Return Me._oVisitaMovs
            End Get
        End Property
        ...
        Public Overloads Overridable Function Equals(ByVal setorVisita As S5T.SetorVisita) As Boolean Implements System.IEquatable(Of S5T.SetorVisita).Equals
            If (setorVisita Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(setorVisita)
            End If
            Return (Me.pId.Equals(setorVisita.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                setorVisita = CType(obj,S5T.SetorVisita)
            Catch icex As System.InvalidCastException
                setorVisita = Nothing
            End Try
            Return Me.Equals(setorVisita)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(setorVisita)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal setorVisita As S5T.SetorVisita) As Integer Implements System.IComparable(Of S5T.SetorVisita).CompareTo
            If (setorVisita Is Nothing) Then
                Throw New System.ArgumentNullException("setorVisita")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(setorVisita.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.SetorVisita.ExternalValidate", "Type 'S5T.SetorVisita' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "SetorVisita", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.SetorVisita
            If (pId = -1) Then
                Return Nothing
            End If
            Dim setorVisita As S5T.SetorVisita = New S5T.SetorVisita()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "SetorVisita", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    setorVisita.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.SetorVisita
            If (pId = -1) Then
                Return Nothing
            End If
            Dim setorVisita As S5T.SetorVisita = New S5T.SetorVisita()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "SetorVisita", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "SetorVisita", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal setorVisita As S5T.SetorVisita) As Boolean
            If (setorVisita Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal setorVisita As S5T.SetorVisita) As Boolean
            Dim ret As Boolean = S5T.SetorVisita.Save(setorVisita)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal setorVisita As S5T.SetorVisita) As Boolean
            If (setorVisita Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.SetorVisita
            ...
            setorVisita = S5T.SetorVisita.Load(var)
            Return setorVisita
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.SetorVisita
            Dim setorVisita As S5T.SetorVisita = New S5T.SetorVisita()
            Me.CopyTo(setorVisita, deep)
            Return setorVisita
        End Function
        
        Public Overloads Function Clone() As S5T.SetorVisita
            Dim localClone As S5T.SetorVisita = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal setorVisita As S5T.SetorVisita, ByVal deep As Boolean)
            If (setorVisita Is Nothing) Then
                Throw New System.ArgumentNullException("setorVisita")
            End If
            setorVisita.pId = Me.pId
            setorVisita.pNome = Me.pNome
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, setorVisita))
        End Sub
