...
Namespace S5T
    ...
    Partial Public Class EmpresaVisita
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.EmpresaVisita), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.EmpresaVisita)
            ...
            Get
                If (Me._oVisitaMovs Is Nothing) Then
                    If ((Me.pId = -1)  _
                        ...
                        Me._oVisitaMovs = New S5T.VisitaMovCollection(Nothing, Nothing, Nothing, Me)
                        Return Me._oVisitaMovs
                    End If
                    Me._oVisitaMovs = S5T.VisitaMovCollection.LoadByoEmpresa(Me)
                End If
                Return Me._oVisitaMovs
            End Get
        End Property
        ...
        Public Overloads Overridable Function Equals(ByVal empresaVisita As S5T.EmpresaVisita) As Boolean Implements System.IEquatable(Of S5T.EmpresaVisita).Equals
            If (empresaVisita Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(empresaVisita)
            End If
            Return (Me.pId.Equals(empresaVisita.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                empresaVisita = CType(obj,S5T.EmpresaVisita)
            Catch icex As System.InvalidCastException
                empresaVisita = Nothing
            End Try
            Return Me.Equals(empresaVisita)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(empresaVisita)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal empresaVisita As S5T.EmpresaVisita) As Integer Implements System.IComparable(Of S5T.EmpresaVisita).CompareTo
            If (empresaVisita Is Nothing) Then
                Throw New System.ArgumentNullException("empresaVisita")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(empresaVisita.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.EmpresaVisita.ExternalValidate", "Type 'S5T.EmpresaVisita' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "EmpresaVisita", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.EmpresaVisita
            If (pId = -1) Then
                Return Nothing
            End If
            Dim empresaVisita As S5T.EmpresaVisita = New S5T.EmpresaVisita()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "EmpresaVisita", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    empresaVisita.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.EmpresaVisita
            If (pId = -1) Then
                Return Nothing
            End If
            Dim empresaVisita As S5T.EmpresaVisita = New S5T.EmpresaVisita()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "EmpresaVisita", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "EmpresaVisita", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal empresaVisita As S5T.EmpresaVisita) As Boolean
            If (empresaVisita Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal empresaVisita As S5T.EmpresaVisita) As Boolean
            Dim ret As Boolean = S5T.EmpresaVisita.Save(empresaVisita)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal empresaVisita As S5T.EmpresaVisita) As Boolean
            If (empresaVisita Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.EmpresaVisita
            ...
            empresaVisita = S5T.EmpresaVisita.Load(var)
            Return empresaVisita
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.EmpresaVisita
            Dim empresaVisita As S5T.EmpresaVisita = New S5T.EmpresaVisita()
            Me.CopyTo(empresaVisita, deep)
            Return empresaVisita
        End Function
        
        Public Overloads Function Clone() As S5T.EmpresaVisita
            Dim localClone As S5T.EmpresaVisita = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal empresaVisita As S5T.EmpresaVisita, ByVal deep As Boolean)
            If (empresaVisita Is Nothing) Then
                Throw New System.ArgumentNullException("empresaVisita")
            End If
            empresaVisita.pId = Me.pId
            empresaVisita.pNome = Me.pNome
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, empresaVisita))
        End Sub
