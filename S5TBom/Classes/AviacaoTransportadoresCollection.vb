...
Namespace S5T
    ...
    Partial Public Class AviacaoTransportadoresCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5T.AviacaoTransportadores), System.Collections.Generic.ICollection(Of S5T.AviacaoTransportadores), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5T.AviacaoTransportadores) = New System.Collections.Generic.List(Of S5T.AviacaoTransportadores)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5T.AviacaoTransportadores) = New System.Collections.Generic.Dictionary(Of Long, S5T.AviacaoTransportadores)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm2017760757 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.AviacaoTransportadores)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm2017760757 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.AviacaoTransportadores)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5T.AviacaoTransportadores)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5T.AviacaoTransportadores)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As S5T.AviacaoTransportadores Implements System.Collections.Generic.IList(Of S5T.AviacaoTransportadores).Item
            Get
                Return CType(Me.BaseList(index),S5T.AviacaoTransportadores)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5T.AviacaoTransportadores)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5T.AviacaoTransportadores
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5T.AviacaoTransportadores = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim aviacaoTransportadores As S5T.AviacaoTransportadores = Me.TryGetValue(pId)
                    If (Not (aviacaoTransportadores) Is Nothing) Then
                        Me.Remove(aviacaoTransportadores)
                    End If
                    Return
                End If
                Dim existing As S5T.AviacaoTransportadores = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5T.AviacaoTransportadores).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5T.AviacaoTransportadores).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm2017760757.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm2017760757.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5T.AviacaoTransportadores, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal aviacaoTransportadores As S5T.AviacaoTransportadores) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(aviacaoTransportadores)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal aviacaoTransportadores As S5T.AviacaoTransportadores) As Integer
            If (aviacaoTransportadores Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoTransportadores")
            End If
            If (aviacaoTransportadores.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "aviacaoTransportadores", "S5T.AviacaoTransportadores")
            End If
            Try 
                Me.BaseTable.Add(aviacaoTransportadores.pId, aviacaoTransportadores)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.AviacaoTransportadoresCollection", aviacaoTransportadores.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.AviacaoTransportadoresCollection", aviacaoTransportadores.pId), ae)
            End Try
            AddHandler aviacaoTransportadores.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(aviacaoTransportadores)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, aviacaoTransportadores, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            Dim aviacaoTransportadores As S5T.AviacaoTransportadores = Nothing
            Try 
                aviacaoTransportadores = CType(value,S5T.AviacaoTransportadores)
            Catch icex As System.InvalidCastException
                aviacaoTransportadores = Nothing
            ...
            If (aviacaoTransportadores Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(aviacaoTransportadores)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5T_AviacaoTransportadores__Add(ByVal aviacaoTransportadores As S5T.AviacaoTransportadores) Implements System.Collections.Generic.ICollection(Of S5T.AviacaoTransportadores).Add
            Me.BaseAdd(aviacaoTransportadores)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5T.AviacaoTransportadores
            Dim aviacaoTransportadores As S5T.AviacaoTransportadores = S5T.AviacaoTransportadores.LoadByEntityKey(key)
            If ((Not (aviacaoTransportadores) Is Nothing)  _
                        AndAlso (Me.Contains(aviacaoTransportadores) = false)) Then
                Me.Add(aviacaoTransportadores)
            End If
            Return aviacaoTransportadores
        End Function
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5T.AviacaoTransportadores))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5T.AviacaoTransportadores, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5T.AviacaoTransportadores).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5T.AviacaoTransportadores, ByVal index As Integer)
        ...
        Public Function Contains(ByVal aviacaoTransportadores As S5T.AviacaoTransportadores) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.AviacaoTransportadores).Contains
            Dim localContains As Boolean = Me.BaseContains(aviacaoTransportadores)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal aviacaoTransportadores As S5T.AviacaoTransportadores) As Boolean
            If (aviacaoTransportadores Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(aviacaoTransportadores.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            Dim aviacaoTransportadores As S5T.AviacaoTransportadores
            Try 
                aviacaoTransportadores = CType(value,S5T.AviacaoTransportadores)
            Catch icex As System.InvalidCastException
                aviacaoTransportadores = Nothing
            End Try
            Return Me.Contains(aviacaoTransportadores)
        End Function
        
        Public Function IndexOf(ByVal aviacaoTransportadores As S5T.AviacaoTransportadores) As Integer Implements System.Collections.Generic.IList(Of S5T.AviacaoTransportadores).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(aviacaoTransportadores)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal aviacaoTransportadores As S5T.AviacaoTransportadores) As Integer
            If (aviacaoTransportadores Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(aviacaoTransportadores)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                aviacaoTransportadores = Nothing
            End Try
            Return Me.IndexOf(aviacaoTransportadores)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal aviacaoTransportadores As S5T.AviacaoTransportadores) Implements System.Collections.Generic.IList(Of S5T.AviacaoTransportadores).Insert
            Me.BaseInsert(index, aviacaoTransportadores)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal aviacaoTransportadores As S5T.AviacaoTransportadores)
            If (aviacaoTransportadores Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoTransportadores")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.AviacaoTransportadoresCollection", aviacaoTransportadores.pId), ae)
            End Try
            Me.BaseList.Insert(index, aviacaoTransportadores)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, aviacaoTransportadores, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                aviacaoTransportadores = Nothing
            End Try
            Me.Insert(index, aviacaoTransportadores)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5T.AviacaoTransportadores).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim AviacaoTransportadores As S5T.AviacaoTransportadores = Me(0)
                Me.BaseRemove(AviacaoTransportadores)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal aviacaoTransportadores As S5T.AviacaoTransportadores) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.AviacaoTransportadores).Remove
            Return Me.BaseRemove(aviacaoTransportadores)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal aviacaoTransportadores As S5T.AviacaoTransportadores) As Boolean
            If (aviacaoTransportadores Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoTransportadores")
            End If
            Dim index As Integer = Me.IndexOf(aviacaoTransportadores)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.AviacaoTransportadores).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(aviacaoTransportadores)
            RemoveHandler aviacaoTransportadores.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(aviacaoTransportadores.pId)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, aviacaoTransportadores, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5T.AviacaoTransportadores).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.AviacaoTransportadores).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim aviacaoTransportadores As S5T.AviacaoTransportadores = Me.BaseList(index)
            If (Not (aviacaoTransportadores) Is Nothing) Then
                RemoveHandler aviacaoTransportadores.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(aviacaoTransportadores.pId)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5T.AviacaoTransportadores) Implements System.Collections.Generic.IEnumerable(Of S5T.AviacaoTransportadores).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5T.AviacaoTransportadores) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5T.AviacaoTransportadores
            Dim aviacaoTransportadores As S5T.AviacaoTransportadores = Nothing
            If (Me.BaseTable.TryGetValue(key, aviacaoTransportadores) = true) Then
                Return aviacaoTransportadores
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim aviacaoTransportadores As S5T.AviacaoTransportadores = Me(index)
                aviacaoTransportadores.Save
                If (aviacaoTransportadores.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(aviacaoTransportadores)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    Dim aviacaoTransportadores As S5T.AviacaoTransportadores = New S5T.AviacaoTransportadores()
                    CType(aviacaoTransportadores,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(aviacaoTransportadores) = false) Then
                        Me.BaseAdd(aviacaoTransportadores)
                        count = (count + 1)
                    End If
                    aviacaoTransportadores.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Unchanged
                End If
                readerRead = reader.Read
            Loop
        End Sub
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5T.AviacaoTransportadoresCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5T.AviacaoTransportadoresCollection = New S5T.AviacaoTransportadoresCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.AviacaoTransportadoresCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5T.AviacaoTransportadoresCollection
            Dim ret As S5T.AviacaoTransportadoresCollection = S5T.AviacaoTransportadoresCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoTransportadores", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.AviacaoTransportadoresCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5T.AviacaoTransportadoresCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5T.AviacaoTransportadores)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5T.AviacaoTransportadores) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5T.AviacaoTransportadores))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5T.AviacaoTransportadoresCollection
            Dim ret As S5T.AviacaoTransportadoresCollection = New S5T.AviacaoTransportadoresCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm2017760757.AddIndex([property])
        End Sub
        ...
        Private Function AddNew() As Object Implements System.ComponentModel.IBindingList.AddNew
            Dim add As S5T.AviacaoTransportadores = New S5T.AviacaoTransportadores()
            Dim e As System.ComponentModel.AddingNewEventArgs = New System.ComponentModel.AddingNewEventArgs(add)
            Me.OnAddingNew(e)
            add = CType(e.NewObject,S5T.AviacaoTransportadores)
            If (add Is Nothing) Then
                add = New S5T.AviacaoTransportadores()
            End If
            add.pId = 0
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm2017760757.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm2017760757.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5T.AviacaoTransportadores))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5T.AviacaoTransportadores = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.AviacaoTransportadoresCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.AviacaoTransportadoresCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5T.AviacaoTransportadoresCollection
            Return S5T.AviacaoTransportadoresCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal aviacaoTransportadores As S5T.AviacaoTransportadores) As Boolean
            If (aviacaoTransportadores Is Nothing) Then
                Return false
            End If
            Dim ret As Boolean = aviacaoTransportadores.Save
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Shared Function Insert(ByVal aviacaoTransportadores As S5T.AviacaoTransportadores) As Boolean
            Dim ret As Boolean = S5T.AviacaoTransportadores.Save(aviacaoTransportadores)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal aviacaoTransportadores As S5T.AviacaoTransportadores) As Boolean
            If (aviacaoTransportadores Is Nothing) Then
                Return false
            End If
            Dim ret As Boolean = aviacaoTransportadores.Delete
            Return ret
        End Function
    End Class
End Namespace
