...
Namespace S5T
    ...
    Partial Public Class AviacaoVendas
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.AviacaoVendas), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.AviacaoVendas)
        ...
        Public Overloads Overridable Function Equals(ByVal aviacaoVendas As S5T.AviacaoVendas) As Boolean Implements System.IEquatable(Of S5T.AviacaoVendas).Equals
            If (aviacaoVendas Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(aviacaoVendas)
            End If
            Return (Me.pId.Equals(aviacaoVendas.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                aviacaoVendas = CType(obj,S5T.AviacaoVendas)
            Catch icex As System.InvalidCastException
                aviacaoVendas = Nothing
            End Try
            Return Me.Equals(aviacaoVendas)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(aviacaoVendas)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal aviacaoVendas As S5T.AviacaoVendas) As Integer Implements System.IComparable(Of S5T.AviacaoVendas).CompareTo
            If (aviacaoVendas Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoVendas")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(aviacaoVendas.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.AviacaoVendas.ExternalValidate", "Type 'S5T.AviacaoVendas' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendas", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.AviacaoVendas
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoVendas As S5T.AviacaoVendas = New S5T.AviacaoVendas()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendas", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    aviacaoVendas.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.AviacaoVendas
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoVendas As S5T.AviacaoVendas = New S5T.AviacaoVendas()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendas", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Public Shared Function LoadPedidosNFAppRaw(ByVal parCodCliente As String, ByVal parCodLoja As String, ByVal parOrderBy As String) As System.Collections.Generic.List(Of S5T.AviacaoVendas)
            If (parCodCliente Is CType(Nothing, String)) Then
                Throw New System.ArgumentNullException("parCodCliente")
            End If
            If (parCodLoja Is CType(Nothing, String)) Then
                Throw New System.ArgumentNullException("parCodLoja")
            End If
            If (parOrderBy Is CType(Nothing, String)) Then
                Throw New System.ArgumentNullException("parOrderBy")
            End If
            Dim ret As System.Collections.Generic.List(Of S5T.AviacaoVendas) = CType(Nothing, System.Collections.Generic.List(Of S5T.AviacaoVendas))
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendas", "LoadPedidosNFAppRaw")
            persistence.AddParameter("@parCodCliente", parCodCliente)
            persistence.AddParameter("@parCodLoja", parCodLoja)
            persistence.AddParameter("@parOrderBy", parOrderBy)
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    ret = New System.Collections.Generic.List(Of S5T.AviacaoVendas)()
                    CodeFluent.Runtime.CodeFluentLightWeightPersistence.ReadList(reader, ret, GetType(S5T.AviacaoVendas))
                End If
            Finally
                If (Not (reader) Is Nothing) Then
                    reader.Dispose
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendas", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal aviacaoVendas As S5T.AviacaoVendas) As Boolean
            If (aviacaoVendas Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal aviacaoVendas As S5T.AviacaoVendas) As Boolean
            Dim ret As Boolean = S5T.AviacaoVendas.Save(aviacaoVendas)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal aviacaoVendas As S5T.AviacaoVendas) As Boolean
            If (aviacaoVendas Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.AviacaoVendas
            ...
            aviacaoVendas = S5T.AviacaoVendas.Load(var)
            Return aviacaoVendas
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.AviacaoVendas
            Dim aviacaoVendas As S5T.AviacaoVendas = New S5T.AviacaoVendas()
            Me.CopyTo(aviacaoVendas, deep)
            Return aviacaoVendas
        End Function
        
        Public Overloads Function Clone() As S5T.AviacaoVendas
            Dim localClone As S5T.AviacaoVendas = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal aviacaoVendas As S5T.AviacaoVendas, ByVal deep As Boolean)
            If (aviacaoVendas Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoVendas")
            End If
            aviacaoVendas.pId = Me.pId
            aviacaoVendas.pVLR_PIS = Me.pVLR_PIS
            aviacaoVendas.pPRECO_FORA_IMPOSTO = Me.pPRECO_FORA_IMPOSTO
            aviacaoVendas.pVLR_ICM = Me.pVLR_ICM
            aviacaoVendas.pVLR_COFINS = Me.pVLR_COFINS
            aviacaoVendas.pB1_QE = Me.pB1_QE
            aviacaoVendas.pB1_CONV = Me.pB1_CONV
            aviacaoVendas.pPRECO_FORA_IMPOSTO_UNIT = Me.pPRECO_FORA_IMPOSTO_UNIT
            aviacaoVendas.pIMPOSTO_TOTAL_NOTA = Me.pIMPOSTO_TOTAL_NOTA
            aviacaoVendas.pVLR_TOTAL_PRODUTO = Me.pVLR_TOTAL_PRODUTO
            aviacaoVendas.pPRECO_DE_VENDA = Me.pPRECO_DE_VENDA
            aviacaoVendas.pQUANTIDADE = Me.pQUANTIDADE
            aviacaoVendas.pPRECO_TABELA = Me.pPRECO_TABELA
            aviacaoVendas.pVLR_TOTAL_NOTA = Me.pVLR_TOTAL_NOTA
            aviacaoVendas.pVLR_SEM_ICMSST = Me.pVLR_SEM_ICMSST
            aviacaoVendas.pVLR_DESCONTO = Me.pVLR_DESCONTO
            aviacaoVendas.pVLR_BASE_ICM = Me.pVLR_BASE_ICM
            aviacaoVendas.pPLACA = Me.pPLACA
            aviacaoVendas.pCUSTO_PROD_QTD = Me.pCUSTO_PROD_QTD
            aviacaoVendas.pNRO_PEDIDO_CLIENTE = Me.pNRO_PEDIDO_CLIENTE
            aviacaoVendas.pVALOR_DESC_FINAN = Me.pVALOR_DESC_FINAN
            aviacaoVendas.pCUSTO_PRODUTO = Me.pCUSTO_PRODUTO
            aviacaoVendas.pBAIRRO_CLIE = Me.pBAIRRO_CLIE
            aviacaoVendas.pULTIMA_COMPRA = Me.pULTIMA_COMPRA
            aviacaoVendas.pPEDIDO = Me.pPEDIDO
            aviacaoVendas.pENDERECO_CLI = Me.pENDERECO_CLI
            aviacaoVendas.pGRUPO_CLIENTE = Me.pGRUPO_CLIENTE
            aviacaoVendas.pDT_ENTRADA = Me.pDT_ENTRADA
            aviacaoVendas.pCFOP = Me.pCFOP
            aviacaoVendas.pMARCA = Me.pMARCA
            aviacaoVendas.pANO_ENTRADA = Me.pANO_ENTRADA
            aviacaoVendas.pDESCON_FINAN = Me.pDESCON_FINAN
            aviacaoVendas.pDIA_ENTRADA = Me.pDIA_ENTRADA
            aviacaoVendas.pMES_ENTRADA = Me.pMES_ENTRADA
            aviacaoVendas.pDESCRICAO = Me.pDESCRICAO
            aviacaoVendas.pPERCENT_DESCONTO = Me.pPERCENT_DESCONTO
            aviacaoVendas.pPORCENT_COMISSAO = Me.pPORCENT_COMISSAO
            aviacaoVendas.pESTADO = Me.pESTADO
            aviacaoVendas.pREGIAO = Me.pREGIAO
            aviacaoVendas.pCIDADE_VENDEDOR = Me.pCIDADE_VENDEDOR
            aviacaoVendas.pVALOR_COMISSAO = Me.pVALOR_COMISSAO
            aviacaoVendas.pCODIGO_VENDEDOR = Me.pCODIGO_VENDEDOR
            aviacaoVendas.pNOME_VENDEDOR = Me.pNOME_VENDEDOR
            aviacaoVendas.pCLIENTE = Me.pCLIENTE
            aviacaoVendas.pFILIAL = Me.pFILIAL
            aviacaoVendas.pNUMERO_NF = Me.pNUMERO_NF
            aviacaoVendas.pSERIE = Me.pSERIE
            aviacaoVendas.pCIDADE_CLIENTE = Me.pCIDADE_CLIENTE
            aviacaoVendas.pCIDADE_CLIENTE_IBGE = Me.pCIDADE_CLIENTE_IBGE
            aviacaoVendas.pLOJA = Me.pLOJA
            aviacaoVendas.pNOME_CLIENTE = Me.pNOME_CLIENTE
            aviacaoVendas.pDATA_EMISSAO = Me.pDATA_EMISSAO
            aviacaoVendas.pGRUPO_PRODUTO = Me.pGRUPO_PRODUTO
            aviacaoVendas.pPESO_PRODUTO = Me.pPESO_PRODUTO
            aviacaoVendas.pNOME_REDESPACHO = Me.pNOME_REDESPACHO
            aviacaoVendas.pPRODUTO = Me.pPRODUTO
            aviacaoVendas.pPESO_TOTAL = Me.pPESO_TOTAL
            aviacaoVendas.pPESO_BRUTO = Me.pPESO_BRUTO
            aviacaoVendas.pQTD_P_CAIXA = Me.pQTD_P_CAIXA
            aviacaoVendas.pQTD_EM_CAIXA = Me.pQTD_EM_CAIXA
            aviacaoVendas.pMES_EXTENSO = Me.pMES_EXTENSO
            aviacaoVendas.pANO_EMISSAO = Me.pANO_EMISSAO
            aviacaoVendas.pDIA_EMISSAO = Me.pDIA_EMISSAO
            aviacaoVendas.pMES_EMISSAO = Me.pMES_EMISSAO
            aviacaoVendas.pNOME_TRANSP = Me.pNOME_TRANSP
            aviacaoVendas.pREDESPACHO = Me.pREDESPACHO
            aviacaoVendas.pTRIMESTRE = Me.pTRIMESTRE
            aviacaoVendas.pCODIGO_TRANSP = Me.pCODIGO_TRANSP
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, aviacaoVendas))
        End Sub
