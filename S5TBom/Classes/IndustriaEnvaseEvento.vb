...
Namespace S5T
    ...
    Partial Public Class IndustriaEnvaseEvento
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.IndustriaEnvaseEvento), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.IndustriaEnvaseEvento)
        ...
        Public Overloads Overridable Function Equals(ByVal industriaEnvaseEvento As S5T.IndustriaEnvaseEvento) As Boolean Implements System.IEquatable(Of S5T.IndustriaEnvaseEvento).Equals
            If (industriaEnvaseEvento Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(industriaEnvaseEvento)
            End If
            Return (Me.pId.Equals(industriaEnvaseEvento.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                industriaEnvaseEvento = CType(obj,S5T.IndustriaEnvaseEvento)
            Catch icex As System.InvalidCastException
                industriaEnvaseEvento = Nothing
            End Try
            Return Me.Equals(industriaEnvaseEvento)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(industriaEnvaseEvento)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal industriaEnvaseEvento As S5T.IndustriaEnvaseEvento) As Integer Implements System.IComparable(Of S5T.IndustriaEnvaseEvento).CompareTo
            If (industriaEnvaseEvento Is Nothing) Then
                Throw New System.ArgumentNullException("industriaEnvaseEvento")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(industriaEnvaseEvento.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.IndustriaEnvaseEvento.ExternalValidate", "Type 'S5T.IndustriaEnvaseEvento' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "IndustriaEnvaseEvento", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.IndustriaEnvaseEvento
            If (pId = -1) Then
                Return Nothing
            End If
            Dim industriaEnvaseEvento As S5T.IndustriaEnvaseEvento = New S5T.IndustriaEnvaseEvento()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "IndustriaEnvaseEvento", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    industriaEnvaseEvento.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.IndustriaEnvaseEvento
            If (pId = -1) Then
                Return Nothing
            End If
            Dim industriaEnvaseEvento As S5T.IndustriaEnvaseEvento = New S5T.IndustriaEnvaseEvento()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "IndustriaEnvaseEvento", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5T.IndustriaEnvaseEvento.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "IndustriaEnvaseEvento", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal industriaEnvaseEvento As S5T.IndustriaEnvaseEvento) As Boolean
            If (industriaEnvaseEvento Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal industriaEnvaseEvento As S5T.IndustriaEnvaseEvento) As Boolean
            Dim ret As Boolean = S5T.IndustriaEnvaseEvento.Save(industriaEnvaseEvento)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal industriaEnvaseEvento As S5T.IndustriaEnvaseEvento) As Boolean
            If (industriaEnvaseEvento Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.IndustriaEnvaseEvento
            ...
            industriaEnvaseEvento = S5T.IndustriaEnvaseEvento.Load(var)
            Return industriaEnvaseEvento
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.IndustriaEnvaseEvento
            Dim industriaEnvaseEvento As S5T.IndustriaEnvaseEvento = New S5T.IndustriaEnvaseEvento()
            Me.CopyTo(industriaEnvaseEvento, deep)
            Return industriaEnvaseEvento
        End Function
        
        Public Overloads Function Clone() As S5T.IndustriaEnvaseEvento
            Dim localClone As S5T.IndustriaEnvaseEvento = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal industriaEnvaseEvento As S5T.IndustriaEnvaseEvento, ByVal deep As Boolean)
            If (industriaEnvaseEvento Is Nothing) Then
                Throw New System.ArgumentNullException("industriaEnvaseEvento")
            End If
            industriaEnvaseEvento.pId = Me.pId
            industriaEnvaseEvento.tempo_segundos = Me.tempo_segundos
            industriaEnvaseEvento.tempo_datetime = Me.tempo_datetime
            industriaEnvaseEvento.tempo_horas = Me.tempo_horas
            industriaEnvaseEvento.tempo_minutos = Me.tempo_minutos
            industriaEnvaseEvento.tempo_mm = Me.tempo_mm
            industriaEnvaseEvento.tempo_ss = Me.tempo_ss
            industriaEnvaseEvento.tempo_dd = Me.tempo_dd
            industriaEnvaseEvento.tempo_hh = Me.tempo_hh
            industriaEnvaseEvento.tempo_dias = Me.tempo_dias
            industriaEnvaseEvento.periodoFIM = Me.periodoFIM
            industriaEnvaseEvento.objectid = Me.objectid
            industriaEnvaseEvento.idtag = Me.idtag
            industriaEnvaseEvento.periodoINI = Me.periodoINI
            industriaEnvaseEvento.numOcorrencia = Me.numOcorrencia
            industriaEnvaseEvento.tempo_hhmmss = Me.tempo_hhmmss
            industriaEnvaseEvento.description = Me.description
            industriaEnvaseEvento.hostname = Me.hostname
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, industriaEnvaseEvento))
        End Sub
