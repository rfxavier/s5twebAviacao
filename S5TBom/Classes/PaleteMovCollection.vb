...
Namespace S5T
    ...
    Partial Public Class PaleteMovCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5T.PaleteMov), System.Collections.Generic.ICollection(Of S5T.PaleteMov), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5T.PaleteMov) = New System.Collections.Generic.List(Of S5T.PaleteMov)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5T.PaleteMov) = New System.Collections.Generic.Dictionary(Of Long, S5T.PaleteMov)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _oPaleteMovsPaleteProdutooPaleteProduto As S5T.PaleteProduto
        
        <System.NonSerializedAttribute()>  _
        Private _addNewPos As Integer = -1
        
        <System.NonSerializedAttribute()>  _
        Private _blm3766310867 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.PaleteMov)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm3766310867 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.PaleteMov)(Me)
        End Sub
        
        Public Sub New(ByVal oPaleteMovsPaleteProdutooPaleteProduto As S5T.PaleteProduto)
            MyBase.New
            Me._blm3766310867 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.PaleteMov)(Me)
            Me._oPaleteMovsPaleteProdutooPaleteProduto = oPaleteMovsPaleteProdutooPaleteProduto
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5T.PaleteMov)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5T.PaleteMov)
            Get
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Public ReadOnly Property oPaleteMovsPaleteProdutooPaleteProduto() As S5T.PaleteProduto
            Get
                Return Me._oPaleteMovsPaleteProdutooPaleteProduto
            End Get
        End Property
        
        Public Overloads Default Property Item(ByVal index As Integer) As S5T.PaleteMov Implements System.Collections.Generic.IList(Of S5T.PaleteMov).Item
            Get
                Return CType(Me.BaseList(index),S5T.PaleteMov)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5T.PaleteMov)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5T.PaleteMov
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5T.PaleteMov = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim paleteMov As S5T.PaleteMov = Me.TryGetValue(pId)
                    If (Not (paleteMov) Is Nothing) Then
                        Me.Remove(paleteMov)
                    End If
                    Return
                End If
                Dim existing As S5T.PaleteMov = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5T.PaleteMov).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5T.PaleteMov).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm3766310867.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm3766310867.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5T.PaleteMov, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal paleteMov As S5T.PaleteMov) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(paleteMov)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal paleteMov As S5T.PaleteMov) As Integer
            If (paleteMov Is Nothing) Then
                Throw New System.ArgumentNullException("paleteMov")
            End If
            If (paleteMov.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "paleteMov", "S5T.PaleteMov")
            End If
            Try 
                Me.BaseTable.Add(paleteMov.pId, paleteMov)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.PaleteMovCollection", paleteMov.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.PaleteMovCollection", paleteMov.pId), ae)
            End Try
            AddHandler paleteMov.KeyChanged, AddressOf Me.OnItemKeyChanged
            If (Not (Me._oPaleteMovsPaleteProdutooPaleteProduto) Is Nothing) Then
                paleteMov.oPaleteProduto = Me._oPaleteMovsPaleteProdutooPaleteProduto
            End If
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(paleteMov)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, paleteMov, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            ...
            If (paleteMov Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(paleteMov)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5T_PaleteMov__Add(ByVal paleteMov As S5T.PaleteMov) Implements System.Collections.Generic.ICollection(Of S5T.PaleteMov).Add
            Me.BaseAdd(paleteMov)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5T.PaleteMov
            Dim paleteMov As S5T.PaleteMov = S5T.PaleteMov.LoadByEntityKey(key)
            If ((Not (paleteMov) Is Nothing)  _
                        AndAlso (Me.Contains(paleteMov) = false)) Then
                Me.Add(paleteMov)
            End If
            Return paleteMov
        End Function
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5T.PaleteMov))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5T.PaleteMov, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5T.PaleteMov).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5T.PaleteMov, ByVal index As Integer)
        ...
        Public Function Contains(ByVal paleteMov As S5T.PaleteMov) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.PaleteMov).Contains
            Dim localContains As Boolean = Me.BaseContains(paleteMov)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal paleteMov As S5T.PaleteMov) As Boolean
            If (paleteMov Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(paleteMov.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            ...
            Catch icex As System.InvalidCastException
                paleteMov = Nothing
            End Try
            Return Me.Contains(paleteMov)
        End Function
        
        Public Function IndexOf(ByVal paleteMov As S5T.PaleteMov) As Integer Implements System.Collections.Generic.IList(Of S5T.PaleteMov).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(paleteMov)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal paleteMov As S5T.PaleteMov) As Integer
            If (paleteMov Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(paleteMov)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                paleteMov = Nothing
            End Try
            Return Me.IndexOf(paleteMov)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal paleteMov As S5T.PaleteMov) Implements System.Collections.Generic.IList(Of S5T.PaleteMov).Insert
            Me.BaseInsert(index, paleteMov)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal paleteMov As S5T.PaleteMov)
            If (paleteMov Is Nothing) Then
                Throw New System.ArgumentNullException("paleteMov")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.PaleteMovCollection", paleteMov.pId), ae)
            End Try
            Me.BaseList.Insert(index, paleteMov)
            If (Not (Me._oPaleteMovsPaleteProdutooPaleteProduto) Is Nothing) Then
                paleteMov.oPaleteProduto = Me._oPaleteMovsPaleteProdutooPaleteProduto
            End If
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, paleteMov, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                paleteMov = Nothing
            End Try
            Me.Insert(index, paleteMov)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5T.PaleteMov).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim PaleteMov As S5T.PaleteMov = Me(0)
                Me.BaseRemove(PaleteMov)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal paleteMov As S5T.PaleteMov) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.PaleteMov).Remove
            Return Me.BaseRemove(paleteMov)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal paleteMov As S5T.PaleteMov) As Boolean
            If (paleteMov Is Nothing) Then
                Throw New System.ArgumentNullException("paleteMov")
            End If
            Dim index As Integer = Me.IndexOf(paleteMov)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.PaleteMov).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(paleteMov)
            RemoveHandler paleteMov.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(paleteMov.pId)
            If (Not (Me._oPaleteMovsPaleteProdutooPaleteProduto) Is Nothing) Then
                paleteMov.oPaleteProduto = Nothing
            End If
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, paleteMov, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5T.PaleteMov).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.PaleteMov).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim paleteMov As S5T.PaleteMov = Me.BaseList(index)
            If (Not (paleteMov) Is Nothing) Then
                RemoveHandler paleteMov.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(paleteMov.pId)
            End If
            If (Not (Me._oPaleteMovsPaleteProdutooPaleteProduto) Is Nothing) Then
                paleteMov.oPaleteProduto = Nothing
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5T.PaleteMov) Implements System.Collections.Generic.IEnumerable(Of S5T.PaleteMov).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5T.PaleteMov) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5T.PaleteMov
            Dim paleteMov As S5T.PaleteMov = Nothing
            If (Me.BaseTable.TryGetValue(key, paleteMov) = true) Then
                Return paleteMov
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim paleteMov As S5T.PaleteMov = Me(index)
                paleteMov.Save
                If (paleteMov.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(paleteMov)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            If (pageSize < 0) Then
                ...
                End If
            End If
            Me._oPaleteMovsPaleteProdutooPaleteProduto = Nothing
            Me.BaseList.Clear
            Me.BaseTable.Clear
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    ...
                    CType(paleteMov,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(paleteMov) = false) Then
                        Me.BaseAdd(paleteMov)
                        count = (count + 1)
                    End If
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5T.PaleteMovCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5T.PaleteMovCollection = New S5T.PaleteMovCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.PaleteMovCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5T.PaleteMovCollection
            Dim ret As S5T.PaleteMovCollection = S5T.PaleteMovCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "PaleteMov", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.PaleteMovCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        
        Private Overloads Sub LoadByoPaleteProduto(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader, ByVal oPaleteProduto As S5T.PaleteProduto)
            If (reader Is Nothing) Then
                Throw New System.ArgumentNullException("reader")
            End If
            If (pageIndex < 0) Then
            ...
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim paleteProdutoState As CodeFluent.Runtime.CodeFluentEntityState = CodeFluent.Runtime.CodeFluentEntityState.Unchanged
            If (Not (oPaleteProduto) Is Nothing) Then
                paleteProdutoState = oPaleteProduto.EntityState
            End If
            Me._oPaleteMovsPaleteProdutooPaleteProduto = oPaleteProduto
            Me.BaseList.Clear
            Me.BaseTable.Clear
            Dim count As Integer = 0
            Dim readCount As Integer = 0
            ...
            Loop
            If (Not (oPaleteProduto) Is Nothing) Then
                oPaleteProduto.EntityState = paleteProdutoState
            End If
        End Sub
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadByoPaleteProduto(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal oPaleteProduto As S5T.PaleteProduto) As S5T.PaleteMovCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
            ...
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.PaleteMovCollection.PageDataLoadByoPaleteProduto(pageOptions, oPaleteProduto)
                If (reader Is Nothing) Then
                    Return ret
                End If
                ret.LoadByoPaleteProduto(pageIndex, pageSize, pageOptions, reader, oPaleteProduto)
            Finally
                If (Not (reader) Is Nothing) Then
                    reader.Dispose
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadByoPaleteProduto(ByVal oPaleteProduto As S5T.PaleteProduto) As S5T.PaleteMovCollection
            Dim ret As S5T.PaleteMovCollection = S5T.PaleteMovCollection.PageLoadByoPaleteProduto(Integer.MinValue, Integer.MaxValue, Nothing, oPaleteProduto)
            Return ret
        End Function
        
        Public Shared Function PageDataLoadByoPaleteProduto(ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal oPaleteProduto As S5T.PaleteProduto) As System.Data.IDataReader
            If (oPaleteProduto Is Nothing) Then
                Return Nothing
            End If
            If (oPaleteProduto.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "oPaleteProduto", "S5T.PaleteProduto")
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "PaleteMov", "LoadByoPaleteProduto")
            persistence.AddParameter("@oPaleteProdutopId", oPaleteProduto.pId, CType(-1,Long))
            If (Not (pageOptions) Is Nothing) Then
                Dim enumerator As System.Collections.IEnumerator = pageOptions.OrderByArguments.GetEnumerator
                Dim b As Boolean
                Dim index As Integer = 0
        ...
        Public Shared Function DataLoadByoPaleteProduto(ByVal oPaleteProduto As S5T.PaleteProduto) As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.PaleteMovCollection.PageDataLoadByoPaleteProduto(Nothing, oPaleteProduto)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5T.PaleteMovCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5T.PaleteMov)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5T.PaleteMov) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5T.PaleteMov))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5T.PaleteMovCollection
            Dim ret As S5T.PaleteMovCollection = New S5T.PaleteMovCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm3766310867.AddIndex([property])
        End Sub
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm3766310867.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm3766310867.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5T.PaleteMov))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5T.PaleteMov = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.PaleteMovCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.PaleteMovCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5T.PaleteMovCollection
            Return S5T.PaleteMovCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadByoPaleteProduto(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal oPaleteProdutoPId As Long) As S5T.PaleteMovCollection
            Dim paleteProduto As S5T.PaleteProduto = S5T.PaleteProduto.Load(oPaleteProdutoPId)
            If (paleteProduto Is Nothing) Then
                Return New S5T.PaleteMovCollection()
            End If
            Return S5T.PaleteMovCollection.PageLoadByoPaleteProduto(pageIndex, pageSize, Nothing, paleteProduto)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal paleteMov As S5T.PaleteMov) As Boolean
            If (paleteMov Is Nothing) Then
                Return false
            End If
        ...
        Public Overloads Shared Function Insert(ByVal paleteMov As S5T.PaleteMov) As Boolean
            Dim ret As Boolean = S5T.PaleteMov.Save(paleteMov)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal paleteMov As S5T.PaleteMov) As Boolean
            If (paleteMov Is Nothing) Then
                Return false
            End If
