...
Namespace S5T
    ...
    Partial Public Class IndustriaLeiteEvento
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.IndustriaLeiteEvento), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.IndustriaLeiteEvento)
        ...
        Public Overloads Overridable Function Equals(ByVal industriaLeiteEvento As S5T.IndustriaLeiteEvento) As Boolean Implements System.IEquatable(Of S5T.IndustriaLeiteEvento).Equals
            If (industriaLeiteEvento Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(industriaLeiteEvento)
            End If
            Return (Me.pId.Equals(industriaLeiteEvento.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                industriaLeiteEvento = CType(obj,S5T.IndustriaLeiteEvento)
            Catch icex As System.InvalidCastException
                industriaLeiteEvento = Nothing
            End Try
            Return Me.Equals(industriaLeiteEvento)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(industriaLeiteEvento)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal industriaLeiteEvento As S5T.IndustriaLeiteEvento) As Integer Implements System.IComparable(Of S5T.IndustriaLeiteEvento).CompareTo
            If (industriaLeiteEvento Is Nothing) Then
                Throw New System.ArgumentNullException("industriaLeiteEvento")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(industriaLeiteEvento.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.IndustriaLeiteEvento.ExternalValidate", "Type 'S5T.IndustriaLeiteEvento' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "IndustriaLeiteEvento", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.IndustriaLeiteEvento
            If (pId = -1) Then
                Return Nothing
            End If
            Dim industriaLeiteEvento As S5T.IndustriaLeiteEvento = New S5T.IndustriaLeiteEvento()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "IndustriaLeiteEvento", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    industriaLeiteEvento.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.IndustriaLeiteEvento
            If (pId = -1) Then
                Return Nothing
            End If
            Dim industriaLeiteEvento As S5T.IndustriaLeiteEvento = New S5T.IndustriaLeiteEvento()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "IndustriaLeiteEvento", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5T.IndustriaLeiteEvento.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "IndustriaLeiteEvento", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal industriaLeiteEvento As S5T.IndustriaLeiteEvento) As Boolean
            If (industriaLeiteEvento Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal industriaLeiteEvento As S5T.IndustriaLeiteEvento) As Boolean
            Dim ret As Boolean = S5T.IndustriaLeiteEvento.Save(industriaLeiteEvento)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal industriaLeiteEvento As S5T.IndustriaLeiteEvento) As Boolean
            If (industriaLeiteEvento Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.IndustriaLeiteEvento
            ...
            industriaLeiteEvento = S5T.IndustriaLeiteEvento.Load(var)
            Return industriaLeiteEvento
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.IndustriaLeiteEvento
            Dim industriaLeiteEvento As S5T.IndustriaLeiteEvento = New S5T.IndustriaLeiteEvento()
            Me.CopyTo(industriaLeiteEvento, deep)
            Return industriaLeiteEvento
        End Function
        
        Public Overloads Function Clone() As S5T.IndustriaLeiteEvento
            Dim localClone As S5T.IndustriaLeiteEvento = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal industriaLeiteEvento As S5T.IndustriaLeiteEvento, ByVal deep As Boolean)
            If (industriaLeiteEvento Is Nothing) Then
                Throw New System.ArgumentNullException("industriaLeiteEvento")
            End If
            industriaLeiteEvento.pId = Me.pId
            industriaLeiteEvento.tempo_segundos = Me.tempo_segundos
            industriaLeiteEvento.tempo_datetime = Me.tempo_datetime
            industriaLeiteEvento.tempo_horas = Me.tempo_horas
            industriaLeiteEvento.tempo_minutos = Me.tempo_minutos
            industriaLeiteEvento.tempo_mm = Me.tempo_mm
            industriaLeiteEvento.tempo_ss = Me.tempo_ss
            industriaLeiteEvento.tempo_dd = Me.tempo_dd
            industriaLeiteEvento.tempo_hh = Me.tempo_hh
            industriaLeiteEvento.tempo_dias = Me.tempo_dias
            industriaLeiteEvento.periodoFIM = Me.periodoFIM
            industriaLeiteEvento.objectid = Me.objectid
            industriaLeiteEvento.idtag = Me.idtag
            industriaLeiteEvento.periodoINI = Me.periodoINI
            industriaLeiteEvento.numOcorrencia = Me.numOcorrencia
            industriaLeiteEvento.tempo_hhmmss = Me.tempo_hhmmss
            industriaLeiteEvento.description = Me.description
            industriaLeiteEvento.hostname = Me.hostname
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, industriaLeiteEvento))
        End Sub
