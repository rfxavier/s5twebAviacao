...
Namespace S5T
    ...
    Partial Public Class AviacaoClientesCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5T.AviacaoClientes), System.Collections.Generic.ICollection(Of S5T.AviacaoClientes), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5T.AviacaoClientes) = New System.Collections.Generic.List(Of S5T.AviacaoClientes)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5T.AviacaoClientes) = New System.Collections.Generic.Dictionary(Of Long, S5T.AviacaoClientes)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm1985974720 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.AviacaoClientes)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm1985974720 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.AviacaoClientes)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5T.AviacaoClientes)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5T.AviacaoClientes)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As S5T.AviacaoClientes Implements System.Collections.Generic.IList(Of S5T.AviacaoClientes).Item
            Get
                Return CType(Me.BaseList(index),S5T.AviacaoClientes)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5T.AviacaoClientes)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5T.AviacaoClientes
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5T.AviacaoClientes = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim aviacaoClientes As S5T.AviacaoClientes = Me.TryGetValue(pId)
                    If (Not (aviacaoClientes) Is Nothing) Then
                        Me.Remove(aviacaoClientes)
                    End If
                    Return
                End If
                Dim existing As S5T.AviacaoClientes = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5T.AviacaoClientes).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5T.AviacaoClientes).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm1985974720.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm1985974720.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5T.AviacaoClientes, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal aviacaoClientes As S5T.AviacaoClientes) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(aviacaoClientes)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal aviacaoClientes As S5T.AviacaoClientes) As Integer
            If (aviacaoClientes Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoClientes")
            End If
            If (aviacaoClientes.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "aviacaoClientes", "S5T.AviacaoClientes")
            End If
            Try 
                Me.BaseTable.Add(aviacaoClientes.pId, aviacaoClientes)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.AviacaoClientesCollection", aviacaoClientes.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.AviacaoClientesCollection", aviacaoClientes.pId), ae)
            End Try
            AddHandler aviacaoClientes.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(aviacaoClientes)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, aviacaoClientes, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            ...
            If (aviacaoClientes Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(aviacaoClientes)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5T_AviacaoClientes__Add(ByVal aviacaoClientes As S5T.AviacaoClientes) Implements System.Collections.Generic.ICollection(Of S5T.AviacaoClientes).Add
            Me.BaseAdd(aviacaoClientes)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5T.AviacaoClientes
            Dim aviacaoClientes As S5T.AviacaoClientes = S5T.AviacaoClientes.LoadByEntityKey(key)
            If ((Not (aviacaoClientes) Is Nothing)  _
                        AndAlso (Me.Contains(aviacaoClientes) = false)) Then
                Me.Add(aviacaoClientes)
            End If
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5T.AviacaoClientes))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5T.AviacaoClientes, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5T.AviacaoClientes).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5T.AviacaoClientes, ByVal index As Integer)
        ...
        Public Function Contains(ByVal aviacaoClientes As S5T.AviacaoClientes) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.AviacaoClientes).Contains
            Dim localContains As Boolean = Me.BaseContains(aviacaoClientes)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal aviacaoClientes As S5T.AviacaoClientes) As Boolean
            If (aviacaoClientes Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(aviacaoClientes.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            ...
            Catch icex As System.InvalidCastException
                aviacaoClientes = Nothing
            End Try
            Return Me.Contains(aviacaoClientes)
        End Function
        
        Public Function IndexOf(ByVal aviacaoClientes As S5T.AviacaoClientes) As Integer Implements System.Collections.Generic.IList(Of S5T.AviacaoClientes).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(aviacaoClientes)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal aviacaoClientes As S5T.AviacaoClientes) As Integer
            If (aviacaoClientes Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(aviacaoClientes)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                aviacaoClientes = Nothing
            End Try
            Return Me.IndexOf(aviacaoClientes)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal aviacaoClientes As S5T.AviacaoClientes) Implements System.Collections.Generic.IList(Of S5T.AviacaoClientes).Insert
            Me.BaseInsert(index, aviacaoClientes)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal aviacaoClientes As S5T.AviacaoClientes)
            If (aviacaoClientes Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoClientes")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.AviacaoClientesCollection", aviacaoClientes.pId), ae)
            End Try
            Me.BaseList.Insert(index, aviacaoClientes)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, aviacaoClientes, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                aviacaoClientes = Nothing
            End Try
            Me.Insert(index, aviacaoClientes)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5T.AviacaoClientes).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim AviacaoClientes As S5T.AviacaoClientes = Me(0)
                Me.BaseRemove(AviacaoClientes)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal aviacaoClientes As S5T.AviacaoClientes) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.AviacaoClientes).Remove
            Return Me.BaseRemove(aviacaoClientes)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal aviacaoClientes As S5T.AviacaoClientes) As Boolean
            If (aviacaoClientes Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoClientes")
            End If
            Dim index As Integer = Me.IndexOf(aviacaoClientes)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.AviacaoClientes).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(aviacaoClientes)
            RemoveHandler aviacaoClientes.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(aviacaoClientes.pId)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, aviacaoClientes, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5T.AviacaoClientes).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.AviacaoClientes).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim aviacaoClientes As S5T.AviacaoClientes = Me.BaseList(index)
            If (Not (aviacaoClientes) Is Nothing) Then
                RemoveHandler aviacaoClientes.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(aviacaoClientes.pId)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5T.AviacaoClientes) Implements System.Collections.Generic.IEnumerable(Of S5T.AviacaoClientes).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5T.AviacaoClientes) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5T.AviacaoClientes
            Dim aviacaoClientes As S5T.AviacaoClientes = Nothing
            If (Me.BaseTable.TryGetValue(key, aviacaoClientes) = true) Then
                Return aviacaoClientes
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim aviacaoClientes As S5T.AviacaoClientes = Me(index)
                aviacaoClientes.Save
                If (aviacaoClientes.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(aviacaoClientes)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    ...
                    CType(aviacaoClientes,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(aviacaoClientes) = false) Then
                        Me.BaseAdd(aviacaoClientes)
                        count = (count + 1)
                    End If
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5T.AviacaoClientesCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5T.AviacaoClientesCollection = New S5T.AviacaoClientesCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.AviacaoClientesCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5T.AviacaoClientesCollection
            Dim ret As S5T.AviacaoClientesCollection = S5T.AviacaoClientesCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoClientes", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.AviacaoClientesCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5T.AviacaoClientesCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5T.AviacaoClientes)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5T.AviacaoClientes) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5T.AviacaoClientes))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5T.AviacaoClientesCollection
            Dim ret As S5T.AviacaoClientesCollection = New S5T.AviacaoClientesCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm1985974720.AddIndex([property])
        End Sub
        ...
        Private Function AddNew() As Object Implements System.ComponentModel.IBindingList.AddNew
            Dim add As S5T.AviacaoClientes = New S5T.AviacaoClientes()
            Dim e As System.ComponentModel.AddingNewEventArgs = New System.ComponentModel.AddingNewEventArgs(add)
            Me.OnAddingNew(e)
            add = CType(e.NewObject,S5T.AviacaoClientes)
            If (add Is Nothing) Then
                add = New S5T.AviacaoClientes()
            End If
            add.pId = 0
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm1985974720.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm1985974720.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5T.AviacaoClientes))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5T.AviacaoClientes = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.AviacaoClientesCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.AviacaoClientesCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5T.AviacaoClientesCollection
            Return S5T.AviacaoClientesCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal aviacaoClientes As S5T.AviacaoClientes) As Boolean
            If (aviacaoClientes Is Nothing) Then
                Return false
            End If
        ...
        Public Overloads Shared Function Insert(ByVal aviacaoClientes As S5T.AviacaoClientes) As Boolean
            Dim ret As Boolean = S5T.AviacaoClientes.Save(aviacaoClientes)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal aviacaoClientes As S5T.AviacaoClientes) As Boolean
            If (aviacaoClientes Is Nothing) Then
                Return false
            End If
