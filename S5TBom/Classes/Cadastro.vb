...
Namespace S5T
    ...
    Partial Public Class Cadastro
        ...
        <System.NonSerializedAttribute()>  _
        Private Shared _pEmailValidator0 As CodeFluent.Runtime.Rules.EmailValidator = New CodeFluent.Runtime.Rules.EmailValidator(S5T.Resources.ValueValidationFailureHandler.Current, CType(Nothing, String), "^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?"& _ 
                ":\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$", System.Text.RegularExpressions.RegexOptions.IgnoreCase, CType(Nothing, CodeFluent.Runtime.Rules.StringValidatorOptions))
