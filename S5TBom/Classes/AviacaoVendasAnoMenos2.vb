...
Namespace S5T
    ...
    Partial Public Class AviacaoVendasAnoMenos2
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.AviacaoVendasAnoMenos2), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.AviacaoVendasAnoMenos2)
        ...
        Public Overloads Overridable Function Equals(ByVal aviacaoVendasAnoMenos2 As S5T.AviacaoVendasAnoMenos2) As Boolean Implements System.IEquatable(Of S5T.AviacaoVendasAnoMenos2).Equals
            If (aviacaoVendasAnoMenos2 Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(aviacaoVendasAnoMenos2)
            End If
            Return (Me.pId.Equals(aviacaoVendasAnoMenos2.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                aviacaoVendasAnoMenos2 = CType(obj,S5T.AviacaoVendasAnoMenos2)
            Catch icex As System.InvalidCastException
                aviacaoVendasAnoMenos2 = Nothing
            End Try
            Return Me.Equals(aviacaoVendasAnoMenos2)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(aviacaoVendasAnoMenos2)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal aviacaoVendasAnoMenos2 As S5T.AviacaoVendasAnoMenos2) As Integer Implements System.IComparable(Of S5T.AviacaoVendasAnoMenos2).CompareTo
            If (aviacaoVendasAnoMenos2 Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoVendasAnoMenos2")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(aviacaoVendasAnoMenos2.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.AviacaoVendasAnoMenos2.ExternalValidate", "Type 'S5T.AviacaoVendasAnoMenos2' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAnoMenos2", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.AviacaoVendasAnoMenos2
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoVendasAnoMenos2 As S5T.AviacaoVendasAnoMenos2 = New S5T.AviacaoVendasAnoMenos2()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAnoMenos2", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    aviacaoVendasAnoMenos2.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.AviacaoVendasAnoMenos2
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoVendasAnoMenos2 As S5T.AviacaoVendasAnoMenos2 = New S5T.AviacaoVendasAnoMenos2()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAnoMenos2", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5T.AviacaoVendasAnoMenos2.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAnoMenos2", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal aviacaoVendasAnoMenos2 As S5T.AviacaoVendasAnoMenos2) As Boolean
            If (aviacaoVendasAnoMenos2 Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal aviacaoVendasAnoMenos2 As S5T.AviacaoVendasAnoMenos2) As Boolean
            Dim ret As Boolean = S5T.AviacaoVendasAnoMenos2.Save(aviacaoVendasAnoMenos2)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal aviacaoVendasAnoMenos2 As S5T.AviacaoVendasAnoMenos2) As Boolean
            If (aviacaoVendasAnoMenos2 Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.AviacaoVendasAnoMenos2
            ...
            aviacaoVendasAnoMenos2 = S5T.AviacaoVendasAnoMenos2.Load(var)
            Return aviacaoVendasAnoMenos2
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.AviacaoVendasAnoMenos2
            Dim aviacaoVendasAnoMenos2 As S5T.AviacaoVendasAnoMenos2 = New S5T.AviacaoVendasAnoMenos2()
            Me.CopyTo(aviacaoVendasAnoMenos2, deep)
            Return aviacaoVendasAnoMenos2
        End Function
        
        Public Overloads Function Clone() As S5T.AviacaoVendasAnoMenos2
            Dim localClone As S5T.AviacaoVendasAnoMenos2 = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal aviacaoVendasAnoMenos2 As S5T.AviacaoVendasAnoMenos2, ByVal deep As Boolean)
            If (aviacaoVendasAnoMenos2 Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoVendasAnoMenos2")
            End If
            aviacaoVendasAnoMenos2.pId = Me.pId
            aviacaoVendasAnoMenos2.pVLR_COFINS = Me.pVLR_COFINS
            aviacaoVendasAnoMenos2.pVLR_PIS = Me.pVLR_PIS
            aviacaoVendasAnoMenos2.pVLR_SEM_ICMSST = Me.pVLR_SEM_ICMSST
            aviacaoVendasAnoMenos2.pVLR_ICM = Me.pVLR_ICM
            aviacaoVendasAnoMenos2.pIMPOSTO_TOTAL_NOTA = Me.pIMPOSTO_TOTAL_NOTA
            aviacaoVendasAnoMenos2.pB1_QE = Me.pB1_QE
            aviacaoVendasAnoMenos2.pPRECO_FORA_IMPOSTO = Me.pPRECO_FORA_IMPOSTO
            aviacaoVendasAnoMenos2.pPRECO_FORA_IMPOSTO_UNIT = Me.pPRECO_FORA_IMPOSTO_UNIT
            aviacaoVendasAnoMenos2.pPRECO_TABELA = Me.pPRECO_TABELA
            aviacaoVendasAnoMenos2.pVLR_TOTAL_PRODUTO = Me.pVLR_TOTAL_PRODUTO
            aviacaoVendasAnoMenos2.pDESCRICAO = Me.pDESCRICAO
            aviacaoVendasAnoMenos2.pQUANTIDADE = Me.pQUANTIDADE
            aviacaoVendasAnoMenos2.pVLR_BASE_ICM = Me.pVLR_BASE_ICM
            aviacaoVendasAnoMenos2.pVLR_TOTAL_NOTA = Me.pVLR_TOTAL_NOTA
            aviacaoVendasAnoMenos2.pPRECO_DE_VENDA = Me.pPRECO_DE_VENDA
            aviacaoVendasAnoMenos2.pVLR_DESCONTO = Me.pVLR_DESCONTO
            aviacaoVendasAnoMenos2.pB1_CONV = Me.pB1_CONV
            aviacaoVendasAnoMenos2.pCUSTO_PROD_QTD = Me.pCUSTO_PROD_QTD
            aviacaoVendasAnoMenos2.pNRO_PEDIDO_CLIENTE = Me.pNRO_PEDIDO_CLIENTE
            aviacaoVendasAnoMenos2.pDESCON_FINAN = Me.pDESCON_FINAN
            aviacaoVendasAnoMenos2.pCUSTO_PRODUTO = Me.pCUSTO_PRODUTO
            aviacaoVendasAnoMenos2.pBAIRRO_CLIE = Me.pBAIRRO_CLIE
            aviacaoVendasAnoMenos2.pULTIMA_COMPRA = Me.pULTIMA_COMPRA
            aviacaoVendasAnoMenos2.pPEDIDO = Me.pPEDIDO
            aviacaoVendasAnoMenos2.pENDERECO_CLI = Me.pENDERECO_CLI
            aviacaoVendasAnoMenos2.pMARCA = Me.pMARCA
            aviacaoVendasAnoMenos2.pGRUPO_CLIENTE = Me.pGRUPO_CLIENTE
            aviacaoVendasAnoMenos2.pPLACA = Me.pPLACA
            aviacaoVendasAnoMenos2.pCFOP = Me.pCFOP
            aviacaoVendasAnoMenos2.pMES_ENTRADA = Me.pMES_ENTRADA
            aviacaoVendasAnoMenos2.pANO_ENTRADA = Me.pANO_ENTRADA
            aviacaoVendasAnoMenos2.pDT_ENTRADA = Me.pDT_ENTRADA
            aviacaoVendasAnoMenos2.pDIA_ENTRADA = Me.pDIA_ENTRADA
            aviacaoVendasAnoMenos2.pPERCENT_DESCONTO = Me.pPERCENT_DESCONTO
            aviacaoVendasAnoMenos2.pPORCENT_COMISSAO = Me.pPORCENT_COMISSAO
            aviacaoVendasAnoMenos2.pESTADO = Me.pESTADO
            aviacaoVendasAnoMenos2.pREGIAO = Me.pREGIAO
            aviacaoVendasAnoMenos2.pCIDADE_VENDEDOR = Me.pCIDADE_VENDEDOR
            aviacaoVendasAnoMenos2.pVALOR_COMISSAO = Me.pVALOR_COMISSAO
            aviacaoVendasAnoMenos2.pCODIGO_VENDEDOR = Me.pCODIGO_VENDEDOR
            aviacaoVendasAnoMenos2.pNOME_VENDEDOR = Me.pNOME_VENDEDOR
            aviacaoVendasAnoMenos2.pCLIENTE = Me.pCLIENTE
            aviacaoVendasAnoMenos2.pFILIAL = Me.pFILIAL
            aviacaoVendasAnoMenos2.pNUMERO_NF = Me.pNUMERO_NF
            aviacaoVendasAnoMenos2.pSERIE = Me.pSERIE
            aviacaoVendasAnoMenos2.pCIDADE_CLIENTE = Me.pCIDADE_CLIENTE
            aviacaoVendasAnoMenos2.pCIDADE_CLIENTE_IBGE = Me.pCIDADE_CLIENTE_IBGE
            aviacaoVendasAnoMenos2.pLOJA = Me.pLOJA
            aviacaoVendasAnoMenos2.pNOME_CLIENTE = Me.pNOME_CLIENTE
            aviacaoVendasAnoMenos2.pDATA_EMISSAO = Me.pDATA_EMISSAO
            aviacaoVendasAnoMenos2.pGRUPO_PRODUTO = Me.pGRUPO_PRODUTO
            aviacaoVendasAnoMenos2.pPESO_PRODUTO = Me.pPESO_PRODUTO
            aviacaoVendasAnoMenos2.pNOME_REDESPACHO = Me.pNOME_REDESPACHO
            aviacaoVendasAnoMenos2.pPRODUTO = Me.pPRODUTO
            aviacaoVendasAnoMenos2.pPESO_TOTAL = Me.pPESO_TOTAL
            aviacaoVendasAnoMenos2.pPESO_BRUTO = Me.pPESO_BRUTO
            aviacaoVendasAnoMenos2.pQTD_P_CAIXA = Me.pQTD_P_CAIXA
            aviacaoVendasAnoMenos2.pQTD_EM_CAIXA = Me.pQTD_EM_CAIXA
            aviacaoVendasAnoMenos2.pMES_EXTENSO = Me.pMES_EXTENSO
            aviacaoVendasAnoMenos2.pANO_EMISSAO = Me.pANO_EMISSAO
            aviacaoVendasAnoMenos2.pDIA_EMISSAO = Me.pDIA_EMISSAO
            aviacaoVendasAnoMenos2.pMES_EMISSAO = Me.pMES_EMISSAO
            aviacaoVendasAnoMenos2.pNOME_TRANSP = Me.pNOME_TRANSP
            aviacaoVendasAnoMenos2.pREDESPACHO = Me.pREDESPACHO
            aviacaoVendasAnoMenos2.pTRIMESTRE = Me.pTRIMESTRE
            aviacaoVendasAnoMenos2.pCODIGO_TRANSP = Me.pCODIGO_TRANSP
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, aviacaoVendasAnoMenos2))
        End Sub
