...
Namespace S5T
    ...
    Partial Public Class Usuario
        ...
        <System.NonSerializedAttribute()>  _
        Private _oAviacaoPivotAnalises As S5T.AviacaoPivotAnaliseCollection
        
        Private _pCodigoVendedor As String = CType(Nothing, String)
        
        Private _pCodigoAprovador As String = CType(Nothing, String)
        
        Private _pCodigoVendedorVinculado As String = CType(Nothing, String)
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Public ReadOnly Property oAviacaoPivotAnalises() As S5T.AviacaoPivotAnaliseCollection
            Get
                If (Me._oAviacaoPivotAnalises Is Nothing) Then
                    If ((Me.pId = -1)  _
                                OrElse (Me.EntityState.Equals(CodeFluent.Runtime.CodeFluentEntityState.Created) = true)) Then
                        Me._oAviacaoPivotAnalises = New S5T.AviacaoPivotAnaliseCollection(Me)
                        Return Me._oAviacaoPivotAnalises
                    End If
                    Me._oAviacaoPivotAnalises = S5T.AviacaoPivotAnaliseCollection.LoadByoUsuario(Me)
                End If
                Return Me._oAviacaoPivotAnalises
            End Get
        End Property
        ...
        <System.ComponentModel.DefaultValueAttribute(CType(Nothing, String)),  _
         System.Xml.Serialization.XmlElementAttribute(IsNullable:=true, Type:=GetType(String))>  _
        Public Property pCodigoVendedor() As String
            Get
                Return Me._pCodigoVendedor
            End Get
            Set
                Me._pCodigoVendedor = value
                Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("pCodigoVendedor"))
            End Set
        End Property
        ...
        <System.ComponentModel.DefaultValueAttribute(CType(Nothing, String)),  _
         System.Xml.Serialization.XmlElementAttribute(IsNullable:=true, Type:=GetType(String))>  _
        Public Property pCodigoVendedorVinculado() As String
            Get
                Return Me._pCodigoVendedorVinculado
            End Get
            Set
                Me._pCodigoVendedorVinculado = value
                Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("pCodigoVendedorVinculado"))
            End Set
        End Property
        ...
        Protected Overridable Sub ReadRecord(ByVal reader As System.Data.IDataReader, ByVal options As CodeFluent.Runtime.CodeFluentReloadOptions)
            ...
            If (((options And CodeFluent.Runtime.CodeFluentReloadOptions.Properties)  _
                ...
                Me._pCodigoVendedor = CodeFluentPersistence.GetReaderValue(reader, "pCodigoVendedor", CType(CType(Nothing, String),String))
                Me._pCodigoAprovador = CodeFluentPersistence.GetReaderValue(reader, "pCodigoAprovador", CType(CType(Nothing, String),String))
                Me._pCodigoVendedorVinculado = CodeFluentPersistence.GetReaderValue(reader, "pCodigoVendedorVinculado", CType(CType(Nothing, String),String))
...
DeleteLinkCadastroPartial(parUsuario)
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            ...
            persistence.AddParameter("@pCodigoVendedor", Me.pCodigoVendedor, CType(Nothing, String))
            persistence.AddParameter("@pCodigoAprovador", Me.pCodigoAprovador, CType(Nothing, String))
            persistence.AddParameter("@pCodigoVendedorVinculado", Me.pCodigoVendedorVinculado, CType(Nothing, String))
        ...
        Protected Overridable Sub BaseTrace(ByVal writer As System.CodeDom.Compiler.IndentedTextWriter)
            ...
            writer.Write(",")
            writer.Write("oAviacaoPivotAnalises=")
            If (Not (Me._oAviacaoPivotAnalises) Is Nothing) Then
                CType(Me._oAviacaoPivotAnalises,CodeFluent.Runtime.ICodeFluentObject).Trace(writer)
            Else
                writer.Write("<null>")
            End If
            writer.Write(",")
            writer.Write("pCodigoVendedor=")
            writer.Write(Me.pCodigoVendedor)
            writer.Write(",")
            writer.Write("pCodigoAprovador=")
            writer.Write(Me.pCodigoAprovador)
            writer.Write(",")
            writer.Write("pCodigoVendedorVinculado=")
            writer.Write(Me.pCodigoVendedorVinculado)
            writer.Write(",")
        ...
        Public Overridable Sub CopyFrom(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            End If
            If (dict.Contains("pCodigoVendedor") = true) Then
                Me.pCodigoVendedor = CType(ConvertUtilities.ChangeType(dict("pCodigoVendedor"), GetType(String), CType(Nothing, String)),String)
            End If
            If (dict.Contains("pCodigoVendedorVinculado") = true) Then
                Me.pCodigoVendedorVinculado = CType(ConvertUtilities.ChangeType(dict("pCodigoVendedorVinculado"), GetType(String), CType(Nothing, String)),String)
            End If
        ...
        Public Overloads Overridable Sub CopyTo(ByVal usuario As S5T.Usuario, ByVal deep As Boolean)
            ...
            usuario.pCodigoSubVendedor = Me.pCodigoSubVendedor
            usuario.xLoginReg = Me.xLoginReg
            usuario.pCodigoVendedor = Me.pCodigoVendedor
            usuario.pCodigoVendedorVinculado = Me.pCodigoVendedorVinculado
            usuario.pCodigoAprovador = Me.pCodigoAprovador
        ...
        Public Overloads Overridable Sub CopyTo(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            dict("pCodigoVendedor") = Me.pCodigoVendedor
            dict("pCodigoVendedorVinculado") = Me.pCodigoVendedorVinculado
