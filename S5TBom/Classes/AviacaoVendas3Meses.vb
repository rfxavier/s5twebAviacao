...
Namespace S5T
    ...
    Partial Public Class AviacaoVendas3Meses
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.AviacaoVendas3Meses), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.AviacaoVendas3Meses)
        ...
        Public Overloads Overridable Function Equals(ByVal aviacaoVendas3Meses As S5T.AviacaoVendas3Meses) As Boolean Implements System.IEquatable(Of S5T.AviacaoVendas3Meses).Equals
            If (aviacaoVendas3Meses Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(aviacaoVendas3Meses)
            End If
            Return (Me.pId.Equals(aviacaoVendas3Meses.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                aviacaoVendas3Meses = CType(obj,S5T.AviacaoVendas3Meses)
            Catch icex As System.InvalidCastException
                aviacaoVendas3Meses = Nothing
            End Try
            Return Me.Equals(aviacaoVendas3Meses)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(aviacaoVendas3Meses)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal aviacaoVendas3Meses As S5T.AviacaoVendas3Meses) As Integer Implements System.IComparable(Of S5T.AviacaoVendas3Meses).CompareTo
            If (aviacaoVendas3Meses Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoVendas3Meses")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(aviacaoVendas3Meses.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.AviacaoVendas3Meses.ExternalValidate", "Type 'S5T.AviacaoVendas3Meses' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendas3Meses", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.AviacaoVendas3Meses
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoVendas3Meses As S5T.AviacaoVendas3Meses = New S5T.AviacaoVendas3Meses()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendas3Meses", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    aviacaoVendas3Meses.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.AviacaoVendas3Meses
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoVendas3Meses As S5T.AviacaoVendas3Meses = New S5T.AviacaoVendas3Meses()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendas3Meses", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5T.AviacaoVendas3Meses.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendas3Meses", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal aviacaoVendas3Meses As S5T.AviacaoVendas3Meses) As Boolean
            If (aviacaoVendas3Meses Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal aviacaoVendas3Meses As S5T.AviacaoVendas3Meses) As Boolean
            Dim ret As Boolean = S5T.AviacaoVendas3Meses.Save(aviacaoVendas3Meses)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal aviacaoVendas3Meses As S5T.AviacaoVendas3Meses) As Boolean
            If (aviacaoVendas3Meses Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.AviacaoVendas3Meses
            ...
            aviacaoVendas3Meses = S5T.AviacaoVendas3Meses.Load(var)
            Return aviacaoVendas3Meses
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.AviacaoVendas3Meses
            Dim aviacaoVendas3Meses As S5T.AviacaoVendas3Meses = New S5T.AviacaoVendas3Meses()
            Me.CopyTo(aviacaoVendas3Meses, deep)
            Return aviacaoVendas3Meses
        End Function
        
        Public Overloads Function Clone() As S5T.AviacaoVendas3Meses
            Dim localClone As S5T.AviacaoVendas3Meses = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal aviacaoVendas3Meses As S5T.AviacaoVendas3Meses, ByVal deep As Boolean)
            If (aviacaoVendas3Meses Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoVendas3Meses")
            End If
            aviacaoVendas3Meses.pId = Me.pId
            aviacaoVendas3Meses.pVLR_COFINS = Me.pVLR_COFINS
            aviacaoVendas3Meses.pVLR_PIS = Me.pVLR_PIS
            aviacaoVendas3Meses.pVLR_SEM_ICMSST = Me.pVLR_SEM_ICMSST
            aviacaoVendas3Meses.pVLR_ICM = Me.pVLR_ICM
            aviacaoVendas3Meses.pIMPOSTO_TOTAL_NOTA = Me.pIMPOSTO_TOTAL_NOTA
            aviacaoVendas3Meses.pB1_QE = Me.pB1_QE
            aviacaoVendas3Meses.pPRECO_FORA_IMPOSTO = Me.pPRECO_FORA_IMPOSTO
            aviacaoVendas3Meses.pPRECO_FORA_IMPOSTO_UNIT = Me.pPRECO_FORA_IMPOSTO_UNIT
            aviacaoVendas3Meses.pPRECO_TABELA = Me.pPRECO_TABELA
            aviacaoVendas3Meses.pVLR_TOTAL_PRODUTO = Me.pVLR_TOTAL_PRODUTO
            aviacaoVendas3Meses.pDESCRICAO = Me.pDESCRICAO
            aviacaoVendas3Meses.pQUANTIDADE = Me.pQUANTIDADE
            aviacaoVendas3Meses.pVLR_BASE_ICM = Me.pVLR_BASE_ICM
            aviacaoVendas3Meses.pVLR_TOTAL_NOTA = Me.pVLR_TOTAL_NOTA
            aviacaoVendas3Meses.pPRECO_DE_VENDA = Me.pPRECO_DE_VENDA
            aviacaoVendas3Meses.pVLR_DESCONTO = Me.pVLR_DESCONTO
            aviacaoVendas3Meses.pB1_CONV = Me.pB1_CONV
            aviacaoVendas3Meses.pCUSTO_PROD_QTD = Me.pCUSTO_PROD_QTD
            aviacaoVendas3Meses.pNRO_PEDIDO_CLIENTE = Me.pNRO_PEDIDO_CLIENTE
            aviacaoVendas3Meses.pDESCON_FINAN = Me.pDESCON_FINAN
            aviacaoVendas3Meses.pCUSTO_PRODUTO = Me.pCUSTO_PRODUTO
            aviacaoVendas3Meses.pBAIRRO_CLIE = Me.pBAIRRO_CLIE
            aviacaoVendas3Meses.pULTIMA_COMPRA = Me.pULTIMA_COMPRA
            aviacaoVendas3Meses.pPEDIDO = Me.pPEDIDO
            aviacaoVendas3Meses.pENDERECO_CLI = Me.pENDERECO_CLI
            aviacaoVendas3Meses.pMARCA = Me.pMARCA
            aviacaoVendas3Meses.pGRUPO_CLIENTE = Me.pGRUPO_CLIENTE
            aviacaoVendas3Meses.pPLACA = Me.pPLACA
            aviacaoVendas3Meses.pCFOP = Me.pCFOP
            aviacaoVendas3Meses.pMES_ENTRADA = Me.pMES_ENTRADA
            aviacaoVendas3Meses.pANO_ENTRADA = Me.pANO_ENTRADA
            aviacaoVendas3Meses.pDT_ENTRADA = Me.pDT_ENTRADA
            aviacaoVendas3Meses.pDIA_ENTRADA = Me.pDIA_ENTRADA
            aviacaoVendas3Meses.pPERCENT_DESCONTO = Me.pPERCENT_DESCONTO
            aviacaoVendas3Meses.pPORCENT_COMISSAO = Me.pPORCENT_COMISSAO
            aviacaoVendas3Meses.pESTADO = Me.pESTADO
            aviacaoVendas3Meses.pREGIAO = Me.pREGIAO
            aviacaoVendas3Meses.pCIDADE_VENDEDOR = Me.pCIDADE_VENDEDOR
            aviacaoVendas3Meses.pVALOR_COMISSAO = Me.pVALOR_COMISSAO
            aviacaoVendas3Meses.pCODIGO_VENDEDOR = Me.pCODIGO_VENDEDOR
            aviacaoVendas3Meses.pNOME_VENDEDOR = Me.pNOME_VENDEDOR
            aviacaoVendas3Meses.pCLIENTE = Me.pCLIENTE
            aviacaoVendas3Meses.pFILIAL = Me.pFILIAL
            aviacaoVendas3Meses.pNUMERO_NF = Me.pNUMERO_NF
            aviacaoVendas3Meses.pSERIE = Me.pSERIE
            aviacaoVendas3Meses.pCIDADE_CLIENTE = Me.pCIDADE_CLIENTE
            aviacaoVendas3Meses.pCIDADE_CLIENTE_IBGE = Me.pCIDADE_CLIENTE_IBGE
            aviacaoVendas3Meses.pLOJA = Me.pLOJA
            aviacaoVendas3Meses.pNOME_CLIENTE = Me.pNOME_CLIENTE
            aviacaoVendas3Meses.pDATA_EMISSAO = Me.pDATA_EMISSAO
            aviacaoVendas3Meses.pGRUPO_PRODUTO = Me.pGRUPO_PRODUTO
            aviacaoVendas3Meses.pPESO_PRODUTO = Me.pPESO_PRODUTO
            aviacaoVendas3Meses.pNOME_REDESPACHO = Me.pNOME_REDESPACHO
            aviacaoVendas3Meses.pPRODUTO = Me.pPRODUTO
            aviacaoVendas3Meses.pPESO_TOTAL = Me.pPESO_TOTAL
            aviacaoVendas3Meses.pPESO_BRUTO = Me.pPESO_BRUTO
            aviacaoVendas3Meses.pQTD_P_CAIXA = Me.pQTD_P_CAIXA
            aviacaoVendas3Meses.pQTD_EM_CAIXA = Me.pQTD_EM_CAIXA
            aviacaoVendas3Meses.pMES_EXTENSO = Me.pMES_EXTENSO
            aviacaoVendas3Meses.pANO_EMISSAO = Me.pANO_EMISSAO
            aviacaoVendas3Meses.pDIA_EMISSAO = Me.pDIA_EMISSAO
            aviacaoVendas3Meses.pMES_EMISSAO = Me.pMES_EMISSAO
            aviacaoVendas3Meses.pNOME_TRANSP = Me.pNOME_TRANSP
            aviacaoVendas3Meses.pREDESPACHO = Me.pREDESPACHO
            aviacaoVendas3Meses.pTRIMESTRE = Me.pTRIMESTRE
            aviacaoVendas3Meses.pCODIGO_TRANSP = Me.pCODIGO_TRANSP
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, aviacaoVendas3Meses))
        End Sub
