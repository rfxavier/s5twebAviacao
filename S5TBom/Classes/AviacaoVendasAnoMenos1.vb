...
Namespace S5T
    ...
    Partial Public Class AviacaoVendasAnoMenos1
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.AviacaoVendasAnoMenos1), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.AviacaoVendasAnoMenos1)
        ...
        Public Overloads Overridable Function Equals(ByVal aviacaoVendasAnoMenos1 As S5T.AviacaoVendasAnoMenos1) As Boolean Implements System.IEquatable(Of S5T.AviacaoVendasAnoMenos1).Equals
            If (aviacaoVendasAnoMenos1 Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(aviacaoVendasAnoMenos1)
            End If
            Return (Me.pId.Equals(aviacaoVendasAnoMenos1.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                aviacaoVendasAnoMenos1 = CType(obj,S5T.AviacaoVendasAnoMenos1)
            Catch icex As System.InvalidCastException
                aviacaoVendasAnoMenos1 = Nothing
            End Try
            Return Me.Equals(aviacaoVendasAnoMenos1)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(aviacaoVendasAnoMenos1)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal aviacaoVendasAnoMenos1 As S5T.AviacaoVendasAnoMenos1) As Integer Implements System.IComparable(Of S5T.AviacaoVendasAnoMenos1).CompareTo
            If (aviacaoVendasAnoMenos1 Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoVendasAnoMenos1")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(aviacaoVendasAnoMenos1.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.AviacaoVendasAnoMenos1.ExternalValidate", "Type 'S5T.AviacaoVendasAnoMenos1' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAnoMenos1", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.AviacaoVendasAnoMenos1
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoVendasAnoMenos1 As S5T.AviacaoVendasAnoMenos1 = New S5T.AviacaoVendasAnoMenos1()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAnoMenos1", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    aviacaoVendasAnoMenos1.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.AviacaoVendasAnoMenos1
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoVendasAnoMenos1 As S5T.AviacaoVendasAnoMenos1 = New S5T.AviacaoVendasAnoMenos1()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAnoMenos1", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5T.AviacaoVendasAnoMenos1.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAnoMenos1", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal aviacaoVendasAnoMenos1 As S5T.AviacaoVendasAnoMenos1) As Boolean
            If (aviacaoVendasAnoMenos1 Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal aviacaoVendasAnoMenos1 As S5T.AviacaoVendasAnoMenos1) As Boolean
            Dim ret As Boolean = S5T.AviacaoVendasAnoMenos1.Save(aviacaoVendasAnoMenos1)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal aviacaoVendasAnoMenos1 As S5T.AviacaoVendasAnoMenos1) As Boolean
            If (aviacaoVendasAnoMenos1 Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.AviacaoVendasAnoMenos1
            ...
            aviacaoVendasAnoMenos1 = S5T.AviacaoVendasAnoMenos1.Load(var)
            Return aviacaoVendasAnoMenos1
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.AviacaoVendasAnoMenos1
            Dim aviacaoVendasAnoMenos1 As S5T.AviacaoVendasAnoMenos1 = New S5T.AviacaoVendasAnoMenos1()
            Me.CopyTo(aviacaoVendasAnoMenos1, deep)
            Return aviacaoVendasAnoMenos1
        End Function
        
        Public Overloads Function Clone() As S5T.AviacaoVendasAnoMenos1
            Dim localClone As S5T.AviacaoVendasAnoMenos1 = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal aviacaoVendasAnoMenos1 As S5T.AviacaoVendasAnoMenos1, ByVal deep As Boolean)
            If (aviacaoVendasAnoMenos1 Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoVendasAnoMenos1")
            End If
            aviacaoVendasAnoMenos1.pId = Me.pId
            aviacaoVendasAnoMenos1.pVLR_COFINS = Me.pVLR_COFINS
            aviacaoVendasAnoMenos1.pVLR_PIS = Me.pVLR_PIS
            aviacaoVendasAnoMenos1.pVLR_SEM_ICMSST = Me.pVLR_SEM_ICMSST
            aviacaoVendasAnoMenos1.pVLR_ICM = Me.pVLR_ICM
            aviacaoVendasAnoMenos1.pIMPOSTO_TOTAL_NOTA = Me.pIMPOSTO_TOTAL_NOTA
            aviacaoVendasAnoMenos1.pB1_QE = Me.pB1_QE
            aviacaoVendasAnoMenos1.pPRECO_FORA_IMPOSTO = Me.pPRECO_FORA_IMPOSTO
            aviacaoVendasAnoMenos1.pPRECO_FORA_IMPOSTO_UNIT = Me.pPRECO_FORA_IMPOSTO_UNIT
            aviacaoVendasAnoMenos1.pPRECO_TABELA = Me.pPRECO_TABELA
            aviacaoVendasAnoMenos1.pVLR_TOTAL_PRODUTO = Me.pVLR_TOTAL_PRODUTO
            aviacaoVendasAnoMenos1.pDESCRICAO = Me.pDESCRICAO
            aviacaoVendasAnoMenos1.pQUANTIDADE = Me.pQUANTIDADE
            aviacaoVendasAnoMenos1.pVLR_BASE_ICM = Me.pVLR_BASE_ICM
            aviacaoVendasAnoMenos1.pVLR_TOTAL_NOTA = Me.pVLR_TOTAL_NOTA
            aviacaoVendasAnoMenos1.pPRECO_DE_VENDA = Me.pPRECO_DE_VENDA
            aviacaoVendasAnoMenos1.pVLR_DESCONTO = Me.pVLR_DESCONTO
            aviacaoVendasAnoMenos1.pB1_CONV = Me.pB1_CONV
            aviacaoVendasAnoMenos1.pCUSTO_PROD_QTD = Me.pCUSTO_PROD_QTD
            aviacaoVendasAnoMenos1.pNRO_PEDIDO_CLIENTE = Me.pNRO_PEDIDO_CLIENTE
            aviacaoVendasAnoMenos1.pDESCON_FINAN = Me.pDESCON_FINAN
            aviacaoVendasAnoMenos1.pCUSTO_PRODUTO = Me.pCUSTO_PRODUTO
            aviacaoVendasAnoMenos1.pBAIRRO_CLIE = Me.pBAIRRO_CLIE
            aviacaoVendasAnoMenos1.pULTIMA_COMPRA = Me.pULTIMA_COMPRA
            aviacaoVendasAnoMenos1.pPEDIDO = Me.pPEDIDO
            aviacaoVendasAnoMenos1.pENDERECO_CLI = Me.pENDERECO_CLI
            aviacaoVendasAnoMenos1.pMARCA = Me.pMARCA
            aviacaoVendasAnoMenos1.pGRUPO_CLIENTE = Me.pGRUPO_CLIENTE
            aviacaoVendasAnoMenos1.pPLACA = Me.pPLACA
            aviacaoVendasAnoMenos1.pCFOP = Me.pCFOP
            aviacaoVendasAnoMenos1.pMES_ENTRADA = Me.pMES_ENTRADA
            aviacaoVendasAnoMenos1.pANO_ENTRADA = Me.pANO_ENTRADA
            aviacaoVendasAnoMenos1.pDT_ENTRADA = Me.pDT_ENTRADA
            aviacaoVendasAnoMenos1.pDIA_ENTRADA = Me.pDIA_ENTRADA
            aviacaoVendasAnoMenos1.pPERCENT_DESCONTO = Me.pPERCENT_DESCONTO
            aviacaoVendasAnoMenos1.pPORCENT_COMISSAO = Me.pPORCENT_COMISSAO
            aviacaoVendasAnoMenos1.pESTADO = Me.pESTADO
            aviacaoVendasAnoMenos1.pREGIAO = Me.pREGIAO
            aviacaoVendasAnoMenos1.pCIDADE_VENDEDOR = Me.pCIDADE_VENDEDOR
            aviacaoVendasAnoMenos1.pVALOR_COMISSAO = Me.pVALOR_COMISSAO
            aviacaoVendasAnoMenos1.pCODIGO_VENDEDOR = Me.pCODIGO_VENDEDOR
            aviacaoVendasAnoMenos1.pNOME_VENDEDOR = Me.pNOME_VENDEDOR
            aviacaoVendasAnoMenos1.pCLIENTE = Me.pCLIENTE
            aviacaoVendasAnoMenos1.pFILIAL = Me.pFILIAL
            aviacaoVendasAnoMenos1.pNUMERO_NF = Me.pNUMERO_NF
            aviacaoVendasAnoMenos1.pSERIE = Me.pSERIE
            aviacaoVendasAnoMenos1.pCIDADE_CLIENTE = Me.pCIDADE_CLIENTE
            aviacaoVendasAnoMenos1.pCIDADE_CLIENTE_IBGE = Me.pCIDADE_CLIENTE_IBGE
            aviacaoVendasAnoMenos1.pLOJA = Me.pLOJA
            aviacaoVendasAnoMenos1.pNOME_CLIENTE = Me.pNOME_CLIENTE
            aviacaoVendasAnoMenos1.pDATA_EMISSAO = Me.pDATA_EMISSAO
            aviacaoVendasAnoMenos1.pGRUPO_PRODUTO = Me.pGRUPO_PRODUTO
            aviacaoVendasAnoMenos1.pPESO_PRODUTO = Me.pPESO_PRODUTO
            aviacaoVendasAnoMenos1.pNOME_REDESPACHO = Me.pNOME_REDESPACHO
            aviacaoVendasAnoMenos1.pPRODUTO = Me.pPRODUTO
            aviacaoVendasAnoMenos1.pPESO_TOTAL = Me.pPESO_TOTAL
            aviacaoVendasAnoMenos1.pPESO_BRUTO = Me.pPESO_BRUTO
            aviacaoVendasAnoMenos1.pQTD_P_CAIXA = Me.pQTD_P_CAIXA
            aviacaoVendasAnoMenos1.pQTD_EM_CAIXA = Me.pQTD_EM_CAIXA
            aviacaoVendasAnoMenos1.pMES_EXTENSO = Me.pMES_EXTENSO
            aviacaoVendasAnoMenos1.pANO_EMISSAO = Me.pANO_EMISSAO
            aviacaoVendasAnoMenos1.pDIA_EMISSAO = Me.pDIA_EMISSAO
            aviacaoVendasAnoMenos1.pMES_EMISSAO = Me.pMES_EMISSAO
            aviacaoVendasAnoMenos1.pNOME_TRANSP = Me.pNOME_TRANSP
            aviacaoVendasAnoMenos1.pREDESPACHO = Me.pREDESPACHO
            aviacaoVendasAnoMenos1.pTRIMESTRE = Me.pTRIMESTRE
            aviacaoVendasAnoMenos1.pCODIGO_TRANSP = Me.pCODIGO_TRANSP
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, aviacaoVendasAnoMenos1))
        End Sub
