...
Namespace S5T
    ...
    Partial Public Class FracionamentoCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5T.Fracionamento), System.Collections.Generic.ICollection(Of S5T.Fracionamento), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5T.Fracionamento) = New System.Collections.Generic.List(Of S5T.Fracionamento)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5T.Fracionamento) = New System.Collections.Generic.Dictionary(Of Long, S5T.Fracionamento)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm1056295676 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.Fracionamento)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm1056295676 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.Fracionamento)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5T.Fracionamento)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5T.Fracionamento)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As S5T.Fracionamento Implements System.Collections.Generic.IList(Of S5T.Fracionamento).Item
            Get
                Return CType(Me.BaseList(index),S5T.Fracionamento)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5T.Fracionamento)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5T.Fracionamento
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5T.Fracionamento = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim fracionamento As S5T.Fracionamento = Me.TryGetValue(pId)
                    If (Not (fracionamento) Is Nothing) Then
                        Me.Remove(fracionamento)
                    End If
                    Return
                End If
                Dim existing As S5T.Fracionamento = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5T.Fracionamento).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5T.Fracionamento).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm1056295676.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm1056295676.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5T.Fracionamento, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal fracionamento As S5T.Fracionamento) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(fracionamento)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal fracionamento As S5T.Fracionamento) As Integer
            If (fracionamento Is Nothing) Then
                Throw New System.ArgumentNullException("fracionamento")
            End If
            If (fracionamento.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "fracionamento", "S5T.Fracionamento")
            End If
            Try 
                Me.BaseTable.Add(fracionamento.pId, fracionamento)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.FracionamentoCollection", fracionamento.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.FracionamentoCollection", fracionamento.pId), ae)
            End Try
            AddHandler fracionamento.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(fracionamento)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, fracionamento, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            ...
            If (fracionamento Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(fracionamento)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5T_Fracionamento__Add(ByVal fracionamento As S5T.Fracionamento) Implements System.Collections.Generic.ICollection(Of S5T.Fracionamento).Add
            Me.BaseAdd(fracionamento)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5T.Fracionamento
            Dim fracionamento As S5T.Fracionamento = S5T.Fracionamento.LoadByEntityKey(key)
            If ((Not (fracionamento) Is Nothing)  _
                        AndAlso (Me.Contains(fracionamento) = false)) Then
                Me.Add(fracionamento)
            End If
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5T.Fracionamento))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5T.Fracionamento, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5T.Fracionamento).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5T.Fracionamento, ByVal index As Integer)
        ...
        Public Function Contains(ByVal fracionamento As S5T.Fracionamento) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.Fracionamento).Contains
            Dim localContains As Boolean = Me.BaseContains(fracionamento)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal fracionamento As S5T.Fracionamento) As Boolean
            If (fracionamento Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(fracionamento.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            ...
            Catch icex As System.InvalidCastException
                fracionamento = Nothing
            End Try
            Return Me.Contains(fracionamento)
        End Function
        
        Public Function IndexOf(ByVal fracionamento As S5T.Fracionamento) As Integer Implements System.Collections.Generic.IList(Of S5T.Fracionamento).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(fracionamento)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal fracionamento As S5T.Fracionamento) As Integer
            If (fracionamento Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(fracionamento)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                fracionamento = Nothing
            End Try
            Return Me.IndexOf(fracionamento)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal fracionamento As S5T.Fracionamento) Implements System.Collections.Generic.IList(Of S5T.Fracionamento).Insert
            Me.BaseInsert(index, fracionamento)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal fracionamento As S5T.Fracionamento)
            If (fracionamento Is Nothing) Then
                Throw New System.ArgumentNullException("fracionamento")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.FracionamentoCollection", fracionamento.pId), ae)
            End Try
            Me.BaseList.Insert(index, fracionamento)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, fracionamento, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                fracionamento = Nothing
            End Try
            Me.Insert(index, fracionamento)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5T.Fracionamento).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim Fracionamento As S5T.Fracionamento = Me(0)
                Me.BaseRemove(Fracionamento)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal fracionamento As S5T.Fracionamento) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.Fracionamento).Remove
            Return Me.BaseRemove(fracionamento)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal fracionamento As S5T.Fracionamento) As Boolean
            If (fracionamento Is Nothing) Then
                Throw New System.ArgumentNullException("fracionamento")
            End If
            Dim index As Integer = Me.IndexOf(fracionamento)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.Fracionamento).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(fracionamento)
            RemoveHandler fracionamento.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(fracionamento.pId)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, fracionamento, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5T.Fracionamento).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.Fracionamento).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim fracionamento As S5T.Fracionamento = Me.BaseList(index)
            If (Not (fracionamento) Is Nothing) Then
                RemoveHandler fracionamento.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(fracionamento.pId)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5T.Fracionamento) Implements System.Collections.Generic.IEnumerable(Of S5T.Fracionamento).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5T.Fracionamento) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5T.Fracionamento
            Dim fracionamento As S5T.Fracionamento = Nothing
            If (Me.BaseTable.TryGetValue(key, fracionamento) = true) Then
                Return fracionamento
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim fracionamento As S5T.Fracionamento = Me(index)
                fracionamento.Save
                If (fracionamento.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(fracionamento)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    ...
                    CType(fracionamento,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(fracionamento) = false) Then
                        Me.BaseAdd(fracionamento)
                        count = (count + 1)
                    End If
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5T.FracionamentoCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5T.FracionamentoCollection = New S5T.FracionamentoCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.FracionamentoCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5T.FracionamentoCollection
            Dim ret As S5T.FracionamentoCollection = S5T.FracionamentoCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "Fracionamento", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.FracionamentoCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5T.FracionamentoCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5T.Fracionamento)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5T.Fracionamento) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5T.Fracionamento))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5T.FracionamentoCollection
            Dim ret As S5T.FracionamentoCollection = New S5T.FracionamentoCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm1056295676.AddIndex([property])
        End Sub
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm1056295676.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm1056295676.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5T.Fracionamento))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5T.Fracionamento = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.FracionamentoCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.FracionamentoCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5T.FracionamentoCollection
            Return S5T.FracionamentoCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal fracionamento As S5T.Fracionamento) As Boolean
            If (fracionamento Is Nothing) Then
                Return false
            End If
        ...
        Public Overloads Shared Function Insert(ByVal fracionamento As S5T.Fracionamento) As Boolean
            Dim ret As Boolean = S5T.Fracionamento.Save(fracionamento)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal fracionamento As S5T.Fracionamento) As Boolean
            If (fracionamento Is Nothing) Then
                Return false
            End If
