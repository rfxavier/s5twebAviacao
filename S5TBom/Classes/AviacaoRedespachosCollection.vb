...
Namespace S5T
    ...
    Partial Public Class AviacaoRedespachosCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5T.AviacaoRedespachos), System.Collections.Generic.ICollection(Of S5T.AviacaoRedespachos), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5T.AviacaoRedespachos) = New System.Collections.Generic.List(Of S5T.AviacaoRedespachos)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5T.AviacaoRedespachos) = New System.Collections.Generic.Dictionary(Of Long, S5T.AviacaoRedespachos)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm601723150 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.AviacaoRedespachos)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm601723150 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.AviacaoRedespachos)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5T.AviacaoRedespachos)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5T.AviacaoRedespachos)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As S5T.AviacaoRedespachos Implements System.Collections.Generic.IList(Of S5T.AviacaoRedespachos).Item
            Get
                Return CType(Me.BaseList(index),S5T.AviacaoRedespachos)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5T.AviacaoRedespachos)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5T.AviacaoRedespachos
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5T.AviacaoRedespachos = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim aviacaoRedespachos As S5T.AviacaoRedespachos = Me.TryGetValue(pId)
                    If (Not (aviacaoRedespachos) Is Nothing) Then
                        Me.Remove(aviacaoRedespachos)
                    End If
                    Return
                End If
                Dim existing As S5T.AviacaoRedespachos = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5T.AviacaoRedespachos).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5T.AviacaoRedespachos).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm601723150.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm601723150.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5T.AviacaoRedespachos, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal aviacaoRedespachos As S5T.AviacaoRedespachos) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(aviacaoRedespachos)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal aviacaoRedespachos As S5T.AviacaoRedespachos) As Integer
            If (aviacaoRedespachos Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoRedespachos")
            End If
            If (aviacaoRedespachos.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "aviacaoRedespachos", "S5T.AviacaoRedespachos")
            End If
            Try 
                Me.BaseTable.Add(aviacaoRedespachos.pId, aviacaoRedespachos)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.AviacaoRedespachosCollection", aviacaoRedespachos.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.AviacaoRedespachosCollection", aviacaoRedespachos.pId), ae)
            End Try
            AddHandler aviacaoRedespachos.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(aviacaoRedespachos)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, aviacaoRedespachos, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            Dim aviacaoRedespachos As S5T.AviacaoRedespachos = Nothing
            Try 
                aviacaoRedespachos = CType(value,S5T.AviacaoRedespachos)
            Catch icex As System.InvalidCastException
                aviacaoRedespachos = Nothing
            ...
            If (aviacaoRedespachos Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(aviacaoRedespachos)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5T_AviacaoRedespachos__Add(ByVal aviacaoRedespachos As S5T.AviacaoRedespachos) Implements System.Collections.Generic.ICollection(Of S5T.AviacaoRedespachos).Add
            Me.BaseAdd(aviacaoRedespachos)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5T.AviacaoRedespachos
            Dim aviacaoRedespachos As S5T.AviacaoRedespachos = S5T.AviacaoRedespachos.LoadByEntityKey(key)
            If ((Not (aviacaoRedespachos) Is Nothing)  _
                        AndAlso (Me.Contains(aviacaoRedespachos) = false)) Then
                Me.Add(aviacaoRedespachos)
            End If
            Return aviacaoRedespachos
        End Function
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5T.AviacaoRedespachos))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5T.AviacaoRedespachos, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5T.AviacaoRedespachos).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5T.AviacaoRedespachos, ByVal index As Integer)
        ...
        Public Function Contains(ByVal aviacaoRedespachos As S5T.AviacaoRedespachos) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.AviacaoRedespachos).Contains
            Dim localContains As Boolean = Me.BaseContains(aviacaoRedespachos)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal aviacaoRedespachos As S5T.AviacaoRedespachos) As Boolean
            If (aviacaoRedespachos Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(aviacaoRedespachos.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            Dim aviacaoRedespachos As S5T.AviacaoRedespachos
            Try 
                aviacaoRedespachos = CType(value,S5T.AviacaoRedespachos)
            Catch icex As System.InvalidCastException
                aviacaoRedespachos = Nothing
            End Try
            Return Me.Contains(aviacaoRedespachos)
        End Function
        
        Public Function IndexOf(ByVal aviacaoRedespachos As S5T.AviacaoRedespachos) As Integer Implements System.Collections.Generic.IList(Of S5T.AviacaoRedespachos).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(aviacaoRedespachos)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal aviacaoRedespachos As S5T.AviacaoRedespachos) As Integer
            If (aviacaoRedespachos Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(aviacaoRedespachos)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                aviacaoRedespachos = Nothing
            End Try
            Return Me.IndexOf(aviacaoRedespachos)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal aviacaoRedespachos As S5T.AviacaoRedespachos) Implements System.Collections.Generic.IList(Of S5T.AviacaoRedespachos).Insert
            Me.BaseInsert(index, aviacaoRedespachos)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal aviacaoRedespachos As S5T.AviacaoRedespachos)
            If (aviacaoRedespachos Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoRedespachos")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.AviacaoRedespachosCollection", aviacaoRedespachos.pId), ae)
            End Try
            Me.BaseList.Insert(index, aviacaoRedespachos)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, aviacaoRedespachos, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                aviacaoRedespachos = Nothing
            End Try
            Me.Insert(index, aviacaoRedespachos)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5T.AviacaoRedespachos).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim AviacaoRedespachos As S5T.AviacaoRedespachos = Me(0)
                Me.BaseRemove(AviacaoRedespachos)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal aviacaoRedespachos As S5T.AviacaoRedespachos) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.AviacaoRedespachos).Remove
            Return Me.BaseRemove(aviacaoRedespachos)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal aviacaoRedespachos As S5T.AviacaoRedespachos) As Boolean
            If (aviacaoRedespachos Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoRedespachos")
            End If
            Dim index As Integer = Me.IndexOf(aviacaoRedespachos)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.AviacaoRedespachos).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(aviacaoRedespachos)
            RemoveHandler aviacaoRedespachos.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(aviacaoRedespachos.pId)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, aviacaoRedespachos, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5T.AviacaoRedespachos).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.AviacaoRedespachos).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim aviacaoRedespachos As S5T.AviacaoRedespachos = Me.BaseList(index)
            If (Not (aviacaoRedespachos) Is Nothing) Then
                RemoveHandler aviacaoRedespachos.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(aviacaoRedespachos.pId)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5T.AviacaoRedespachos) Implements System.Collections.Generic.IEnumerable(Of S5T.AviacaoRedespachos).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5T.AviacaoRedespachos) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5T.AviacaoRedespachos
            Dim aviacaoRedespachos As S5T.AviacaoRedespachos = Nothing
            If (Me.BaseTable.TryGetValue(key, aviacaoRedespachos) = true) Then
                Return aviacaoRedespachos
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim aviacaoRedespachos As S5T.AviacaoRedespachos = Me(index)
                aviacaoRedespachos.Save
                If (aviacaoRedespachos.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(aviacaoRedespachos)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    Dim aviacaoRedespachos As S5T.AviacaoRedespachos = New S5T.AviacaoRedespachos()
                    CType(aviacaoRedespachos,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(aviacaoRedespachos) = false) Then
                        Me.BaseAdd(aviacaoRedespachos)
                        count = (count + 1)
                    End If
                    aviacaoRedespachos.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Unchanged
                End If
                readerRead = reader.Read
            Loop
        End Sub
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5T.AviacaoRedespachosCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5T.AviacaoRedespachosCollection = New S5T.AviacaoRedespachosCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.AviacaoRedespachosCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5T.AviacaoRedespachosCollection
            Dim ret As S5T.AviacaoRedespachosCollection = S5T.AviacaoRedespachosCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoRedespachos", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.AviacaoRedespachosCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5T.AviacaoRedespachosCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5T.AviacaoRedespachos)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5T.AviacaoRedespachos) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5T.AviacaoRedespachos))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5T.AviacaoRedespachosCollection
            Dim ret As S5T.AviacaoRedespachosCollection = New S5T.AviacaoRedespachosCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm601723150.AddIndex([property])
        End Sub
        ...
        Private Function AddNew() As Object Implements System.ComponentModel.IBindingList.AddNew
            Dim add As S5T.AviacaoRedespachos = New S5T.AviacaoRedespachos()
            Dim e As System.ComponentModel.AddingNewEventArgs = New System.ComponentModel.AddingNewEventArgs(add)
            Me.OnAddingNew(e)
            add = CType(e.NewObject,S5T.AviacaoRedespachos)
            If (add Is Nothing) Then
                add = New S5T.AviacaoRedespachos()
            End If
            add.pId = 0
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm601723150.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm601723150.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5T.AviacaoRedespachos))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5T.AviacaoRedespachos = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.AviacaoRedespachosCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.AviacaoRedespachosCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5T.AviacaoRedespachosCollection
            Return S5T.AviacaoRedespachosCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal aviacaoRedespachos As S5T.AviacaoRedespachos) As Boolean
            If (aviacaoRedespachos Is Nothing) Then
                Return false
            End If
            Dim ret As Boolean = aviacaoRedespachos.Save
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Shared Function Insert(ByVal aviacaoRedespachos As S5T.AviacaoRedespachos) As Boolean
            Dim ret As Boolean = S5T.AviacaoRedespachos.Save(aviacaoRedespachos)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal aviacaoRedespachos As S5T.AviacaoRedespachos) As Boolean
            If (aviacaoRedespachos Is Nothing) Then
                Return false
            End If
            Dim ret As Boolean = aviacaoRedespachos.Delete
            Return ret
        End Function
    End Class
End Namespace
