...
Namespace S5T
    ...
    Partial Public Class ProdutoCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5T.Produto), System.Collections.Generic.ICollection(Of S5T.Produto), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5T.Produto) = New System.Collections.Generic.List(Of S5T.Produto)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5T.Produto) = New System.Collections.Generic.Dictionary(Of Long, S5T.Produto)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm1835099578 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.Produto)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm1835099578 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.Produto)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5T.Produto)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5T.Produto)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As S5T.Produto Implements System.Collections.Generic.IList(Of S5T.Produto).Item
            Get
                Return CType(Me.BaseList(index),S5T.Produto)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5T.Produto)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5T.Produto
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5T.Produto = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim produto As S5T.Produto = Me.TryGetValue(pId)
                    If (Not (produto) Is Nothing) Then
                        Me.Remove(produto)
                    End If
                    Return
                End If
                Dim existing As S5T.Produto = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5T.Produto).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5T.Produto).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm1835099578.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm1835099578.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5T.Produto, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal produto As S5T.Produto) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(produto)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal produto As S5T.Produto) As Integer
            If (produto Is Nothing) Then
                Throw New System.ArgumentNullException("produto")
            End If
            If (produto.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "produto", "S5T.Produto")
            End If
            Try 
                Me.BaseTable.Add(produto.pId, produto)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.ProdutoCollection", produto.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.ProdutoCollection", produto.pId), ae)
            End Try
            AddHandler produto.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(produto)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, produto, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            ...
            If (produto Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(produto)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5T_Produto__Add(ByVal produto As S5T.Produto) Implements System.Collections.Generic.ICollection(Of S5T.Produto).Add
            Me.BaseAdd(produto)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5T.Produto
            Dim produto As S5T.Produto = S5T.Produto.LoadByEntityKey(key)
            If ((Not (produto) Is Nothing)  _
                        AndAlso (Me.Contains(produto) = false)) Then
                Me.Add(produto)
            End If
            Return produto
        End Function
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5T.Produto))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5T.Produto, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5T.Produto).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5T.Produto, ByVal index As Integer)
        ...
        Public Function Contains(ByVal produto As S5T.Produto) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.Produto).Contains
            Dim localContains As Boolean = Me.BaseContains(produto)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal produto As S5T.Produto) As Boolean
            If (produto Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(produto.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            ...
            Catch icex As System.InvalidCastException
                produto = Nothing
            End Try
            Return Me.Contains(produto)
        End Function
        
        Public Function IndexOf(ByVal produto As S5T.Produto) As Integer Implements System.Collections.Generic.IList(Of S5T.Produto).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(produto)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal produto As S5T.Produto) As Integer
            If (produto Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(produto)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                produto = Nothing
            End Try
            Return Me.IndexOf(produto)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal produto As S5T.Produto) Implements System.Collections.Generic.IList(Of S5T.Produto).Insert
            Me.BaseInsert(index, produto)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal produto As S5T.Produto)
            If (produto Is Nothing) Then
                Throw New System.ArgumentNullException("produto")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.ProdutoCollection", produto.pId), ae)
            End Try
            Me.BaseList.Insert(index, produto)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, produto, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                produto = Nothing
            End Try
            Me.Insert(index, produto)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5T.Produto).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim Produto As S5T.Produto = Me(0)
                Me.BaseRemove(Produto)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal produto As S5T.Produto) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.Produto).Remove
            Return Me.BaseRemove(produto)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal produto As S5T.Produto) As Boolean
            If (produto Is Nothing) Then
                Throw New System.ArgumentNullException("produto")
            End If
            Dim index As Integer = Me.IndexOf(produto)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.Produto).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(produto)
            RemoveHandler produto.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(produto.pId)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, produto, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5T.Produto).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.Produto).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim produto As S5T.Produto = Me.BaseList(index)
            If (Not (produto) Is Nothing) Then
                RemoveHandler produto.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(produto.pId)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5T.Produto) Implements System.Collections.Generic.IEnumerable(Of S5T.Produto).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5T.Produto) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5T.Produto
            Dim produto As S5T.Produto = Nothing
            If (Me.BaseTable.TryGetValue(key, produto) = true) Then
                Return produto
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim produto As S5T.Produto = Me(index)
                produto.Save
                If (produto.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(produto)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    ...
                    CType(produto,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(produto) = false) Then
                        Me.BaseAdd(produto)
                        count = (count + 1)
                    End If
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5T.ProdutoCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5T.ProdutoCollection = New S5T.ProdutoCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.ProdutoCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5T.ProdutoCollection
            Dim ret As S5T.ProdutoCollection = S5T.ProdutoCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "Produto", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.ProdutoCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        
        Private Overloads Shared Sub LoadAllViewGrid(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader, ByVal list As System.Collections.Generic.List(Of S5T.ProdutoViewGrid))
            If (reader Is Nothing) Then
                Throw New System.ArgumentNullException("reader")
            End If
            If (pageIndex < 0) Then
            ...
            Do While ((readerRead = true)  _
                ...
                readCount = (readCount + 1)
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    Dim produtoViewGrid As S5T.ProdutoViewGrid = New S5T.ProdutoViewGrid()
                    CodeFluent.Runtime.CodeFluentLightWeightPersistence.ReadRecord(reader, CType(produtoViewGrid,CodeFluent.Runtime.ICodeFluentLightEntity), Nothing)
                    list.Add(produtoViewGrid)
                    count = (count + 1)
                End If
                readerRead = reader.Read
            Loop
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAllViewGrid(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Collections.Generic.List(Of S5T.ProdutoViewGrid)
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As System.Collections.Generic.List(Of S5T.ProdutoViewGrid) = New System.Collections.Generic.List(Of S5T.ProdutoViewGrid)()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.ProdutoCollection.PageDataLoadAllViewGrid(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
                S5T.ProdutoCollection.LoadAllViewGrid(pageIndex, pageSize, pageOptions, reader, ret)
            Finally
                If (Not (reader) Is Nothing) Then
                    reader.Dispose
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAllViewGrid() As System.Collections.Generic.List(Of S5T.ProdutoViewGrid)
            Dim ret As System.Collections.Generic.List(Of S5T.ProdutoViewGrid) = S5T.ProdutoCollection.PageLoadAllViewGrid(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAllViewGrid(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "Produto", "LoadAllViewGrid")
            If (Not (pageOptions) Is Nothing) Then
                Dim enumerator As System.Collections.IEnumerator = pageOptions.OrderByArguments.GetEnumerator
                Dim b As Boolean
                Dim index As Integer = 0
        ...
        Public Shared Function DataLoadAllViewGrid() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.ProdutoCollection.PageDataLoadAllViewGrid(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5T.ProdutoCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5T.Produto)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5T.Produto) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5T.Produto))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5T.ProdutoCollection
            Dim ret As S5T.ProdutoCollection = New S5T.ProdutoCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm1835099578.AddIndex([property])
        End Sub
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm1835099578.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm1835099578.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5T.Produto))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5T.Produto = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.ProdutoCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.ProdutoCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5T.ProdutoCollection
            Return S5T.ProdutoCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAllViewGrid(ByVal pageIndex As Integer, ByVal pageSize As Integer) As System.Collections.Generic.List(Of S5T.ProdutoViewGrid)
            Return S5T.ProdutoCollection.PageLoadAllViewGrid(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal produto As S5T.Produto) As Boolean
            If (produto Is Nothing) Then
                Return false
            End If
        ...
        Public Overloads Shared Function Insert(ByVal produto As S5T.Produto) As Boolean
            Dim ret As Boolean = S5T.Produto.Save(produto)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal produto As S5T.Produto) As Boolean
            If (produto Is Nothing) Then
                Return false
            End If
