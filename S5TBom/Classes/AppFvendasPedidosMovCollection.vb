...
Namespace S5T
    ...
    Partial Public Class AppFvendasPedidosMovCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5T.AppFvendasPedidosMov), System.Collections.Generic.ICollection(Of S5T.AppFvendasPedidosMov), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5T.AppFvendasPedidosMov) = New System.Collections.Generic.List(Of S5T.AppFvendasPedidosMov)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5T.AppFvendasPedidosMov) = New System.Collections.Generic.Dictionary(Of Long, S5T.AppFvendasPedidosMov)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm1596315294 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.AppFvendasPedidosMov)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm1596315294 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.AppFvendasPedidosMov)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5T.AppFvendasPedidosMov)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5T.AppFvendasPedidosMov)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As S5T.AppFvendasPedidosMov Implements System.Collections.Generic.IList(Of S5T.AppFvendasPedidosMov).Item
            Get
                Return CType(Me.BaseList(index),S5T.AppFvendasPedidosMov)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5T.AppFvendasPedidosMov)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5T.AppFvendasPedidosMov
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5T.AppFvendasPedidosMov = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim appFvendasPedidosMov As S5T.AppFvendasPedidosMov = Me.TryGetValue(pId)
                    If (Not (appFvendasPedidosMov) Is Nothing) Then
                        Me.Remove(appFvendasPedidosMov)
                    End If
                    Return
                End If
                Dim existing As S5T.AppFvendasPedidosMov = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5T.AppFvendasPedidosMov).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5T.AppFvendasPedidosMov).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm1596315294.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm1596315294.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5T.AppFvendasPedidosMov, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal appFvendasPedidosMov As S5T.AppFvendasPedidosMov) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(appFvendasPedidosMov)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal appFvendasPedidosMov As S5T.AppFvendasPedidosMov) As Integer
            If (appFvendasPedidosMov Is Nothing) Then
                Throw New System.ArgumentNullException("appFvendasPedidosMov")
            End If
            If (appFvendasPedidosMov.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "appFvendasPedidosMov", "S5T.AppFvendasPedidosMov")
            End If
            Try 
                Me.BaseTable.Add(appFvendasPedidosMov.pId, appFvendasPedidosMov)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.AppFvendasPedidosMovCollection", appFvendasPedidosMov.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.AppFvendasPedidosMovCollection", appFvendasPedidosMov.pId), ae)
            End Try
            AddHandler appFvendasPedidosMov.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(appFvendasPedidosMov)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, appFvendasPedidosMov, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            ...
            If (appFvendasPedidosMov Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(appFvendasPedidosMov)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5T_AppFvendasPedidosMov__Add(ByVal appFvendasPedidosMov As S5T.AppFvendasPedidosMov) Implements System.Collections.Generic.ICollection(Of S5T.AppFvendasPedidosMov).Add
            Me.BaseAdd(appFvendasPedidosMov)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5T.AppFvendasPedidosMov
            Dim appFvendasPedidosMov As S5T.AppFvendasPedidosMov = S5T.AppFvendasPedidosMov.LoadByEntityKey(key)
            If ((Not (appFvendasPedidosMov) Is Nothing)  _
                        AndAlso (Me.Contains(appFvendasPedidosMov) = false)) Then
                Me.Add(appFvendasPedidosMov)
            End If
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5T.AppFvendasPedidosMov))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5T.AppFvendasPedidosMov, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5T.AppFvendasPedidosMov).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5T.AppFvendasPedidosMov, ByVal index As Integer)
        ...
        Public Function Contains(ByVal appFvendasPedidosMov As S5T.AppFvendasPedidosMov) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.AppFvendasPedidosMov).Contains
            Dim localContains As Boolean = Me.BaseContains(appFvendasPedidosMov)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal appFvendasPedidosMov As S5T.AppFvendasPedidosMov) As Boolean
            If (appFvendasPedidosMov Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(appFvendasPedidosMov.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            ...
            Catch icex As System.InvalidCastException
                appFvendasPedidosMov = Nothing
            End Try
            Return Me.Contains(appFvendasPedidosMov)
        End Function
        
        Public Function IndexOf(ByVal appFvendasPedidosMov As S5T.AppFvendasPedidosMov) As Integer Implements System.Collections.Generic.IList(Of S5T.AppFvendasPedidosMov).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(appFvendasPedidosMov)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal appFvendasPedidosMov As S5T.AppFvendasPedidosMov) As Integer
            If (appFvendasPedidosMov Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(appFvendasPedidosMov)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                appFvendasPedidosMov = Nothing
            End Try
            Return Me.IndexOf(appFvendasPedidosMov)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal appFvendasPedidosMov As S5T.AppFvendasPedidosMov) Implements System.Collections.Generic.IList(Of S5T.AppFvendasPedidosMov).Insert
            Me.BaseInsert(index, appFvendasPedidosMov)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal appFvendasPedidosMov As S5T.AppFvendasPedidosMov)
            If (appFvendasPedidosMov Is Nothing) Then
                Throw New System.ArgumentNullException("appFvendasPedidosMov")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.AppFvendasPedidosMovCollection", appFvendasPedidosMov.pId), ae)
            End Try
            Me.BaseList.Insert(index, appFvendasPedidosMov)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, appFvendasPedidosMov, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                appFvendasPedidosMov = Nothing
            End Try
            Me.Insert(index, appFvendasPedidosMov)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5T.AppFvendasPedidosMov).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim AppFvendasPedidosMov As S5T.AppFvendasPedidosMov = Me(0)
                Me.BaseRemove(AppFvendasPedidosMov)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal appFvendasPedidosMov As S5T.AppFvendasPedidosMov) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.AppFvendasPedidosMov).Remove
            Return Me.BaseRemove(appFvendasPedidosMov)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal appFvendasPedidosMov As S5T.AppFvendasPedidosMov) As Boolean
            If (appFvendasPedidosMov Is Nothing) Then
                Throw New System.ArgumentNullException("appFvendasPedidosMov")
            End If
            Dim index As Integer = Me.IndexOf(appFvendasPedidosMov)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.AppFvendasPedidosMov).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(appFvendasPedidosMov)
            RemoveHandler appFvendasPedidosMov.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(appFvendasPedidosMov.pId)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, appFvendasPedidosMov, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5T.AppFvendasPedidosMov).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.AppFvendasPedidosMov).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim appFvendasPedidosMov As S5T.AppFvendasPedidosMov = Me.BaseList(index)
            If (Not (appFvendasPedidosMov) Is Nothing) Then
                RemoveHandler appFvendasPedidosMov.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(appFvendasPedidosMov.pId)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5T.AppFvendasPedidosMov) Implements System.Collections.Generic.IEnumerable(Of S5T.AppFvendasPedidosMov).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5T.AppFvendasPedidosMov) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5T.AppFvendasPedidosMov
            Dim appFvendasPedidosMov As S5T.AppFvendasPedidosMov = Nothing
            If (Me.BaseTable.TryGetValue(key, appFvendasPedidosMov) = true) Then
                Return appFvendasPedidosMov
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim appFvendasPedidosMov As S5T.AppFvendasPedidosMov = Me(index)
                appFvendasPedidosMov.Save
                If (appFvendasPedidosMov.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(appFvendasPedidosMov)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    ...
                    CType(appFvendasPedidosMov,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(appFvendasPedidosMov) = false) Then
                        Me.BaseAdd(appFvendasPedidosMov)
                        count = (count + 1)
                    End If
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5T.AppFvendasPedidosMovCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5T.AppFvendasPedidosMovCollection = New S5T.AppFvendasPedidosMovCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.AppFvendasPedidosMovCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5T.AppFvendasPedidosMovCollection
            Dim ret As S5T.AppFvendasPedidosMovCollection = S5T.AppFvendasPedidosMovCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AppFvendasPedidosMov", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.AppFvendasPedidosMovCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        
        Private Overloads Sub LoadByNumeroPedido(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader, ByVal parNumeroPedido As Long)
            If (reader Is Nothing) Then
                Throw New System.ArgumentNullException("reader")
            End If
            If (pageIndex < 0) Then
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadByNumeroPedido(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal parNumeroPedido As Long) As S5T.AppFvendasPedidosMovCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
            ...
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.AppFvendasPedidosMovCollection.PageDataLoadByNumeroPedido(pageOptions, parNumeroPedido)
                If (reader Is Nothing) Then
                    Return ret
                End If
                ret.LoadByNumeroPedido(pageIndex, pageSize, pageOptions, reader, parNumeroPedido)
            Finally
                If (Not (reader) Is Nothing) Then
                    reader.Dispose
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadByNumeroPedido(ByVal parNumeroPedido As Long) As S5T.AppFvendasPedidosMovCollection
            Dim ret As S5T.AppFvendasPedidosMovCollection = S5T.AppFvendasPedidosMovCollection.PageLoadByNumeroPedido(Integer.MinValue, Integer.MaxValue, Nothing, parNumeroPedido)
            Return ret
        End Function
        
        Public Shared Function PageDataLoadByNumeroPedido(ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal parNumeroPedido As Long) As System.Data.IDataReader
            If (parNumeroPedido = CodeFluentPersistence.DefaultInt64Value) Then
                Throw New System.ArgumentNullException("parNumeroPedido")
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AppFvendasPedidosMov", "LoadByNumeroPedido")
        ...
        Public Shared Function DataLoadByNumeroPedido(ByVal parNumeroPedido As Long) As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.AppFvendasPedidosMovCollection.PageDataLoadByNumeroPedido(Nothing, parNumeroPedido)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5T.AppFvendasPedidosMovCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5T.AppFvendasPedidosMov)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5T.AppFvendasPedidosMov) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5T.AppFvendasPedidosMov))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5T.AppFvendasPedidosMovCollection
            Dim ret As S5T.AppFvendasPedidosMovCollection = New S5T.AppFvendasPedidosMovCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm1596315294.AddIndex([property])
        End Sub
        ...
        Private Function AddNew() As Object Implements System.ComponentModel.IBindingList.AddNew
            Dim add As S5T.AppFvendasPedidosMov = New S5T.AppFvendasPedidosMov()
            Dim e As System.ComponentModel.AddingNewEventArgs = New System.ComponentModel.AddingNewEventArgs(add)
            Me.OnAddingNew(e)
            add = CType(e.NewObject,S5T.AppFvendasPedidosMov)
            If (add Is Nothing) Then
                add = New S5T.AppFvendasPedidosMov()
            End If
            add.pId = 0
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm1596315294.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm1596315294.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5T.AppFvendasPedidosMov))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5T.AppFvendasPedidosMov = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.AppFvendasPedidosMovCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.AppFvendasPedidosMovCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5T.AppFvendasPedidosMovCollection
            Return S5T.AppFvendasPedidosMovCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadByNumeroPedido(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal parNumeroPedido As Long) As S5T.AppFvendasPedidosMovCollection
            Return S5T.AppFvendasPedidosMovCollection.PageLoadByNumeroPedido(pageIndex, pageSize, Nothing, parNumeroPedido)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal appFvendasPedidosMov As S5T.AppFvendasPedidosMov) As Boolean
            If (appFvendasPedidosMov Is Nothing) Then
                Return false
            End If
        ...
        Public Overloads Shared Function Insert(ByVal appFvendasPedidosMov As S5T.AppFvendasPedidosMov) As Boolean
            Dim ret As Boolean = S5T.AppFvendasPedidosMov.Save(appFvendasPedidosMov)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal appFvendasPedidosMov As S5T.AppFvendasPedidosMov) As Boolean
            If (appFvendasPedidosMov Is Nothing) Then
                Return false
            End If
