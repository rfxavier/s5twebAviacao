...
Namespace S5T
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("CodeFluent Entities", "1.0.01234.05678"),  _
     ...
     System.Diagnostics.DebuggerDisplayAttribute("EK={EntityKey}, C2_PRODUTO={C2_PRODUTO}, pId={pId}"),  _
    ...
    Partial Public Class TaraFracionamento
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.TaraFracionamento), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.TaraFracionamento)
        ...
        Private _oEmbalagempId As Long = -1
        
        <System.NonSerializedAttribute()>  _
        Private _oEmbalagem As S5T.EmbalagemFracionamento = Nothing
        ...
        <System.Xml.Serialization.XmlElementAttribute(IsNullable:=false),  _
         System.ComponentModel.DataObjectFieldAttribute(true)>  _
        Public Property oEmbalagempId() As Long
            Get
                If ((Me._oEmbalagempId = -1)  _
                            AndAlso (Not (Me._oEmbalagem) Is Nothing)) Then
                    Me._oEmbalagempId = Me._oEmbalagem.pId
                End If
                Return Me._oEmbalagempId
            End Get
            Set
                If (System.Collections.Generic.EqualityComparer(Of Long).Default.Equals(value, Me.oEmbalagempId) = true) Then
                    Return
                End If
                Me._oEmbalagem = Nothing
                Me._oEmbalagempId = value
                Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("oEmbalagem"))
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("oEmbalagempId"))
            End Set
        End Property
        
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Public Property oEmbalagem() As S5T.EmbalagemFracionamento
            Get
                If (Me._oEmbalagem Is Nothing) Then
                    Me._oEmbalagem = S5T.EmbalagemFracionamento.Load(Me._oEmbalagempId)
                End If
                Return Me._oEmbalagem
            End Get
            Set
                Me._oEmbalagempId = -1
                Me._oEmbalagem = value
                Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Modified
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("oEmbalagem"))
                Me.OnPropertyChanged(New System.ComponentModel.PropertyChangedEventArgs("oEmbalagempId"))
            End Set
        ...
        Public Overloads Overridable Function Equals(ByVal taraFracionamento As S5T.TaraFracionamento) As Boolean Implements System.IEquatable(Of S5T.TaraFracionamento).Equals
            If (taraFracionamento Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(taraFracionamento)
            End If
            Return (Me.pId.Equals(taraFracionamento.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                taraFracionamento = CType(obj,S5T.TaraFracionamento)
            Catch icex As System.InvalidCastException
                taraFracionamento = Nothing
            End Try
            Return Me.Equals(taraFracionamento)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(taraFracionamento)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal taraFracionamento As S5T.TaraFracionamento) As Integer Implements System.IComparable(Of S5T.TaraFracionamento).CompareTo
            If (taraFracionamento Is Nothing) Then
                Throw New System.ArgumentNullException("taraFracionamento")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(taraFracionamento.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.TaraFracionamento.ExternalValidate", "Type 'S5T.TaraFracionamento' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "TaraFracionamento", "Delete")
        ...
        Protected Overridable Sub ReadRecord(ByVal reader As System.Data.IDataReader, ByVal options As CodeFluent.Runtime.CodeFluentReloadOptions)
            ...
            If (((options And CodeFluent.Runtime.CodeFluentReloadOptions.Properties)  _
                ...
                Me.oEmbalagempId = CodeFluentPersistence.GetReaderValue(reader, "oEmbalagem_pId", CType(-1,Long))
            End If
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.TaraFracionamento
            If (pId = -1) Then
                Return Nothing
            End If
            Dim taraFracionamento As S5T.TaraFracionamento = New S5T.TaraFracionamento()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "TaraFracionamento", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    taraFracionamento.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.TaraFracionamento
            If (pId = -1) Then
                Return Nothing
            End If
            Dim taraFracionamento As S5T.TaraFracionamento = New S5T.TaraFracionamento()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "TaraFracionamento", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5T.TaraFracionamento.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "TaraFracionamento", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
            ...
            persistence.AddParameter("@oEmbalagem_pId", Me.oEmbalagempId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal taraFracionamento As S5T.TaraFracionamento) As Boolean
            If (taraFracionamento Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal taraFracionamento As S5T.TaraFracionamento) As Boolean
            Dim ret As Boolean = S5T.TaraFracionamento.Save(taraFracionamento)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal taraFracionamento As S5T.TaraFracionamento) As Boolean
            If (taraFracionamento Is Nothing) Then
                Return false
            End If
        ...
        Protected Overridable Sub BaseTrace(ByVal writer As System.CodeDom.Compiler.IndentedTextWriter)
            ...
            writer.Write(",")
            writer.Write("oEmbalagem=")
            If (Not (Me._oEmbalagem) Is Nothing) Then
                CType(Me._oEmbalagem,CodeFluent.Runtime.ICodeFluentObject).Trace(writer)
            Else
                writer.Write("<null>")
            End If
            writer.Write(",")
            writer.Write("_oEmbalagempId=")
            writer.Write(Me._oEmbalagempId)
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.TaraFracionamento
            ...
            taraFracionamento = S5T.TaraFracionamento.Load(var)
            Return taraFracionamento
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.TaraFracionamento
            Dim taraFracionamento As S5T.TaraFracionamento = New S5T.TaraFracionamento()
            Me.CopyTo(taraFracionamento, deep)
            Return taraFracionamento
        End Function
        
        Public Overloads Function Clone() As S5T.TaraFracionamento
            Dim localClone As S5T.TaraFracionamento = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overridable Sub CopyFrom(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            End If
            If (dict.Contains("oEmbalagempId") = true) Then
                Me.oEmbalagempId = CType(ConvertUtilities.ChangeType(dict("oEmbalagempId"), GetType(Long), -1),Long)
            End If
        ...
        Public Overloads Overridable Sub CopyTo(ByVal taraFracionamento As S5T.TaraFracionamento, ByVal deep As Boolean)
            If (taraFracionamento Is Nothing) Then
                Throw New System.ArgumentNullException("taraFracionamento")
            End If
            taraFracionamento.pId = Me.pId
            taraFracionamento.G1_COMP = Me.G1_COMP
            taraFracionamento.C2_PRODUTO = Me.C2_PRODUTO
            taraFracionamento.oEmbalagempId = Me.oEmbalagempId
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, taraFracionamento))
        End Sub
        ...
        Public Overloads Overridable Sub CopyTo(ByVal dict As System.Collections.IDictionary, ByVal deep As Boolean)
            ...
            dict("oEmbalagempId") = Me.oEmbalagempId
