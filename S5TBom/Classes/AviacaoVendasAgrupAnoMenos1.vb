...
Namespace S5T
    ...
    Partial Public Class AviacaoVendasAgrupAnoMenos1
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.AviacaoVendasAgrupAnoMenos1), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.AviacaoVendasAgrupAnoMenos1)
        ...
        Public Overloads Overridable Function Equals(ByVal aviacaoVendasAgrupAnoMenos1 As S5T.AviacaoVendasAgrupAnoMenos1) As Boolean Implements System.IEquatable(Of S5T.AviacaoVendasAgrupAnoMenos1).Equals
            If (aviacaoVendasAgrupAnoMenos1 Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(aviacaoVendasAgrupAnoMenos1)
            End If
            Return (Me.pId.Equals(aviacaoVendasAgrupAnoMenos1.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                aviacaoVendasAgrupAnoMenos1 = CType(obj,S5T.AviacaoVendasAgrupAnoMenos1)
            Catch icex As System.InvalidCastException
                aviacaoVendasAgrupAnoMenos1 = Nothing
            End Try
            Return Me.Equals(aviacaoVendasAgrupAnoMenos1)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(aviacaoVendasAgrupAnoMenos1)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal aviacaoVendasAgrupAnoMenos1 As S5T.AviacaoVendasAgrupAnoMenos1) As Integer Implements System.IComparable(Of S5T.AviacaoVendasAgrupAnoMenos1).CompareTo
            If (aviacaoVendasAgrupAnoMenos1 Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoVendasAgrupAnoMenos1")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(aviacaoVendasAgrupAnoMenos1.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.AviacaoVendasAgrupAnoMenos1.ExternalValidate", "Type 'S5T.AviacaoVendasAgrupAnoMenos1' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAgrupAnoMenos1", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.AviacaoVendasAgrupAnoMenos1
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoVendasAgrupAnoMenos1 As S5T.AviacaoVendasAgrupAnoMenos1 = New S5T.AviacaoVendasAgrupAnoMenos1()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAgrupAnoMenos1", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    aviacaoVendasAgrupAnoMenos1.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.AviacaoVendasAgrupAnoMenos1
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoVendasAgrupAnoMenos1 As S5T.AviacaoVendasAgrupAnoMenos1 = New S5T.AviacaoVendasAgrupAnoMenos1()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAgrupAnoMenos1", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5T.AviacaoVendasAgrupAnoMenos1.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoVendasAgrupAnoMenos1", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal aviacaoVendasAgrupAnoMenos1 As S5T.AviacaoVendasAgrupAnoMenos1) As Boolean
            If (aviacaoVendasAgrupAnoMenos1 Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal aviacaoVendasAgrupAnoMenos1 As S5T.AviacaoVendasAgrupAnoMenos1) As Boolean
            Dim ret As Boolean = S5T.AviacaoVendasAgrupAnoMenos1.Save(aviacaoVendasAgrupAnoMenos1)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal aviacaoVendasAgrupAnoMenos1 As S5T.AviacaoVendasAgrupAnoMenos1) As Boolean
            If (aviacaoVendasAgrupAnoMenos1 Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.AviacaoVendasAgrupAnoMenos1
            ...
            aviacaoVendasAgrupAnoMenos1 = S5T.AviacaoVendasAgrupAnoMenos1.Load(var)
            Return aviacaoVendasAgrupAnoMenos1
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.AviacaoVendasAgrupAnoMenos1
            Dim aviacaoVendasAgrupAnoMenos1 As S5T.AviacaoVendasAgrupAnoMenos1 = New S5T.AviacaoVendasAgrupAnoMenos1()
            Me.CopyTo(aviacaoVendasAgrupAnoMenos1, deep)
            Return aviacaoVendasAgrupAnoMenos1
        End Function
        
        Public Overloads Function Clone() As S5T.AviacaoVendasAgrupAnoMenos1
            Dim localClone As S5T.AviacaoVendasAgrupAnoMenos1 = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal aviacaoVendasAgrupAnoMenos1 As S5T.AviacaoVendasAgrupAnoMenos1, ByVal deep As Boolean)
            If (aviacaoVendasAgrupAnoMenos1 Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoVendasAgrupAnoMenos1")
            End If
            aviacaoVendasAgrupAnoMenos1.pId = Me.pId
            aviacaoVendasAgrupAnoMenos1.pVLR_TOTAL_NOTA = Me.pVLR_TOTAL_NOTA
            aviacaoVendasAgrupAnoMenos1.pVLR_BASE_ICM = Me.pVLR_BASE_ICM
            aviacaoVendasAgrupAnoMenos1.pVLR_SEM_ICMSST = Me.pVLR_SEM_ICMSST
            aviacaoVendasAgrupAnoMenos1.pVLR_COFINS = Me.pVLR_COFINS
            aviacaoVendasAgrupAnoMenos1.pVLR_ICM = Me.pVLR_ICM
            aviacaoVendasAgrupAnoMenos1.pPRECO_TABELA = Me.pPRECO_TABELA
            aviacaoVendasAgrupAnoMenos1.pQUANTIDADE = Me.pQUANTIDADE
            aviacaoVendasAgrupAnoMenos1.pVLR_TOTAL_PRODUTO = Me.pVLR_TOTAL_PRODUTO
            aviacaoVendasAgrupAnoMenos1.pVLR_DESCONTO = Me.pVLR_DESCONTO
            aviacaoVendasAgrupAnoMenos1.pPRECO_DE_VENDA = Me.pPRECO_DE_VENDA
            aviacaoVendasAgrupAnoMenos1.pCUSTO_PRODUTO = Me.pCUSTO_PRODUTO
            aviacaoVendasAgrupAnoMenos1.pDESCON_FINAN = Me.pDESCON_FINAN
            aviacaoVendasAgrupAnoMenos1.pCUSTO_PROD_QTD = Me.pCUSTO_PROD_QTD
            aviacaoVendasAgrupAnoMenos1.pMES_EMISSAO = Me.pMES_EMISSAO
            aviacaoVendasAgrupAnoMenos1.pANO_EMISSAO = Me.pANO_EMISSAO
            aviacaoVendasAgrupAnoMenos1.pPRECO_FORA_IMPOSTO = Me.pPRECO_FORA_IMPOSTO
            aviacaoVendasAgrupAnoMenos1.pVLR_PIS = Me.pVLR_PIS
            aviacaoVendasAgrupAnoMenos1.pPRECO_FORA_IMPOSTO_UNIT = Me.pPRECO_FORA_IMPOSTO_UNIT
            aviacaoVendasAgrupAnoMenos1.pCFOP = Me.pCFOP
            aviacaoVendasAgrupAnoMenos1.pIMPOSTO_TOTAL_NOTA = Me.pIMPOSTO_TOTAL_NOTA
            aviacaoVendasAgrupAnoMenos1.pDESCRICAO = Me.pDESCRICAO
            aviacaoVendasAgrupAnoMenos1.pESTADO = Me.pESTADO
            aviacaoVendasAgrupAnoMenos1.pCIDADE_CLIENTE_IBGE = Me.pCIDADE_CLIENTE_IBGE
            aviacaoVendasAgrupAnoMenos1.pREGIAO = Me.pREGIAO
            aviacaoVendasAgrupAnoMenos1.pNOME_VENDEDOR = Me.pNOME_VENDEDOR
            aviacaoVendasAgrupAnoMenos1.pCODIGO_VENDEDOR = Me.pCODIGO_VENDEDOR
            aviacaoVendasAgrupAnoMenos1.pFILIAL = Me.pFILIAL
            aviacaoVendasAgrupAnoMenos1.pCLIENTE = Me.pCLIENTE
            aviacaoVendasAgrupAnoMenos1.pLOJA = Me.pLOJA
            aviacaoVendasAgrupAnoMenos1.pCIDADE_CLIENTE = Me.pCIDADE_CLIENTE
            aviacaoVendasAgrupAnoMenos1.pNOME_CLIENTE = Me.pNOME_CLIENTE
            aviacaoVendasAgrupAnoMenos1.pQTD_P_CAIXA = Me.pQTD_P_CAIXA
            aviacaoVendasAgrupAnoMenos1.pPESO_PRODUTO = Me.pPESO_PRODUTO
            aviacaoVendasAgrupAnoMenos1.pQTD_EM_CAIXA = Me.pQTD_EM_CAIXA
            aviacaoVendasAgrupAnoMenos1.pPESO_BRUTO = Me.pPESO_BRUTO
            aviacaoVendasAgrupAnoMenos1.pPESO_TOTAL = Me.pPESO_TOTAL
            aviacaoVendasAgrupAnoMenos1.pDATA_EMISSAO = Me.pDATA_EMISSAO
            aviacaoVendasAgrupAnoMenos1.pVALOR_COMISSAO = Me.pVALOR_COMISSAO
            aviacaoVendasAgrupAnoMenos1.pTRIMESTRE = Me.pTRIMESTRE
            aviacaoVendasAgrupAnoMenos1.pGRUPO_PRODUTO = Me.pGRUPO_PRODUTO
            aviacaoVendasAgrupAnoMenos1.pPRODUTO = Me.pPRODUTO
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, aviacaoVendasAgrupAnoMenos1))
        End Sub
