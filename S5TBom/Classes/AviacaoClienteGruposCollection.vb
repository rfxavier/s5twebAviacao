...
Namespace S5T
    ...
    Partial Public Class AviacaoClienteGruposCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of S5T.AviacaoClienteGrupos), System.Collections.Generic.ICollection(Of S5T.AviacaoClienteGrupos), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of S5T.AviacaoClienteGrupos) = New System.Collections.Generic.List(Of S5T.AviacaoClienteGrupos)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Long, S5T.AviacaoClienteGrupos) = New System.Collections.Generic.Dictionary(Of Long, S5T.AviacaoClienteGrupos)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm2282612659 As CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.AviacaoClienteGrupos)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm2282612659 = New CodeFluent.Runtime.Utilities.BindingListManager(Of S5T.AviacaoClienteGrupos)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of S5T.AviacaoClienteGrupos)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Long, S5T.AviacaoClienteGrupos)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As S5T.AviacaoClienteGrupos Implements System.Collections.Generic.IList(Of S5T.AviacaoClienteGrupos).Item
            Get
                Return CType(Me.BaseList(index),S5T.AviacaoClienteGrupos)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,S5T.AviacaoClienteGrupos)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal pId As Long) As S5T.AviacaoClienteGrupos
            Get
                If (pId = -1) Then
                    Throw New System.ArgumentNullException("pId")
                End If
                Dim i As S5T.AviacaoClienteGrupos = Me.TryGetValue(pId)
                Return i
            End Get
            Set
                If (pId = -1) Then
                ...
                If (value Is Nothing) Then
                    Dim aviacaoClienteGrupos As S5T.AviacaoClienteGrupos = Me.TryGetValue(pId)
                    If (Not (aviacaoClienteGrupos) Is Nothing) Then
                        Me.Remove(aviacaoClienteGrupos)
                    End If
                    Return
                End If
                Dim existing As S5T.AviacaoClienteGrupos = Me.TryGetValue(value.pId)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of S5T.AviacaoClienteGrupos).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of S5T.AviacaoClienteGrupos).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm2282612659.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm2282612659.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As S5T.AviacaoClienteGrupos, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal aviacaoClienteGrupos As S5T.AviacaoClienteGrupos) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(aviacaoClienteGrupos)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal aviacaoClienteGrupos As S5T.AviacaoClienteGrupos) As Integer
            If (aviacaoClienteGrupos Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoClienteGrupos")
            End If
            If (aviacaoClienteGrupos.pId = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "pId", "aviacaoClienteGrupos", "S5T.AviacaoClienteGrupos")
            End If
            Try 
                Me.BaseTable.Add(aviacaoClienteGrupos.pId, aviacaoClienteGrupos)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.AviacaoClienteGruposCollection", aviacaoClienteGrupos.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.AviacaoClienteGruposCollection", aviacaoClienteGrupos.pId), ae)
            End Try
            AddHandler aviacaoClienteGrupos.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(aviacaoClienteGrupos)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, aviacaoClienteGrupos, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            ...
            If (aviacaoClienteGrupos Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(aviacaoClienteGrupos)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_S5T_AviacaoClienteGrupos__Add(ByVal aviacaoClienteGrupos As S5T.AviacaoClienteGrupos) Implements System.Collections.Generic.ICollection(Of S5T.AviacaoClienteGrupos).Add
            Me.BaseAdd(aviacaoClienteGrupos)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As S5T.AviacaoClienteGrupos
            Dim aviacaoClienteGrupos As S5T.AviacaoClienteGrupos = S5T.AviacaoClienteGrupos.LoadByEntityKey(key)
            If ((Not (aviacaoClienteGrupos) Is Nothing)  _
                        AndAlso (Me.Contains(aviacaoClienteGrupos) = false)) Then
                Me.Add(aviacaoClienteGrupos)
            End If
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of S5T.AviacaoClienteGrupos))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As S5T.AviacaoClienteGrupos, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of S5T.AviacaoClienteGrupos).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As S5T.AviacaoClienteGrupos, ByVal index As Integer)
        ...
        Public Function Contains(ByVal aviacaoClienteGrupos As S5T.AviacaoClienteGrupos) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.AviacaoClienteGrupos).Contains
            Dim localContains As Boolean = Me.BaseContains(aviacaoClienteGrupos)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal aviacaoClienteGrupos As S5T.AviacaoClienteGrupos) As Boolean
            If (aviacaoClienteGrupos Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(aviacaoClienteGrupos.pId)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            ...
            Catch icex As System.InvalidCastException
                aviacaoClienteGrupos = Nothing
            End Try
            Return Me.Contains(aviacaoClienteGrupos)
        End Function
        
        Public Function IndexOf(ByVal aviacaoClienteGrupos As S5T.AviacaoClienteGrupos) As Integer Implements System.Collections.Generic.IList(Of S5T.AviacaoClienteGrupos).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(aviacaoClienteGrupos)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal aviacaoClienteGrupos As S5T.AviacaoClienteGrupos) As Integer
            If (aviacaoClienteGrupos Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(aviacaoClienteGrupos)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                aviacaoClienteGrupos = Nothing
            End Try
            Return Me.IndexOf(aviacaoClienteGrupos)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal aviacaoClienteGrupos As S5T.AviacaoClienteGrupos) Implements System.Collections.Generic.IList(Of S5T.AviacaoClienteGrupos).Insert
            Me.BaseInsert(index, aviacaoClienteGrupos)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal aviacaoClienteGrupos As S5T.AviacaoClienteGrupos)
            If (aviacaoClienteGrupos Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoClienteGrupos")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.AviacaoClienteGruposCollection", aviacaoClienteGrupos.pId), ae)
            End Try
            Me.BaseList.Insert(index, aviacaoClienteGrupos)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, aviacaoClienteGrupos, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                aviacaoClienteGrupos = Nothing
            End Try
            Me.Insert(index, aviacaoClienteGrupos)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of S5T.AviacaoClienteGrupos).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim AviacaoClienteGrupos As S5T.AviacaoClienteGrupos = Me(0)
                Me.BaseRemove(AviacaoClienteGrupos)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal aviacaoClienteGrupos As S5T.AviacaoClienteGrupos) As Boolean Implements System.Collections.Generic.ICollection(Of S5T.AviacaoClienteGrupos).Remove
            Return Me.BaseRemove(aviacaoClienteGrupos)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal aviacaoClienteGrupos As S5T.AviacaoClienteGrupos) As Boolean
            If (aviacaoClienteGrupos Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoClienteGrupos")
            End If
            Dim index As Integer = Me.IndexOf(aviacaoClienteGrupos)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.AviacaoClienteGrupos).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(aviacaoClienteGrupos)
            RemoveHandler aviacaoClienteGrupos.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(aviacaoClienteGrupos.pId)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, aviacaoClienteGrupos, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of S5T.AviacaoClienteGrupos).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of S5T.AviacaoClienteGrupos).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim aviacaoClienteGrupos As S5T.AviacaoClienteGrupos = Me.BaseList(index)
            If (Not (aviacaoClienteGrupos) Is Nothing) Then
                RemoveHandler aviacaoClienteGrupos.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(aviacaoClienteGrupos.pId)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of S5T.AviacaoClienteGrupos) Implements System.Collections.Generic.IEnumerable(Of S5T.AviacaoClienteGrupos).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of S5T.AviacaoClienteGrupos) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Long) As S5T.AviacaoClienteGrupos
            Dim aviacaoClienteGrupos As S5T.AviacaoClienteGrupos = Nothing
            If (Me.BaseTable.TryGetValue(key, aviacaoClienteGrupos) = true) Then
                Return aviacaoClienteGrupos
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim aviacaoClienteGrupos As S5T.AviacaoClienteGrupos = Me(index)
                aviacaoClienteGrupos.Save
                If (aviacaoClienteGrupos.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(aviacaoClienteGrupos)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    ...
                    CType(aviacaoClienteGrupos,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(aviacaoClienteGrupos) = false) Then
                        Me.BaseAdd(aviacaoClienteGrupos)
                        count = (count + 1)
                    End If
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As S5T.AviacaoClienteGruposCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As S5T.AviacaoClienteGruposCollection = New S5T.AviacaoClienteGruposCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = S5T.AviacaoClienteGruposCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As S5T.AviacaoClienteGruposCollection
            Dim ret As S5T.AviacaoClienteGruposCollection = S5T.AviacaoClienteGruposCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoClienteGrupos", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = S5T.AviacaoClienteGruposCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As S5T.AviacaoClienteGruposCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(S5T.AviacaoClienteGrupos)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of S5T.AviacaoClienteGrupos) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,S5T.AviacaoClienteGrupos))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As S5T.AviacaoClienteGruposCollection
            Dim ret As S5T.AviacaoClienteGruposCollection = New S5T.AviacaoClienteGruposCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm2282612659.AddIndex([property])
        End Sub
        ...
        Private Function AddNew() As Object Implements System.ComponentModel.IBindingList.AddNew
            Dim add As S5T.AviacaoClienteGrupos = New S5T.AviacaoClienteGrupos()
            Dim e As System.ComponentModel.AddingNewEventArgs = New System.ComponentModel.AddingNewEventArgs(add)
            Me.OnAddingNew(e)
            add = CType(e.NewObject,S5T.AviacaoClienteGrupos)
            If (add Is Nothing) Then
                add = New S5T.AviacaoClienteGrupos()
            End If
            add.pId = 0
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm2282612659.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm2282612659.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of S5T.AviacaoClienteGrupos))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Long))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As S5T.AviacaoClienteGrupos = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "S5T.AviacaoClienteGruposCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(S5T.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "S5T.AviacaoClienteGruposCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As S5T.AviacaoClienteGruposCollection
            Return S5T.AviacaoClienteGruposCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal aviacaoClienteGrupos As S5T.AviacaoClienteGrupos) As Boolean
            If (aviacaoClienteGrupos Is Nothing) Then
                Return false
            End If
        ...
        Public Overloads Shared Function Insert(ByVal aviacaoClienteGrupos As S5T.AviacaoClienteGrupos) As Boolean
            Dim ret As Boolean = S5T.AviacaoClienteGrupos.Save(aviacaoClienteGrupos)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal aviacaoClienteGrupos As S5T.AviacaoClienteGrupos) As Boolean
            If (aviacaoClienteGrupos Is Nothing) Then
                Return false
            End If
