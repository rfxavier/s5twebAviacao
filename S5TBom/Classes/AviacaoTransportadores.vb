...
Namespace S5T
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("CodeFluent Entities", "1.0.01234.05678"),  _
     ...
     System.Diagnostics.DebuggerDisplayAttribute("EK={EntityKey}, pCODIGO_TRANSP={pCODIGO_TRANSP}, pId={pId}"),  _
     System.ComponentModel.TypeConverterAttribute(GetType(CodeFluent.Runtime.Design.NameTypeConverter))>  _
    Partial Public Class AviacaoTransportadores
        Implements System.ICloneable, System.IComparable, System.IComparable(Of S5T.AviacaoTransportadores), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of Long), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of S5T.AviacaoTransportadores)
        ...
        Public Overloads Overridable Function Equals(ByVal aviacaoTransportadores As S5T.AviacaoTransportadores) As Boolean Implements System.IEquatable(Of S5T.AviacaoTransportadores).Equals
            If (aviacaoTransportadores Is Nothing) Then
                Return false
            End If
            If (Me.pId = -1) Then
                Return MyBase.Equals(aviacaoTransportadores)
            End If
            Return (Me.pId.Equals(aviacaoTransportadores.pId) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                aviacaoTransportadores = CType(obj,S5T.AviacaoTransportadores)
            Catch icex As System.InvalidCastException
                aviacaoTransportadores = Nothing
            End Try
            Return Me.Equals(aviacaoTransportadores)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(aviacaoTransportadores)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal aviacaoTransportadores As S5T.AviacaoTransportadores) As Integer Implements System.IComparable(Of S5T.AviacaoTransportadores).CompareTo
            If (aviacaoTransportadores Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoTransportadores")
            End If
            Dim localCompareTo As Integer = Me.pId.CompareTo(aviacaoTransportadores.pId)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = S5T.Resources.Manager.GetStringWithDefault(culture, "S5T.AviacaoTransportadores.ExternalValidate", "Type 'S5T.AviacaoTransportadores' cannot be validated.", Nothing)
                End If
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoTransportadores", "Delete")
        ...
        Public Shared Function Load(ByVal pId As Long) As S5T.AviacaoTransportadores
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoTransportadores As S5T.AviacaoTransportadores = New S5T.AviacaoTransportadores()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoTransportadores", "Load")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    aviacaoTransportadores.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadBypId(ByVal pId As Long) As S5T.AviacaoTransportadores
            If (pId = -1) Then
                Return Nothing
            End If
            Dim aviacaoTransportadores As S5T.AviacaoTransportadores = New S5T.AviacaoTransportadores()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoTransportadores", "LoadBypId")
            persistence.AddParameter("@pId", pId, CType(-1,Long))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            If (Me.EntityState = CodeFluent.Runtime.CodeFluentEntityState.ToBeDeleted) Then
                S5T.AviacaoTransportadores.Delete(Me)
                Return false
            End If
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(S5T.Constants.S5TStoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "AviacaoTransportadores", "Save")
            persistence.AddParameter("@pId", Me.pId, CType(-1,Long))
        ...
        Public Overloads Shared Function Save(ByVal aviacaoTransportadores As S5T.AviacaoTransportadores) As Boolean
            If (aviacaoTransportadores Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal aviacaoTransportadores As S5T.AviacaoTransportadores) As Boolean
            Dim ret As Boolean = S5T.AviacaoTransportadores.Save(aviacaoTransportadores)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal aviacaoTransportadores As S5T.AviacaoTransportadores) As Boolean
            If (aviacaoTransportadores Is Nothing) Then
                Return false
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As S5T.AviacaoTransportadores
            ...
            aviacaoTransportadores = S5T.AviacaoTransportadores.Load(var)
            Return aviacaoTransportadores
        End Function
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As S5T.AviacaoTransportadores
            Dim aviacaoTransportadores As S5T.AviacaoTransportadores = New S5T.AviacaoTransportadores()
            Me.CopyTo(aviacaoTransportadores, deep)
            Return aviacaoTransportadores
        End Function
        
        Public Overloads Function Clone() As S5T.AviacaoTransportadores
            Dim localClone As S5T.AviacaoTransportadores = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal aviacaoTransportadores As S5T.AviacaoTransportadores, ByVal deep As Boolean)
            If (aviacaoTransportadores Is Nothing) Then
                Throw New System.ArgumentNullException("aviacaoTransportadores")
            End If
            aviacaoTransportadores.pId = Me.pId
            aviacaoTransportadores.pNOME_TRANSP = Me.pNOME_TRANSP
            aviacaoTransportadores.pCODIGO_TRANSP = Me.pCODIGO_TRANSP
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, aviacaoTransportadores))
        End Sub
