<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.master" CodeBehind="pivotVendasAgrupAnoMenos1.aspx.vb" Inherits="AspNet5t.pivotVendasAgrupAnoMenos1" %>
...
<HideAdaptiveDetailButton ButtonType="Image"></HideAdaptiveDetailButton>
    ...
    <dx:ASPxPivotGrid ID="ASPxPivotGrid1" runat="server" ClientIDMode="AutoID" Theme="Moderno" EnableTheming="True" Width="100%" ClientInstanceName="pivotVendas"  oncustomcellvalue="ASPxPivotGrid1_CustomCellValue">
        <Fields>
            ...
            <dx:PivotGridField ID="fieldpNOMECLIENTE" Caption="Cliente" FieldName="pNOME_CLIENTE" AreaIndex="1" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldpCIDADECLIENTE" AreaIndex="2" Caption="Cidade Cliente" FieldName="pCIDADE_CLIENTE" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldpESTADO" AreaIndex="3" Caption="UF Cliente" FieldName="pESTADO">
            </dx:PivotGridField>
    ...
    <dx:LinqServerModeDataSource runat="server" ID="LinqServerModeDataSource1" ContextTypeName="AspNet5t.AviacaoVendasAgrupAnoMenos1BasedataclassDataContext" TableName="AviacaoVendasAgrupAnoMenos1s"></dx:LinqServerModeDataSource>
