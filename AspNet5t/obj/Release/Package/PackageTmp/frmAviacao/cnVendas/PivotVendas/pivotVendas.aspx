<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.master" CodeBehind="pivotVendas.aspx.vb" Inherits="AspNet5t.pivotVendas" %>
...
<ClientSideEvents Click="refreshGridAnalises"></ClientSideEvents>
                ...
                <td>
                    <dx:ASPxButton ID="ASPxButtonPreFiltro" runat="server" ToolTip="Pré-Filtro Pivot" UseSubmitBehavior="False" AutoPostBack="False">
                 ...
                 <td>
                    <dx:ASPxButton ID="ASPxButtonPreFiltroLink" runat="server" ToolTip="Pré-Filtro de Dados" UseSubmitBehavior="False" AutoPostBack="False">
                        <Image IconID="filter_filter_16x16">
                        </Image>
                    </dx:ASPxButton>
                </td>
    ...
    <!-- pop do filtro do Link -->
   <dx:ASPxPopupControl ID="ASPxPopupControl3" runat="server"  ClientInstanceName="pcFiltroLink" PopupElementID="ASPxButtonPreFiltroLink" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="Below" CssClass="popupresultado" HeaderText="Pré-filtro dos Dados">
        <HeaderStyle Font-Size="Larger" Font-Bold="True" />
        <ContentCollection>
            <dx:PopupControlContentControl runat="server"  >
                ...
                <dx:ASPxFormLayout ID="ASPxFormLayoutPesq" runat="server" ColCount="3" Width="100%">
                                <Items>
                                    ...
                                    <dx:TabbedLayoutGroup ColSpan="1" RowSpan="2" ClientInstanceName="tabbedGroupPageControlPesq" Width="100%" ShowGroupDecoration="False">
                                        ...
                                        <Items>
                                            <dx:LayoutGroup ColCount="2" Caption="" GroupBoxDecoration="None" Name="layoutPesq" VerticalAlign="Top" Width="100%" HorizontalAlign="Left" RowSpan="2">
                                                <Items>

                                                    <dx:LayoutItem Caption="Data Emissão - Período " ColSpan="1" VerticalAlign="Top" Width="18%">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxDateEdit runat="server" EditFormat="Date" Width="100%" Theme="Moderno" ID="mskDatEmissaoIniPesq">
                                                                </dx:ASPxDateEdit>
                                                                <dx:ASPxDateEdit runat="server" EditFormat="Date" Width="100%" Theme="Moderno" ID="mskDatEmissaoFinPesq">
                                                                </dx:ASPxDateEdit>
                                                     ...
                                                     <dx:LayoutItem Caption="" Width="15%">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                  <dx:ASPxButton ID="buttonAplicarFiltro" ClientInstanceName="buttonAplicarFiltro" runat="server" ToolTip="Aplicar Filtro" Text="Aplicar Filtro" />
                                                             </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                        <CaptionSettings HorizontalAlign="Left" VerticalAlign="Middle"></CaptionSettings>
                                                    </dx:LayoutItem>
...
<HideAdaptiveDetailButton ButtonType="Image"></HideAdaptiveDetailButton>
    ...
    <dx:ASPxPivotGrid ID="ASPxPivotGrid1" runat="server"  ClientIDMode="AutoID" Theme="Moderno" EnableTheming="True" Width="100%" ClientInstanceName="pivotVendas"  oncustomcellvalue="ASPxPivotGrid1_CustomCellValue" OnCustomFieldValueCells="pivotGrid_CustomFieldValueCells" >
        <Fields>
            ...
            <dx:PivotGridField ID="fieldpPESOTOTAL1" Caption="Peso Total" CellFormat-FormatString="{0:#,#0.00}" CellFormat-FormatType="Numeric" FieldName="pPESO_TOTAL" AreaIndex="6">
            </dx:PivotGridField>
            ...
            <dx:PivotGridField ID="fieldpVLRTOTALNOTA1" AreaIndex="7" Caption="Valor Total Nota" CellFormat-FormatString="{0:#,#0.00}" CellFormat-FormatType="Numeric" FieldName="pVLR_TOTAL_NOTA">
            </dx:PivotGridField>
            ...
            <dx:PivotGridField ID="fieldpDESCONFINAN1" Area="DataArea" Caption="Desc.Financ. %" CellFormat-FormatString="{0:#,#0.00}" CellFormat-FormatType="Numeric"  FieldName="pDESCON_FINAN" Visible="False">
            </dx:PivotGridField>
