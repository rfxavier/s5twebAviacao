Namespace Win_Dashboards
    Partial Public Class dashCnFinanceiroTitulosAbertoVendedor
        ''' <summary> 
...
#Region "Component Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Dim FormatConditionValue1 As DevExpress.DashboardCommon.FormatConditionValue = New DevExpress.DashboardCommon.FormatConditionValue()
            ...
            Dim FormatConditionValue2 As DevExpress.DashboardCommon.FormatConditionValue = New DevExpress.DashboardCommon.FormatConditionValue()
            ...
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(dashCnFinanceiroTitulosAbertoVendedor))
            ...
            'gridDashboardItem1
            '
            Dimension1.DataMember = "FILIAL"
            Dimension1.Name = "Filial"
            GridDimensionColumn1.Name = "Filial"
            GridDimensionColumn1.Weight = 63.656884875846494R
            GridDimensionColumn1.WidthType = DevExpress.DashboardCommon.GridColumnFixedWidthType.Weight
            GridDimensionColumn1.AddDataItem("Dimension", Dimension1)
            Dimension2.DataMember = "SERIE"
            Dimension2.Name = "Série"
            GridDimensionColumn2.Name = "Série"
            GridDimensionColumn2.Weight = 63.6568848758465R
            ...
            Dimension3.DataMember = "NOTA"
            Dimension3.Name = "Nota"
            GridDimensionColumn3.Name = "Nota"
            GridDimensionColumn3.Weight = 63.6568848758465R
            ...
            Dimension4.DataMember = "EMISSAO"
            Dimension4.DateTimeGroupInterval = DevExpress.DashboardCommon.DateTimeGroupInterval.DayMonthYear
            Dimension4.Name = "Emissão"
            GridDimensionColumn4.Name = "Emissão"
            GridDimensionColumn4.Weight = 63.656884875846494R
            ...
            Dimension5.DataMember = "VENCIMENTO"
            Dimension5.DateTimeGroupInterval = DevExpress.DashboardCommon.DateTimeGroupInterval.DayMonthYear
            Dimension5.Name = "Vencimento"
            GridDimensionColumn5.Name = "Vencimento"
            GridDimensionColumn5.Weight = 45.372460496613996R
            ...
            Dimension6.DataMember = "statusVENCIMENTOcalc"
            Dimension6.Name = "Status"
            GridDimensionColumn6.Name = "Status"
            GridDimensionColumn6.Weight = 68.397291196388267R
            ...
            Measure1.DataMember = "diasVENCIMENTOcalc"
            Measure1.Name = "Dias Atraso"
            ...
            GridMeasureColumn1.Name = "Dias Atraso"
            GridMeasureColumn1.Weight = 77.20090293453724R
            GridMeasureColumn1.WidthType = DevExpress.DashboardCommon.GridColumnFixedWidthType.Weight
            GridMeasureColumn1.AddDataItem("Measure", Measure1)
            Me.gridDashboardItem1.Columns.AddRange(New DevExpress.DashboardCommon.GridColumnBase() {GridDimensionColumn1, GridDimensionColumn2, GridDimensionColumn3, GridDimensionColumn4, GridDimensionColumn5, GridDimensionColumn6, GridMeasureColumn1})
            ...
            Me.gridDashboardItem1.DataItemRepository.Add(Dimension6, "DataItem2")
            ...
            Me.gridDashboardItem1.DataItemRepository.Add(Dimension2, "DataItem4")
            Me.gridDashboardItem1.DataItemRepository.Add(Dimension3, "DataItem5")
            Me.gridDashboardItem1.DataItemRepository.Add(Dimension4, "DataItem6")
            ...
            FormatConditionValue1.StyleSettings = IconSettings1
            FormatConditionValue1.Value1 = "Vencido"
            GridItemFormatRule1.Condition = FormatConditionValue1
            GridItemFormatRule1.DataItem = Dimension6
            ...
            Me.gridDashboardItem1.Name = "Títulos Detalhamento"
            Me.gridDashboardItem1.ShowCaption = True
            '
            'cardDashboardItem1
            '
            Measure2.DataMember = "VALOR"
            ...
            Dimension7.DataMember = "statusVENCIMENTOcalc"
            Dimension7.Name = "Status Vencimento"
            ...
            Me.cardDashboardItem1.DataMember = "Query"
            ...
            Me.cardDashboardItem1.Name = "Títulos por Status Vencimento"
            ...
            'gridDashboardItem2
            '
            Dimension8.DataMember = "NOME"
            Dimension8.Name = "Cliente"
            GridDimensionColumn7.Name = "Cliente"
            ...
            GridMeasureColumn2.Name = "Valor Total"
            ...
            Dimension9.DataMember = "statusVENCIMENTOcalc"
            Dimension9.Name = "Status Vencimento"
            GridDimensionColumn8.Name = "Status"
            ...
            Me.gridDashboardItem2.Columns.AddRange(New DevExpress.DashboardCommon.GridColumnBase() {GridDimensionColumn7, GridMeasureColumn2, GridDimensionColumn8})
            Me.gridDashboardItem2.ComponentName = "gridDashboardItem2"
            Me.gridDashboardItem2.DataItemRepository.Clear()
            Me.gridDashboardItem2.DataItemRepository.Add(Dimension8, "DataItem0")
            Me.gridDashboardItem2.DataItemRepository.Add(Measure3, "DataItem1")
            Me.gridDashboardItem2.DataItemRepository.Add(Dimension9, "DataItem2")
            Me.gridDashboardItem2.DataMember = "Query"
            Me.gridDashboardItem2.DataSource = Me.dashboardSqlDataSource1
            IconSettings2.IconType = DevExpress.DashboardCommon.FormatConditionIconType.IndicatorRedFlag
            FormatConditionValue2.StyleSettings = IconSettings2
            FormatConditionValue2.Value1 = "Vencido"
            GridItemFormatRule2.Condition = FormatConditionValue2
            GridItemFormatRule2.DataItem = Dimension9
            GridItemFormatRule2.Name = "FormatRule 2"
            Me.gridDashboardItem2.FormatRules.AddRange(New DevExpress.DashboardCommon.GridItemFormatRule() {GridItemFormatRule2})
            ...
            Me.gridDashboardItem2.Name = "Títulos por Cliente e Status Vencimento"
            Me.gridDashboardItem2.ShowCaption = True
            '
            'dashboardSqlDataSource1
            '
            CalculatedField1.DataMember = "Query"
            CalculatedField1.Expression = "Iif([VENCIMENTO] >= Today(), 'A Vencer', 'Vencido')"
            CalculatedField1.Name = "statusVENCIMENTOcalc"
            CalculatedField2.DataMember = "Query"
            CalculatedField2.DataType = DevExpress.DashboardCommon.CalculatedFieldType.[Integer]
            CalculatedField2.Expression = "Abs(Iif(DateDiffDay([VENCIMENTO], Today()) <= 0, 0, DateDiffDay([VENCIMENTO], Tod" & _
        "ay())))"
            CalculatedField2.Name = "diasVENCIMENTOcalc"
            ...
            QueryParameter1.Name = "parVendedorIni"
            QueryParameter1.Type = GetType(DevExpress.DataAccess.Expression)
            QueryParameter1.Value = New DevExpress.DataAccess.Expression("[Parameters.parDashVendedorIni]", GetType(String))
            QueryParameter2.Name = "parVendedorFim"
            QueryParameter2.Type = GetType(DevExpress.DataAccess.Expression)
            QueryParameter2.Value = New DevExpress.DataAccess.Expression("[Parameters.parDashVendedorFim]", GetType(String))
            ...
            Me.Items.AddRange(New DevExpress.DashboardCommon.DashboardItem() {Me.gridDashboardItem1, Me.cardDashboardItem1, Me.gridDashboardItem2})
            DashboardLayoutItem1.DashboardItem = Me.gridDashboardItem2
            DashboardLayoutItem1.Weight = 63.9572192513369R
            DashboardLayoutItem2.DashboardItem = Me.cardDashboardItem1
            DashboardLayoutItem2.Weight = 36.0427807486631R
            ...
            DashboardLayoutGroup2.Weight = 61.791590493601461R
            DashboardLayoutItem3.DashboardItem = Me.gridDashboardItem1
            DashboardLayoutItem3.Weight = 38.208409506398539R
            ...
            DashboardParameter1.Description = "Código Vendedor"
            DashboardParameter1.Name = "parDashVendedorIni"
            DashboardParameter1.Type = GetType(String)
            DashboardParameter1.Value = "001"
            DashboardParameter2.Description = "Código Final Vendedor"
            DashboardParameter2.Name = "parDashVendedorFim"
            DashboardParameter2.Type = GetType(String)
            DashboardParameter2.Value = "999"
