Namespace Win_Dashboards
    Partial Public Class dashCnProducaoProducaoPedidoSemDetalheCimaBaixoNeutro
        ''' <summary> 
...
#Region "Component Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(dashCnProducaoProducaoPedidoSemDetalheCimaBaixoNeutro))
            ...
            GridDimensionColumn1.Weight = 28.025851938895414R
            GridDimensionColumn1.WidthType = DevExpress.DashboardCommon.GridColumnFixedWidthType.Weight
            GridDimensionColumn1.AddDataItem("Dimension", Dimension1)
            Dimension2.DataMember = "C6_DESCRI"
            GridDimensionColumn2.Name = "Produto"
            GridDimensionColumn2.Weight = 116.86251468860162R
            ...
            GridMeasureColumn1.Weight = 65.569917743830786R
            ...
            GridMeasureColumn2.Weight = 74.030552291421841R
            ...
            GridMeasureColumn3.Weight = 77.732079905992933R
            ...
            GridMeasureColumn4.Weight = 87.779083431257334R
            ...
            Measure7.DataMember = "IndicadorStatus"
            ...
            Me.gridDashboardItem1.DataItemRepository.Add(Measure7, "DataItem8")
            Me.gridDashboardItem1.DataMember = "Query"
            Me.gridDashboardItem1.DataSource = Me.dashboardSqlDataSource1
            FormatConditionExpression1.Expression = "[DataItem8] = 'CIMA'"
            ...
            FormatConditionExpression2.Expression = "[DataItem8] = 'BAIXO'"
            ...
            FormatConditionValue1.StyleSettings = AppearanceSettings3
            FormatConditionValue1.Value1 = "NEUTRO"
            GridItemFormatRule3.Condition = FormatConditionValue1
            GridItemFormatRule3.DataItem = Measure7
            GridItemFormatRule3.DataItemApplyTo = Measure4
            GridItemFormatRule3.Name = "FormatRule 3"
            Me.gridDashboardItem1.FormatRules.AddRange(New DevExpress.DashboardCommon.GridItemFormatRule() {GridItemFormatRule1, GridItemFormatRule2, GridItemFormatRule3})
            Me.gridDashboardItem1.GridOptions.ColumnWidthMode = DevExpress.DashboardCommon.GridColumnWidthMode.Manual
            Me.gridDashboardItem1.HiddenMeasures.AddRange(New DevExpress.DashboardCommon.Measure() {Measure5, Measure6, Measure7})
            ...
            CalculatedField5.Expression = "Concat('Pedido:', [C5_NUM], ' - Emissão: ', Substring([C5_EMISSAO], 6, 2), '/', S" &
    "ubstring([C5_EMISSAO], 4, 2), '/', Substring([C5_EMISSAO], 0, 4))"
            ...
            CalculatedField7.Expression = "Iif([QtdePedidoConv] >= [QtdeEstoqueConv], 'BAIXO', 'CIMA')"
            CalculatedField7.Name = "IndicadorStatusCimaBaixo"
            CalculatedField8.DataMember = "Query"
            CalculatedField8.Expression = "Iif([QtdeEmpenhadaConv] > 0 And [QtdeEstoqueConv] + [QtdeEmpenhadaConv] - [QtdePe" &
    "didoConv] > 0 And [QtdePedidoConv] >= [QtdeEstoqueConv], 'NEUTRO', [IndicadorSta" &
    "tusCimaBaixo])"
            CalculatedField8.Name = "IndicadorStatus"
