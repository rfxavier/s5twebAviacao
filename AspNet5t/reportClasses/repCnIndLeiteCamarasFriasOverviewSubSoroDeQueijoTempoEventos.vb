Public Class repCnIndLeiteCamarasFriasOverviewSubSoroDeQueijoTempoEventos
...
#Region " Designer generated code "
    ...
    Friend WithEvents chart5TempDesnatacao As DevExpress.XtraReports.UI.XRChart
    ...
    Private Sub InitializeComponent()
        ...
        Me.chart5TempDesnatacao = New DevExpress.XtraReports.UI.XRChart()
        ...
        CType(Me.chart5TempDesnatacao,System.ComponentModel.ISupportInitialize).BeginInit
        ...
        'ReportHeader
        '
        Me.ReportHeader.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.chart5TempDesnatacao, Me.chart4TempPasteurizacao, Me.chart3Limpeza, Me.chart2Automatico, Me.chart1MaqLigada})
        Me.ReportHeader.HeightF = 846!
        Me.ReportHeader.Name = "ReportHeader"
        '
        'chart5TempDesnatacao
        '
        Me.chart5TempDesnatacao.BorderColor = System.Drawing.Color.Black
        Me.chart5TempDesnatacao.Borders = DevExpress.XtraPrinting.BorderSide.None
        Me.chart5TempDesnatacao.Legend.AlignmentHorizontal = DevExpress.XtraCharts.LegendAlignmentHorizontal.Center
        Me.chart5TempDesnatacao.Legend.AlignmentVertical = DevExpress.XtraCharts.LegendAlignmentVertical.TopOutside
        Me.chart5TempDesnatacao.Legend.Name = "Default Legend"
        Me.chart5TempDesnatacao.Legend.Visibility = DevExpress.Utils.DefaultBoolean.[True]
        Me.chart5TempDesnatacao.LocationFloat = New DevExpress.Utils.PointFloat(370.0001!, 564!)
        Me.chart5TempDesnatacao.Name = "chart5TempDesnatacao"
        Me.chart5TempDesnatacao.PaletteName = "GreenRedCustom"
        Me.chart5TempDesnatacao.PaletteRepository.Add("GreenRedCustom", New DevExpress.XtraCharts.Palette("GreenRedCustom", DevExpress.XtraCharts.PaletteScaleMode.Repeat, New DevExpress.XtraCharts.PaletteEntry() {New DevExpress.XtraCharts.PaletteEntry(System.Drawing.Color.FromArgb(CType(CType(0,Byte),Integer), CType(CType(179,Byte),Integer), CType(CType(0,Byte),Integer)), System.Drawing.Color.FromArgb(CType(CType(0,Byte),Integer), CType(CType(179,Byte),Integer), CType(CType(0,Byte),Integer))), New DevExpress.XtraCharts.PaletteEntry(System.Drawing.Color.Red, System.Drawing.Color.Red)}))
        Series1.ArgumentDataMember = "description"
        Series1.DataFilters.ClearAndAddRange(New DevExpress.XtraCharts.DataFilter() {New DevExpress.XtraCharts.XRDataFilter("tag", "System.String", DevExpress.XtraCharts.DataFilterCondition.Equal, "desnatacaofora")})
        ...
        Me.chart5TempDesnatacao.SeriesSerializable = New DevExpress.XtraCharts.Series() {Series1}
        Me.chart5TempDesnatacao.SeriesTemplate.View = PieSeriesView2
        Me.chart5TempDesnatacao.SizeF = New System.Drawing.SizeF(370!, 282!)
        ...
        ChartTitle1.Text = "Tempo Temperatura Desnatação"
        Me.chart5TempDesnatacao.Titles.AddRange(New DevExpress.XtraCharts.ChartTitle() {ChartTitle1})
        '
        ...
        Series2.DataFilters.ClearAndAddRange(New DevExpress.XtraCharts.DataFilter() {New DevExpress.XtraCharts.XRDataFilter("tag", "System.String", DevExpress.XtraCharts.DataFilterCondition.Equal, "pasteurizacaofora")})
        ...
        Me.chart4TempPasteurizacao.SeriesSerializable = New DevExpress.XtraCharts.Series() {Series2}
        Me.chart4TempPasteurizacao.SeriesTemplate.View = PieSeriesView4
        ...
        ChartTitle2.Text = "Tempo Temperatura Pasteurização"
        Me.chart4TempPasteurizacao.Titles.AddRange(New DevExpress.XtraCharts.ChartTitle() {ChartTitle2})
        '
        'chart3Limpeza
        '
        ...
        Series3.DataFilters.ClearAndAddRange(New DevExpress.XtraCharts.DataFilter() {New DevExpress.XtraCharts.XRDataFilter("tag", "System.String", DevExpress.XtraCharts.DataFilterCondition.Equal, "limpeza")})
        ...
        Me.chart3Limpeza.SeriesSerializable = New DevExpress.XtraCharts.Series() {Series3}
        Me.chart3Limpeza.SeriesTemplate.View = PieSeriesView6
        ...
        Me.chart3Limpeza.Titles.AddRange(New DevExpress.XtraCharts.ChartTitle() {ChartTitle3})
        '
        'chart2Automatico
        '
        ...
        Series4.DataFilters.ClearAndAddRange(New DevExpress.XtraCharts.DataFilter() {New DevExpress.XtraCharts.XRDataFilter("tag", "System.String", DevExpress.XtraCharts.DataFilterCondition.Equal, "automatico")})
        ...
        Me.chart2Automatico.SeriesSerializable = New DevExpress.XtraCharts.Series() {Series4}
        Me.chart2Automatico.SeriesTemplate.View = PieSeriesView8
        ...
        Me.chart2Automatico.Titles.AddRange(New DevExpress.XtraCharts.ChartTitle() {ChartTitle4})
        '
        'chart1MaqLigada
        '
        ...
        Series5.DataFilters.ClearAndAddRange(New DevExpress.XtraCharts.DataFilter() {New DevExpress.XtraCharts.XRDataFilter("tag", "System.String", DevExpress.XtraCharts.DataFilterCondition.Equal, "maqligada")})
        ...
        Me.chart1MaqLigada.SeriesSerializable = New DevExpress.XtraCharts.Series() {Series5}
        Me.chart1MaqLigada.SeriesTemplate.View = PieSeriesView10
        ...
        ChartTitle5.Text = "Tempo de Operação"
        Me.chart1MaqLigada.Titles.AddRange(New DevExpress.XtraCharts.ChartTitle() {ChartTitle5})
        '
        'objectDsLeiteEvento
        '
        Me.objectDsLeiteEvento.DataMember = "GetTempoEventosSoroDeQueijo"
        ...
        '
        'repCnIndLeiteCamarasFriasOverviewSubSoroDeQueijoTempoEventos
        '
        ...
        Me.DisplayName = "repCnIndLeiteCamarasFriasOverviewSubSoroDeQueijoTempoEventos"
        ...
        CType(Me.chart5TempDesnatacao,System.ComponentModel.ISupportInitialize).EndInit
