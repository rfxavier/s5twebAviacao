...
Public partial Class repCnIndLeiteCamarasFriasOverviewSubSoroDeQueijoTempoEventos
    Private Sub repCnIndLeiteCamarasFriasOverviewSubSoroDeQueijoTempoEventos_BeforePrint(sender As Object, e As PrintEventArgs) Handles Me.BeforePrint
