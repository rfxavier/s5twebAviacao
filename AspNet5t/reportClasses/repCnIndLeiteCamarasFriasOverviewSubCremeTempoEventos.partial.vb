...
Public partial Class repCnIndLeiteCamarasFriasOverviewSubCremeTempoEventos
    Private Sub repCnIndLeiteCamarasFriasOverviewSubCremeTempoEventos_BeforePrint(sender As Object, e As PrintEventArgs) Handles Me.BeforePrint
