...
Public partial Class repCnIndLeiteCamarasFriasOverviewSubLeitelhoTempoEventos
    Private Sub repCnIndLeiteCamarasFriasOverviewSubLeitelhoTempoEventos_BeforePrint(sender As Object, e As PrintEventArgs) Handles Me.BeforePrint
