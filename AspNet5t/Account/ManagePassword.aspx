                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-3">
                            <asp:Button runat="server" ID="btnAlterar" Text="Alterar senha" ValidationGroup="ChangePassword" OnClick="ChangePassword_Click" CssClass="btn btn-default" Width="120px" />
                            <asp:Button runat="server" ID="btnCancelar" Text="Cancelar" CssClass="btn btn-default" Width="120px" />
                        </div>
                    </div>
                </div>
            </asp:PlaceHolder>
