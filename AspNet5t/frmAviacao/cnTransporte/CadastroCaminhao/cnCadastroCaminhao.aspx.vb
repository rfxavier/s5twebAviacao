...
Public Class cnCadastroCaminhao
    Inherits System.Web.UI.Page
    Dim obj As S5T.AviacaoCaminhao = Nothing
    ...
    Private Sub PreencheFormComId(ByVal parId As Long)
        ...
        obj = S5T.AviacaoCaminhao.LoadByEntityKey(parId)

        If Not obj Is Nothing Then
            'lblId.Text = obj.pId
            txtPlaca.Value = obj.pPlaca
            txtTipo.Value = obj.pTipo
            txtCapacidadeTon.Value = obj.pCapacidade_Ton
            txtCapacidadePalete.Value = obj.pCapacidade_Palete
            if obj.sStatus = Status.Ativo then
                chkAtivo.Value = true
            else
    ...
    Protected Sub btnSalvar_Click(sender As Object, e As EventArgs) Handles btnSalvar.Click
        ...
        Try
            ...
            If tipoOperacao() = tpInsAlt.Insercao Then
                ''É INSERÇÃO
                Dim objCaminhao As New S5T.AviacaoCaminhao
                With objCaminhao
                 

                    .pPlaca = Trim(txtPlaca.Value)
                    .pTipo =Trim(txtTipo.Value )
                    .pDESC_VEICULO =Trim(txtTipo.Value )
                     .pCapacidade_Ton =Trim(txtCapacidadeTon.Value)
                   .pCapacidade_Palete = Trim(txtCapacidadePalete.Value)
                    if  chkAtivo.Value Then
                        .sStatus = Status.Ativo
                     else
                        .sStatus = Status.Inativo
                    End If
                    .Save()
                End With
            ...
            ElseIf tipoOperacao() = tpInsAlt.Alteracao Then
                ...
                Dim obj As S5T.AviacaoCaminhao = S5T.AviacaoCaminhao.LoadByEntityKey(gridPesquisa.GetSelectedFieldValues("pId")(0))
...
#Region "btnPesquisarTratamento"
    ...
    Protected Sub gridPesquisa_DataBinding(sender As Object, e As EventArgs) Handles gridPesquisa.DataBinding
        Dim VwGrid As List(Of S5T.AviacaoCaminhaoViewGrid) = Nothing


        VwGrid = S5T.AviacaoCaminhaoCollection.LoadAllViewGrid
