...
Public Class cnCadastroMotorista
    Inherits System.Web.UI.Page
    Dim obj As S5T.AviacaoMotorista = Nothing
    ...
    Private Sub PreencheFormComId(ByVal parId As Long)
        ...
        obj = S5T.AviacaoMotorista.LoadByEntityKey(parId)

        If Not obj Is Nothing Then
            'lblId.Text = obj.pId
            txtCodigo.Value = obj.pCOD_MOTORISTA
            TXTNOME.Value = obj.pNOME_MOTORISTA
    ...
    Protected Sub btnSalvar_Click(sender As Object, e As EventArgs) Handles btnSalvar.Click
        ...
        Try
            ...
            If tipoOperacao() = tpInsAlt.Insercao Then
                ''É INSERÇÃO
                Dim objMotorista As New S5T.AviacaoMotorista
                With objMotorista
                 

                    .pCOD_MOTORISTA = Trim(TXTCODIGO.Value)
                    .pNOME_MOTORISTA =Trim(TXTNOME.Value )
            ...
            ElseIf tipoOperacao() = tpInsAlt.Alteracao Then
                ...
                Dim obj As S5T.AviacaoMotorista = S5T.AviacaoMotorista.LoadByEntityKey(gridPesquisa.GetSelectedFieldValues("pId")(0))
...
#Region "btnPesquisarTratamento"
    ...
    Protected Sub gridPesquisa_DataBinding(sender As Object, e As EventArgs) Handles gridPesquisa.DataBinding
        Dim VwGrid As List(Of S5T.AviacaoMotoristaViewGrid) = Nothing


        VwGrid = S5T.AviacaoMotoristaCollection.LoadAllViewGrid
