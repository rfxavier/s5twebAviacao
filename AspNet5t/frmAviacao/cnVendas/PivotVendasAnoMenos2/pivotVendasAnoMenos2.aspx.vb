...
Public Class pivotVendasAnoMenos2
    ...
    Private Sub LinqServerModeDataSource1_Selecting(sender As Object, e As LinqServerModeDataSourceSelectEventArgs) Handles LinqServerModeDataSource1.Selecting
        ...
        If mskDatEmissaoIniPesq.Text <> "" And mskDatEmissaoFinPesq.Text <> "" Then
            ...
            Dim db As New AviacaoVendasAnoMenos2BasedataclassDataContext
            e.KeyExpression = "pId"
            e.QueryableSource = From aviacaoVendas In db.AviacaoVendasAnoMenos2s Where aviacaoVendas.pDATA_EMISSAO >= mskDatEmissaoIniPesq.Text And aviacaoVendas.pDATA_EMISSAO <= mskDatEmissaoFinPesq.Text
