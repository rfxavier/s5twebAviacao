...
Public Class pivotVendas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Not IsPostBack) AndAlso (Not IsCallback) Then
            ...
            mskDatEmissaoIniPesq.Text = New Date(Date.Now.Year, 01, 01)
    ...
    Private Sub LinqServerModeDataSource1_Selecting(sender As Object, e As LinqServerModeDataSourceSelectEventArgs) Handles LinqServerModeDataSource1.Selecting
        ...
        If mskDatEmissaoIniPesq.Text <> "" And mskDatEmissaoFinPesq.Text <> "" Then
            ...
            Dim db As New AviacaoVendasBasedataclassDataContext
            e.KeyExpression = "pId"
            e.QueryableSource = From aviacaoVendas In db.AviacaoVendas Where aviacaoVendas.pDATA_EMISSAO >= mskDatEmissaoIniPesq.Text And aviacaoVendas.pDATA_EMISSAO <= mskDatEmissaoFinPesq.Text
