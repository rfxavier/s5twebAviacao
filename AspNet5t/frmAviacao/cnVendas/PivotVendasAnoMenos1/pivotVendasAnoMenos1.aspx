<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.master" CodeBehind="pivotVendasAnoMenos1.aspx.vb" Inherits="AspNet5t.pivotVendasAnoMenos1" %>
...
<HideAdaptiveDetailButton ButtonType="Image"></HideAdaptiveDetailButton>
    ...
    <dx:ASPxPivotGrid ID="ASPxPivotGrid1" runat="server" ClientIDMode="AutoID" Theme="Moderno" EnableTheming="True" Width="100%" ClientInstanceName="pivotVendas"  oncustomcellvalue="ASPxPivotGrid1_CustomCellValue">
        <Fields>
            ...
            <dx:PivotGridField ID="fieldpPESOTOTAL1" Caption="Peso Total" CellFormat-FormatString="{0:#,#0.00}" CellFormat-FormatType="Numeric" FieldName="pPESO_TOTAL" AreaIndex="9">
            </dx:PivotGridField>
            ...
            <dx:PivotGridField ID="fieldpVLRTOTALNOTA1" AreaIndex="10" Caption="Valor Total Nota" CellFormat-FormatString="{0:#,#0.00}" CellFormat-FormatType="Numeric" FieldName="pVLR_TOTAL_NOTA">
            </dx:PivotGridField>
    ...
    <dx:LinqServerModeDataSource runat="server" ID="LinqServerModeDataSource1" ContextTypeName="AspNet5t.AviacaoVendasAnoMenos1BasedataclassDataContext" TableName="AviacaoVendasAnoMenos1s"></dx:LinqServerModeDataSource>
