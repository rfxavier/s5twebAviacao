...
Public Class cnVendasComparativoClientes
    ...
    End Sub
    Protected Sub ASPxDashboardViewer2_ConfigureDataConnection(sender As Object, e As DevExpress.DashboardWeb.ConfigureDataConnectionWebEventArgs) Handles ASPxDashboardViewer2.ConfigureDataConnection
        e.ConnectionParameters = AppUtils.dashConnectionParameters
    End Sub
    ...
    Private Sub ASPxDashboardViewer2_CustomParameters(sender As Object, e As DevExpress.DashboardWeb.CustomParametersWebEventArgs) Handles ASPxDashboardViewer2.CustomParameters
        'e.Parameters(0).Value = "052399"
        'e.Parameters(1).Value = "00"
        'e.Parameters(2).Value = "ZZ"
