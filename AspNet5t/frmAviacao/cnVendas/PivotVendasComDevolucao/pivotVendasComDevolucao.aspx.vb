...
Public Class pivotVendasComDevolucao
    ...
    Protected Sub ASPxPivotGrid1_CustomCellValue(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxPivotGrid.PivotCellValueEventArgs)
        If e.DataField Is calcPRECOMEDIOVENDA Then
            ...
            fieldpQUANTIDADE_VENDA.Visible = True
    ...
    Private Function GetPrecoMedio(ByVal e As DevExpress.Web.ASPxPivotGrid.PivotCellValueEventArgs) As Double
        ...
        valuesQuantidade = e.GetFieldValue(fieldpQUANTIDADE_VENDA)
    ...
    Protected Sub pivotGrid_CustomFieldValueCells(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxPivotGrid.PivotCustomFieldValueCellsEventArgs)
        ...
        For i As Integer = e.GetCellCount(True) - 1 To 0 Step -1
            ...
            If cbOcultarCampos.Checked = True Then
                If cell.DisplayText = "Quant. Venda" Or cell.DisplayText = "Valor Total Produto" Or cell.DisplayText = "Custo Produto" Then
                    e.Remove(cell)
                End If
            End If
        Next i
