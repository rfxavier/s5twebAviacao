...
Public Class cnCadastroProduto
    Inherits System.Web.UI.Page
    Dim obj As S5T.Produto = Nothing
    ...
    Private Sub PreencheFormComId(ByVal parId As Long)
        ...
        obj = S5T.Produto.LoadByEntityKey(parId)

        If Not obj Is Nothing Then
            'lblId.Text = obj.pId
            txtDescricao.Value = obj.pDescricao
            txtDiasMaturacao.Text = obj.pDiasMaturacao
        End If
    ...
    Protected Sub btnSalvar_Click(sender As Object, e As EventArgs) Handles btnSalvar.Click
        ...
        Try
            ...
            If tipoOperacao() = tpInsAlt.Insercao Then
                ''É INSERÇÃO
                Dim objProduto As New S5T.Produto
                With objProduto
                    .pDescricao = Trim(txtDescricao.Text)
                    .pDiasMaturacao = txtDiasMaturacao.Text
                    .Save()
                End With
            ...
            ElseIf tipoOperacao() = tpInsAlt.Alteracao Then
                ...
                Dim obj As S5T.Produto = S5T.Produto.LoadByEntityKey(gridPesquisa.GetSelectedFieldValues("pId")(0))
...
#Region "btnPesquisarTratamento"
    ...
    Protected Sub gridPesquisa_DataBinding(sender As Object, e As EventArgs) Handles gridPesquisa.DataBinding
        Dim VwGrid As List(Of S5T.ProdutoViewGrid) = Nothing


        VwGrid = S5T.ProdutoCollection.LoadAllViewGrid

        If CmbProdutoPesq.Value IsNot Nothing Then
            VwGrid = VwGrid.FindAll(Function(x) x.pId = CmbProdutoPesq.Value)
        End If
