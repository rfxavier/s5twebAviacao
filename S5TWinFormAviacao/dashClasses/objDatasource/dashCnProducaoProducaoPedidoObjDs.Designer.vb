Namespace Win_Dashboards
    Partial Public Class dashCnProducaoProducaoPedidoObjDs
        ''' <summary> 
...
#Region "Component Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Dim CalculatedField7 As DevExpress.DashboardCommon.CalculatedField = New DevExpress.DashboardCommon.CalculatedField()
            Dim CalculatedField8 As DevExpress.DashboardCommon.CalculatedField = New DevExpress.DashboardCommon.CalculatedField()
            Dim CalculatedField9 As DevExpress.DashboardCommon.CalculatedField = New DevExpress.DashboardCommon.CalculatedField()
            ...
            Measure1.Name = "Quantidade em Estoque"
            ...
            Measure2.DataMember = "QtdePedidoUltLoteConv"
            Measure2.Name = "Quantidade em Pedido"
            ...
            Me.gridDashboardItem1.DataItemRepository.Add(Measure2, "DataItem8")
            Me.gridDashboardItem1.DataSource = Me.dashboardObjectDataSource1
            FormatConditionExpression1.Expression = "[DataItem8] >= [DataItem6]"
            ...
            FormatConditionExpression2.Expression = "[DataItem8] < [DataItem6]"
            ...
            'gridDashboardItem2
            '
            Dimension3.DataMember = "LOTE_AVIACAO"
            ...
            Dimension4.DataMember = "DESCRICAO"
            Dimension4.Name = "Cliente"
            GridDimensionColumn4.Name = "Cliente"
            ...
            Dimension5.DataMember = "PedidoDataCalc"
            Dimension5.Name = "Pedido"
            ...
            Measure7.DataMember = "QtdePedidoConv"
            Measure7.Name = "Quantidade em Pedido"
            ...
            GridMeasureColumn5.Name = "Quantidade em Pedido"
            ...
            Me.gridDashboardItem2.Columns.AddRange(New DevExpress.DashboardCommon.GridColumnBase() {GridDimensionColumn3, GridDimensionColumn4, GridDimensionColumn5, GridMeasureColumn5})
            ...
            Me.gridDashboardItem2.DataItemRepository.Add(Dimension3, "DataItem5")
            Me.gridDashboardItem2.DataSource = Me.dashboardObjectDataSource1
            ...
            Me.gridDashboardItem2.Name = "Produção Detalhamento A"
            Me.gridDashboardItem2.ShowCaption = True
            '
            'gridDashboardItem3
            '
            Dimension6.DataMember = "FeriaCalc"
            Dimension6.Name = "Féria"
            GridDimensionColumn6.Name = "Lote"
            ...
            Dimension7.DataMember = "C5_EMISSAO_DATE"
            ...
            Measure8.DataMember = "QtdePedidoConv"
            Measure8.Name = "Quantidade em Pedido"
            ...
            GridMeasureColumn6.Name = "Quantidade em Pedido"
            ...
            Me.gridDashboardItem3.Columns.AddRange(New DevExpress.DashboardCommon.GridColumnBase() {GridDimensionColumn6, GridDimensionColumn7, GridMeasureColumn6})
            Me.gridDashboardItem3.ComponentName = "gridDashboardItem3"
            Me.gridDashboardItem3.DataItemRepository.Clear()
            Me.gridDashboardItem3.DataItemRepository.Add(Dimension6, "DataItem0")
            Me.gridDashboardItem3.DataItemRepository.Add(Measure8, "DataItem2")
            Me.gridDashboardItem3.DataItemRepository.Add(Dimension7, "DataItem1")
            Me.gridDashboardItem3.DataSource = Me.dashboardObjectDataSource1
            Me.gridDashboardItem3.InteractivityOptions.IgnoreMasterFilters = False
            Me.gridDashboardItem3.InteractivityOptions.IsDrillDownEnabled = True
            Me.gridDashboardItem3.Name = "Produção Detalhamento B"
            ...
            CalculatedField2.Expression = "[QtdeEstoqueConv] - [QtdePedidoUltLoteConv]"
        ...
        "ubstring([C5_EMISSAO], 4, 2), '/', Substring([C5_EMISSAO], 0, 4))"
            ...
            CalculatedField7.Expression = "Substring([LOTE_AVIACAO], 0, 5)"
            CalculatedField7.Name = "FeriaCalc"
            CalculatedField8.Expression = "Concat(Substring([C5_EMISSAO], 6, 2), '/', Substring([C5_EMISSAO], 4, 2), '/', Su" & _
        "bstring([C5_EMISSAO], 0, 4))"
            CalculatedField8.Name = "EmissaoCalc"
            CalculatedField9.DataType = DevExpress.DashboardCommon.CalculatedFieldType.[Decimal]
            CalculatedField9.Expression = "Avg([QTDVEN_ULTLOTE]) / Avg([FATOR_CONV])"
            CalculatedField9.Name = "QtdePedidoUltLoteConv"
            Me.dashboardObjectDataSource1.CalculatedFields.AddRange(New DevExpress.DashboardCommon.CalculatedField() {CalculatedField1, CalculatedField2, CalculatedField3, CalculatedField4, CalculatedField5, CalculatedField6, CalculatedField7, CalculatedField8, CalculatedField9})
            ...
            Me.Items.AddRange(New DevExpress.DashboardCommon.DashboardItem() {Me.gridDashboardItem1, Me.gridDashboardItem2, Me.gridDashboardItem3})
            ...
            DashboardLayoutItem2.Weight = 46.551724137931032R
            DashboardLayoutItem3.DashboardItem = Me.gridDashboardItem3
            DashboardLayoutItem3.Weight = 53.448275862068968R
