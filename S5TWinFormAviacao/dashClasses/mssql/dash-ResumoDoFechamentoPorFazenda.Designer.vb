Namespace Win_Dashboards
    Partial Public Class dash_ResumoDoFechamentoPorFazenda
        ''' <summary> 
...
#Region "Component Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(dash_ResumoDoFechamentoPorFazenda))
            ...
            Measure3.DataMember = "pTPHRealizado"
            ...
            Measure4.DataMember = "pTPHDifPercentual"
            ...
            Measure5.DataMember = "pATRPrevisto"
            ...
            GridMeasureColumn5.AddDataItem("Measure", Measure5)
            Measure6.DataMember = "pATRRealizado"
            ...
            GridMeasureColumn6.AddDataItem("Measure", Measure6)
            Measure7.DataMember = "pATRDifPercentual"
            ...
            GridMeasureColumn7.AddDataItem("Measure", Measure7)
            Measure8.DataMember = "pTCHPrevisto"
            ...
            GridMeasureColumn8.AddDataItem("Measure", Measure8)
            Measure9.DataMember = "pTCHRealizado"
            ...
            GridMeasureColumn9.AddDataItem("Measure", Measure9)
            Measure10.DataMember = "pTCHDifPercentual"
            ...
            GridMeasureColumn10.AddDataItem("Measure", Measure10)
            ...
            Me.gridDashboardItem1.DataItemRepository.Add(Measure5, "DataItem4")
            Me.gridDashboardItem1.DataItemRepository.Add(Measure6, "DataItem5")
            Me.gridDashboardItem1.DataItemRepository.Add(Measure8, "DataItem6")
            Me.gridDashboardItem1.DataItemRepository.Add(Measure9, "DataItem7")
            Me.gridDashboardItem1.DataItemRepository.Add(Measure4, "DataItem8")
            Me.gridDashboardItem1.DataItemRepository.Add(Measure7, "DataItem9")
            Me.gridDashboardItem1.DataItemRepository.Add(Measure10, "DataItem10")
            ...
            Measure11.DataMember = "pTPHPrevisto"
            Measure12.DataMember = "pTPHRealizado"
            Me.chartDashboardItem1.DataItemRepository.Clear()
            Me.chartDashboardItem1.DataItemRepository.Add(Measure11, "DataItem0")
            Me.chartDashboardItem1.DataItemRepository.Add(Measure12, "DataItem1")
            ...
            Measure13.DataMember = "pATRPrevisto"
            Measure14.DataMember = "pATRRealizado"
            Me.chartDashboardItem2.DataItemRepository.Clear()
            Me.chartDashboardItem2.DataItemRepository.Add(Measure13, "DataItem0")
            Me.chartDashboardItem2.DataItemRepository.Add(Measure14, "DataItem1")
            ...
            Me.chartDashboardItem3.Arguments.AddRange(New DevExpress.DashboardCommon.Dimension() {Dimension4})
            Me.chartDashboardItem3.AxisX.TitleVisible = False
            Me.chartDashboardItem3.ComponentName = "chartDashboardItem3"
            Measure15.DataMember = "pTCHPrevisto"
            Measure16.DataMember = "pTCHRealizado"
            Me.chartDashboardItem3.DataItemRepository.Clear()
            Me.chartDashboardItem3.DataItemRepository.Add(Measure15, "DataItem0")
            Me.chartDashboardItem3.DataItemRepository.Add(Measure16, "DataItem1")
            Me.chartDashboardItem3.DataItemRepository.Add(Dimension4, "DataItem2")
            ...
            '
            'dash_ResumoDoFechamentoPorFazenda
            '
            ...
            DashboardLayoutItem1.Weight = 24.193548387096776R
            DashboardLayoutItem2.DashboardItem = Me.chartDashboardItem1
            DashboardLayoutItem2.Weight = 27.822580645161292R
            DashboardLayoutItem3.DashboardItem = Me.chartDashboardItem2
            DashboardLayoutItem3.Weight = 25.0R
            DashboardLayoutItem4.DashboardItem = Me.chartDashboardItem3
            DashboardLayoutItem4.Weight = 22.983870967741936R
            ...
            Me.Title.ImageDataSerializable = resources.GetString("dash_ResumoDoFechamentoPorFazenda.Title.ImageDataSerializable")
            Me.Title.Text = "   FECHAMENTO POR FAZENDA (PRÓPRIA + FORNECEDOR)"
