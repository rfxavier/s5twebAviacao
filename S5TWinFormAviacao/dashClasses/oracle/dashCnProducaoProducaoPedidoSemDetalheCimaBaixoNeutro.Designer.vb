...
#Region "Component Designer generated code"
        ...
        "ubstring([C5_EMISSAO], 4, 2), '/', Substring([C5_EMISSAO], 0, 4))"
            ...
            CalculatedField8.Expression = "Iif([QtdeEmpenhadaConv] > 0 And [QtdeEstoqueConv] + [QtdeEmpenhadaConv] - [QtdePe" & _
        "didoConv] > 0 And [QtdePedidoConv] >= [QtdeEstoqueConv], 'NEUTRO', [IndicadorSta" & _
        "tusCimaBaixo])"
