...
Partial Public Class DataClassesSetorVisitaDataContext
  ...
  End Sub
  Partial Private Sub InsertSetorVisita(instance As SetorVisita)
    End Sub
  Partial Private Sub UpdateSetorVisita(instance As SetorVisita)
    End Sub
  Partial Private Sub DeleteSetorVisita(instance As SetorVisita)
    End Sub
  #End Region
	...
	Public ReadOnly Property SetorVisitas() As System.Data.Linq.Table(Of SetorVisita)
		Get
			Return Me.GetTable(Of SetorVisita)
		End Get
	End Property
End Class

<Global.System.Data.Linq.Mapping.TableAttribute(Name:="dbo.SetorVisita")>  _
